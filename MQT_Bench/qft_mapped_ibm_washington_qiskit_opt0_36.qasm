...
cx q[28],q[27];
cx q[27],q[28];
barrier q[22],q[20],q[4],q[16],q[27],q[30],q[29],q[12],q[35],q[26],q[7],q[6],q[2],q[24],q[15],q[1],q[23],q[18],q[14],q[19],q[0],q[34],q[25],q[5],q[32],q[9],q[10],q[11],q[13],q[17],q[31],q[28],q[8],q[3],q[33],q[21];
measure q[22] -> meas[0];
measure q[20] -> meas[1];
measure q[4] -> meas[2];
measure q[16] -> meas[3];
