...
rz(pi/2) q[61];
rz(-pi/4) q[62];
barrier q[61],q[62],q[63],q[60],q[53],q[41],q[42],q[43],q[45],q[64],q[54],q[59],q[58],q[57],q[56],q[52],q[37],q[39],q[38],q[33],q[21],q[22],q[20],q[23],q[25],q[24],q[26],q[28],q[35],q[47],q[46],q[27],q[32],q[31],q[29],q[48],q[30],q[50],q[68],q[49],q[69],q[70],q[67],q[65],q[66],q[55],q[36],q[19],q[8],q[6],q[15],q[3],q[2],q[1],q[4],q[7],q[71],q[44],q[17],q[12],q[11],q[34],q[10],q[9],q[13],q[51],q[16],q[5],q[40],q[18],q[14],q[0],q[72];
measure q[61] -> meas[0];
measure q[62] -> meas[1];
measure q[63] -> meas[2];
measure q[60] -> meas[3];
