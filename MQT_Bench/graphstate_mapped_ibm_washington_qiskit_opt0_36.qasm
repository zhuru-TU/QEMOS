...
sx q[30];
rz(pi/2) q[30];
barrier q[2],q[5],q[14],q[16],q[35],q[0],q[6],q[1],q[3],q[32],q[9],q[4],q[13],q[10],q[31],q[18],q[7],q[21],q[29],q[20],q[22],q[27],q[25],q[34],q[19],q[26],q[11],q[17],q[33],q[8],q[30],q[12],q[28],q[15],q[24],q[23];
measure q[2] -> meas[0];
measure q[5] -> meas[1];
measure q[14] -> meas[2];
measure q[16] -> meas[3];
