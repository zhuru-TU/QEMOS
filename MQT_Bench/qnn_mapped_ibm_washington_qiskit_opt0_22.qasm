...
rz(0) q[21];
sx q[21];
rz(3.3332166726448977) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(3.9033742985442363) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[21],q[22];
cx q[20],q[21];
...
rz(0) q[22];
sx q[22];
rz(3.7863172669253444) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[24];
sx q[24];
rz(3.5608197588822956) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(0) q[10];
sx q[10];
rz(3.5167316774837425) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.840603387657799) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
rz(0) q[21];
sx q[21];
rz(3.6660141812475926) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[23];
sx q[23];
rz(3.5354630123614563) q[23];
sx q[23];
rz(3*pi) q[23];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[27];
sx q[27];
rz(3.9029298607222755) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.97120644140755) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[30],q[17];
cx q[17],q[30];
...
rz(0) q[1];
sx q[1];
rz(3.267670420091731) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.635293792288153) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.2711027137908015) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[7];
sx q[7];
rz(4.024014885762544) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[27];
sx q[27];
rz(3.70098622709328) q[27];
sx q[27];
rz(3*pi) q[27];
barrier q[1],q[2],q[4],q[7],q[27],q[21],q[20],q[3],q[22],q[28],q[30],q[12],q[10],q[11],q[17],q[29],q[25],q[24],q[23],q[19],q[18],q[15];
measure q[1] -> meas[0];
measure q[2] -> meas[1];
measure q[4] -> meas[2];
measure q[7] -> meas[3];
