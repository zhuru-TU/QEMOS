...
rz(pi/2) q[6];
rz(-pi/4) q[7];
barrier q[15],q[19],q[8],q[16],q[30],q[21],q[23],q[24],q[26],q[28],q[11],q[10],q[12],q[17],q[29],q[27],q[25],q[22],q[20],q[18],q[14],q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[6],q[13];
measure q[15] -> c[0];
measure q[19] -> c[1];
measure q[8] -> c[2];
measure q[16] -> c[3];
