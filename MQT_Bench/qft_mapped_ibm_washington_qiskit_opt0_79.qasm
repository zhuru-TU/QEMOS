...
cx q[40],q[41];
cx q[41],q[40];
barrier q[41],q[42],q[39],q[38],q[45],q[66],q[27],q[35],q[51],q[64],q[80],q[85],q[48],q[61],q[68],q[24],q[79],q[19],q[62],q[72],q[83],q[58],q[59],q[15],q[71],q[4],q[34],q[84],q[8],q[30],q[49],q[86],q[10],q[3],q[78],q[37],q[12],q[16],q[31],q[32],q[26],q[9],q[13],q[23],q[6],q[2],q[50],q[73],q[11],q[44],q[7],q[82],q[77],q[5],q[0],q[14],q[53],q[57],q[81],q[18],q[22],q[21],q[63],q[25],q[55],q[60],q[17],q[65],q[47],q[54],q[36],q[28],q[29],q[67],q[46],q[20],q[33],q[43],q[40];
measure q[41] -> meas[0];
measure q[42] -> meas[1];
measure q[39] -> meas[2];
measure q[38] -> meas[3];
