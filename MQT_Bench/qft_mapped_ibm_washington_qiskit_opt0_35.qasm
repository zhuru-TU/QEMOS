...
cx q[25],q[26];
cx q[26],q[25];
barrier q[26],q[11],q[24],q[27],q[28],q[9],q[31],q[17],q[10],q[20],q[34],q[32],q[8],q[4],q[3],q[1],q[2],q[0],q[6],q[5],q[14],q[33],q[7],q[18],q[15],q[19],q[29],q[16],q[30],q[13],q[21],q[22],q[23],q[12],q[25];
measure q[26] -> meas[0];
measure q[11] -> meas[1];
measure q[24] -> meas[2];
measure q[27] -> meas[3];
