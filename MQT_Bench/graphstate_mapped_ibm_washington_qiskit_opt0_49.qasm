...
sx q[47];
rz(pi/2) q[47];
barrier q[33],q[18],q[1],q[14],q[3],q[6],q[19],q[5],q[28],q[9],q[11],q[48],q[13],q[30],q[8],q[7],q[21],q[40],q[37],q[0],q[38],q[39],q[20],q[2],q[34],q[4],q[12],q[17],q[36],q[10],q[23],q[35],q[31],q[22],q[43],q[32],q[25],q[29],q[16],q[15],q[24],q[26],q[42],q[47],q[45],q[46],q[44],q[41],q[27];
measure q[33] -> meas[0];
measure q[18] -> meas[1];
measure q[1] -> meas[2];
measure q[14] -> meas[3];
