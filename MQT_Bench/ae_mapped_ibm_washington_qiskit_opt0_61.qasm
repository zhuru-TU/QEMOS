...
rz(0) q[29];
sx q[29];
rz(-15189.663259084824) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
rz(0) q[29];
sx q[29];
rz(15195.946444392004) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
rz(0) q[16];
sx q[16];
rz(-124459454.20384844) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[8],q[16];
rz(0) q[16];
sx q[16];
rz(124459460.48703374) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[16],q[26];
cx q[26],q[16];
...
rz(-pi/4) q[60];
rz(-pi/524288) q[65];
barrier q[53],q[60],q[41],q[40],q[42],q[39],q[38],q[33],q[37],q[43],q[44],q[45],q[47],q[48],q[49],q[46],q[54],q[64],q[65],q[34],q[63],q[62],q[24],q[66],q[23],q[61],q[22],q[27],q[29],q[26],q[30],q[17],q[11],q[12],q[10],q[9],q[13],q[31],q[25],q[6],q[3],q[15],q[2],q[4],q[1],q[19],q[28],q[7],q[8],q[32],q[59],q[36],q[16],q[5],q[21],q[18],q[20],q[14],q[0],q[52],q[57];
measure q[53] -> meas[0];
measure q[60] -> meas[1];
measure q[41] -> meas[2];
measure q[40] -> meas[3];
