...
cx q[36],q[32];
cx q[32],q[36];
barrier q[22],q[23],q[24],q[16],q[26],q[28],q[17],q[32],q[47],q[35],q[46],q[11],q[30],q[34],q[31],q[6],q[9],q[42],q[5],q[20],q[39],q[18],q[14],q[19],q[33],q[21],q[41],q[10],q[2],q[44],q[25],q[43],q[29],q[45],q[49],q[48],q[36],q[12],q[27],q[7],q[8],q[3],q[4],q[15];
measure q[22] -> meas[0];
measure q[23] -> meas[1];
measure q[24] -> meas[2];
measure q[16] -> meas[3];
