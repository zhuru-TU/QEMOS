...
cx q[22],q[15];
cx q[15],q[22];
rz(0.44863575865727257) q[15];
cx q[15],q[4];
rz(-0.44863575865727257) q[4];
cx q[15],q[4];
rz(0.44863575865727257) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
sx q[1];
rz(pi/2) q[1];
barrier q[10],q[13],q[26],q[25],q[20],q[19],q[8],q[21],q[15],q[22],q[28],q[30],q[11],q[12],q[17],q[29],q[27],q[23],q[24],q[16],q[7],q[6],q[5],q[4],q[3],q[18],q[2],q[14],q[0],q[1],q[9];
measure q[10] -> c[0];
measure q[13] -> c[1];
measure q[26] -> c[2];
measure q[25] -> c[3];
