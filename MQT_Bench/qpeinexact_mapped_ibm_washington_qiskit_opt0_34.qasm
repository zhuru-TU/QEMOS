...
cx q[33],q[20];
cx q[20],q[33];
rz(0.6473398924877406) q[20];
cx q[20],q[19];
rz(-0.6473398924877406) q[19];
cx q[20],q[19];
rz(0.6473398924877406) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
rz(pi/2) q[4];
rz(-pi/4) q[15];
barrier q[5],q[7],q[18],q[14],q[33],q[19],q[20],q[23],q[30],q[32],q[10],q[11],q[31],q[13],q[12],q[17],q[29],q[8],q[28],q[26],q[25],q[27],q[24],q[16],q[6],q[21],q[0],q[1],q[2],q[3],q[22],q[15],q[4],q[9];
measure q[5] -> c[0];
measure q[7] -> c[1];
measure q[18] -> c[2];
measure q[14] -> c[3];
