...
rz(0) q[9];
sx q[9];
rz(3.7014048982939367) q[9];
sx q[9];
rz(3*pi) q[9];
cx q[12],q[17];
rz(0) q[13];
sx q[13];
rz(3.6609649494369103) q[13];
sx q[13];
rz(3*pi) q[13];
cx q[17],q[12];
cx q[12],q[17];
...
rz(0) q[5];
sx q[5];
rz(3.919444198207219) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6478183176049934) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[15],q[4];
rz(9.172838187819544) q[4];
...
rz(0) q[4];
sx q[4];
rz(3.1682855347014383) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[16];
sx q[16];
rz(3.401454295471122) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[22],q[15];
rz(9.172838187819544) q[15];
...
rz(0) q[1];
sx q[1];
rz(4.020832406428567) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.9308810038451867) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(3.9488730704143964) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
rz(0) q[2];
sx q[2];
rz(3.4698122011833132) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.2431106589158976) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[14];
sx q[14];
rz(3.2707891689511097) q[14];
sx q[14];
rz(3*pi) q[14];
cx q[0],q[14];
cx q[14],q[0];
...
rz(0) q[1];
sx q[1];
rz(4.130449308660207) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[18];
sx q[18];
rz(3.515837474524859) q[18];
sx q[18];
rz(3*pi) q[18];
cx q[14],q[18];
cx q[18],q[14];
...
rz(0) q[21];
sx q[21];
rz(3.576075073911513) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[21],q[20];
rz(0) q[20];
sx q[20];
rz(3.272897727744949) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
rz(0) q[8];
sx q[8];
rz(3.9988724791790515) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[16],q[26];
rz(0) q[21];
sx q[21];
rz(3.3381296786666677) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[20],q[21];
cx q[21],q[20];
...
rz(0) q[27];
sx q[27];
rz(3.4759394997625606) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(3.7473114899381157) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[10];
sx q[10];
rz(3.617934891865568) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.537850753872454) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[13];
cx q[13],q[12];
...
rz(0) q[11];
sx q[11];
rz(3.4887997103099124) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[17];
sx q[17];
rz(3.790993596591666) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[6];
sx q[6];
rz(3.6423256568030027) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.2854645650866687) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[15];
sx q[15];
rz(3.63720414066237) q[15];
sx q[15];
rz(3*pi) q[15];
rz(0) q[25];
sx q[25];
rz(3.839055727877722) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[27];
sx q[27];
rz(3.9683534193495915) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[30];
sx q[30];
rz(3.4560208164578574) q[30];
sx q[30];
rz(3*pi) q[30];
barrier q[7],q[6],q[15],q[21],q[22],q[25],q[27],q[30],q[11],q[10],q[13],q[12],q[17],q[9],q[29],q[28],q[26],q[24],q[16],q[8],q[5],q[4],q[23],q[20],q[19],q[18],q[0],q[1],q[2],q[3],q[14];
measure q[7] -> meas[0];
measure q[6] -> meas[1];
measure q[15] -> meas[2];
measure q[21] -> meas[3];
