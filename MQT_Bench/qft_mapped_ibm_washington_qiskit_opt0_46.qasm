...
cx q[47],q[35];
cx q[35],q[47];
barrier q[19],q[22],q[21],q[3],q[33],q[35],q[34],q[27],q[42],q[30],q[48],q[16],q[12],q[31],q[11],q[9],q[26],q[49],q[20],q[6],q[40],q[14],q[38],q[37],q[25],q[39],q[23],q[44],q[45],q[50],q[10],q[8],q[7],q[17],q[24],q[46],q[28],q[41],q[29],q[43],q[47],q[5],q[2],q[4],q[15],q[18];
measure q[19] -> meas[0];
measure q[22] -> meas[1];
measure q[21] -> meas[2];
measure q[3] -> meas[3];
