...
rz(0) q[28];
sx q[28];
rz(3.971947637618147) q[28];
sx q[28];
rz(3*pi) q[28];
rz(0) q[29];
sx q[29];
rz(3.6202166804778386) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[27],q[28];
...
rz(0) q[11];
sx q[11];
rz(4.00234904402037) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[17];
sx q[17];
rz(3.240722268460236) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[0];
sx q[0];
rz(4.106414318547876) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.563910124671975) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.896983476509334) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.9597971251303834) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.9773657497008346) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(4.042286756855003) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(4.014477820616531) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.956942699020245) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.9550228034456003) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.20129183963864) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[5],q[6],q[7],q[16],q[27],q[29],q[11],q[12],q[17],q[28],q[26],q[30];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
