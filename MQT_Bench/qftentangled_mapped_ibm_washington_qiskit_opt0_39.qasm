...
cx q[24],q[34];
cx q[34],q[24];
barrier q[34],q[43],q[16],q[28],q[22],q[35],q[30],q[29],q[49],q[6],q[44],q[10],q[45],q[46],q[4],q[1],q[3],q[18],q[0],q[47],q[14],q[19],q[15],q[2],q[5],q[20],q[21],q[9],q[26],q[11],q[48],q[12],q[17],q[7],q[25],q[27],q[8],q[23],q[24];
measure q[34] -> meas[0];
measure q[43] -> meas[1];
measure q[16] -> meas[2];
measure q[28] -> meas[3];
