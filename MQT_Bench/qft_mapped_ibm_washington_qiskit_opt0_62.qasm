...
cx q[27],q[28];
cx q[28],q[27];
barrier q[28],q[43],q[49],q[31],q[26],q[36],q[50],q[55],q[48],q[46],q[13],q[64],q[65],q[66],q[68],q[9],q[44],q[53],q[22],q[7],q[5],q[24],q[33],q[20],q[18],q[21],q[15],q[58],q[14],q[4],q[2],q[1],q[3],q[0],q[38],q[16],q[45],q[19],q[40],q[39],q[25],q[6],q[8],q[23],q[59],q[41],q[67],q[61],q[62],q[63],q[54],q[10],q[11],q[17],q[51],q[35],q[32],q[29],q[30],q[47],q[42],q[27];
measure q[28] -> meas[0];
measure q[43] -> meas[1];
measure q[49] -> meas[2];
measure q[31] -> meas[3];
