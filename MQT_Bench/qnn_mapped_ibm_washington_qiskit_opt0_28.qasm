...
rz(0) q[11];
sx q[11];
rz(3.9216364440699785) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(4.1110076627663386) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[19];
sx q[19];
rz(3.876284218552937) q[19];
sx q[19];
rz(3*pi) q[19];
rz(0) q[22];
sx q[22];
rz(3.982764541310191) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[21],q[22];
cx q[22],q[21];
...
rz(0) q[6];
sx q[6];
rz(3.8776928186757473) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(4.065326441174816) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
cx q[5],q[6];
...
rz(0) q[7];
sx q[7];
rz(3.3210894738947725) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.9197588194573694) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[8],q[16];
cx q[16],q[8];
...
rz(0) q[18];
sx q[18];
rz(3.6432074356391553) q[18];
sx q[18];
rz(3*pi) q[18];
rz(0) q[20];
sx q[20];
rz(3.4782465342435485) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
rz(0) q[25];
sx q[25];
rz(3.2127500446904826) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(3.814850820378462) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.182261003131779) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[10];
sx q[10];
rz(3.8554660264528455) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(4.013775485525955) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[1];
sx q[1];
rz(3.898501361621982) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[3];
sx q[3];
rz(3.5319450406430253) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[5];
sx q[5];
rz(4.11791719725619) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.5233666972741773) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(3.839757160024635) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[14];
sx q[14];
rz(4.010502324083795) q[14];
sx q[14];
rz(3*pi) q[14];
barrier q[14],q[0],q[1],q[3],q[5],q[7],q[25],q[26],q[17],q[11],q[10],q[12],q[30],q[29],q[27],q[23],q[15],q[20],q[18],q[19],q[21],q[22],q[24],q[28],q[16],q[6],q[4],q[8];
measure q[14] -> meas[0];
measure q[0] -> meas[1];
measure q[1] -> meas[2];
measure q[3] -> meas[3];
