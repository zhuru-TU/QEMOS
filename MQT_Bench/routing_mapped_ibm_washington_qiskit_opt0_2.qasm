...
rz(0) q[0];
sx q[0];
rz(4.879642770360396) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(2.57757973966172) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
rz(0) q[0];
sx q[0];
rz(3.6116921140131795) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(1.6047080413599266) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
rz(0) q[0];
sx q[0];
rz(3.474143168534375) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(2.4673241133475883) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
rz(0) q[0];
sx q[0];
rz(1.3693050041921655) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.4556544187679417) q[1];
sx q[1];
rz(3*pi) q[1];
barrier q[0],q[1];
measure q[0] -> meas[0];
