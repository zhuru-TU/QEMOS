...
cx q[4],q[3];
cx q[3],q[4];
rz(-1.346499573466243) q[3];
cx q[3],q[2];
rz(1.346499573466243) q[2];
cx q[3],q[2];
rz(-1.346499573466243) q[2];
cx q[2],q[3];
cx q[3],q[2];
...
rz(pi/2) q[25];
rz(-pi/8192) q[29];
barrier q[2],q[7],q[29],q[28],q[27],q[16],q[22],q[15],q[4],q[6],q[8],q[26],q[23],q[24],q[25],q[30];
measure q[2] -> c[0];
measure q[7] -> c[1];
measure q[29] -> c[2];
measure q[28] -> c[3];
