...
cx q[20],q[21];
cx q[21],q[20];
barrier q[1],q[26],q[21],q[23],q[19],q[4],q[28],q[30],q[15],q[39],q[34],q[41],q[44],q[46],q[31],q[37],q[48],q[7],q[8],q[16],q[11],q[10],q[14],q[2],q[3],q[38],q[5],q[6],q[47],q[18],q[12],q[40],q[45],q[42],q[43],q[17],q[25],q[35],q[29],q[22],q[33],q[24],q[20],q[27],q[0];
measure q[1] -> meas[0];
measure q[26] -> meas[1];
measure q[21] -> meas[2];
measure q[23] -> meas[3];
