...
rz(pi/2) q[20];
rz(-pi/4294967296) q[48];
barrier q[8],q[38],q[40],q[1],q[33],q[0],q[39],q[45],q[44],q[49],q[48],q[46],q[47],q[34],q[35],q[23],q[14],q[2],q[4],q[3],q[5],q[15],q[6],q[7],q[26],q[13],q[28],q[30],q[12],q[9],q[10],q[11],q[17],q[29],q[27],q[25],q[24],q[22],q[21],q[18],q[19],q[20],q[37];
measure q[8] -> c[0];
measure q[38] -> c[1];
measure q[40] -> c[2];
measure q[1] -> c[3];
