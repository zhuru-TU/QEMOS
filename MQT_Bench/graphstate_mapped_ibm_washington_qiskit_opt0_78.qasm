...
sx q[81];
rz(pi/2) q[81];
barrier q[71],q[3],q[6],q[0],q[5],q[2],q[8],q[7],q[49],q[16],q[9],q[13],q[10],q[12],q[38],q[19],q[32],q[23],q[1],q[58],q[14],q[25],q[28],q[39],q[22],q[30],q[4],q[50],q[53],q[11],q[54],q[74],q[24],q[41],q[42],q[45],q[62],q[73],q[44],q[18],q[26],q[33],q[52],q[56],q[37],q[36],q[55],q[48],q[27],q[70],q[34],q[31],q[20],q[21],q[51],q[63],q[57],q[60],q[61],q[65],q[67],q[79],q[64],q[68],q[66],q[15],q[35],q[17],q[80],q[69],q[40],q[47],q[72],q[29],q[46],q[81],q[59],q[43];
measure q[71] -> meas[0];
measure q[3] -> meas[1];
measure q[6] -> meas[2];
measure q[0] -> meas[3];
