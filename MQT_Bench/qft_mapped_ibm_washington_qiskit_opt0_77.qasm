...
cx q[47],q[48];
cx q[48],q[47];
barrier q[48],q[42],q[44],q[50],q[45],q[64],q[63],q[28],q[35],q[73],q[22],q[17],q[82],q[68],q[12],q[62],q[23],q[33],q[40],q[25],q[60],q[52],q[58],q[59],q[56],q[71],q[14],q[4],q[3],q[5],q[6],q[9],q[83],q[10],q[41],q[36],q[67],q[66],q[11],q[31],q[69],q[32],q[8],q[72],q[80],q[30],q[26],q[7],q[2],q[85],q[0],q[57],q[19],q[21],q[61],q[37],q[38],q[53],q[39],q[20],q[15],q[81],q[13],q[55],q[54],q[49],q[16],q[65],q[29],q[27],q[84],q[46],q[24],q[51],q[34],q[43],q[47];
measure q[48] -> meas[0];
measure q[42] -> meas[1];
measure q[44] -> meas[2];
measure q[50] -> meas[3];
