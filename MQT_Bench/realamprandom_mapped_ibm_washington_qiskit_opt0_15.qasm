...
sx q[29];
rz(3*pi) q[29];
barrier q[11],q[12],q[30],q[17],q[29],q[28],q[27],q[16],q[7],q[5],q[4],q[3],q[2],q[0],q[1];
measure q[11] -> meas[0];
measure q[12] -> meas[1];
measure q[30] -> meas[2];
measure q[17] -> meas[3];
