...
cx q[26],q[25];
cx q[25],q[26];
rz(0.1023690886288168) q[25];
cx q[25],q[24];
rz(-0.1023690886288168) q[24];
cx q[25],q[24];
rz(0.1023690886288168) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[22],q[15];
cx q[15],q[22];
rz(0.2047381772576336) q[15];
cx q[15],q[4];
rz(-0.2047381772576336) q[4];
cx q[15],q[4];
rz(0.2047381772576336) q[4];
cx q[4],q[15];
cx q[15],q[4];
