...
rz(0) q[11];
sx q[11];
rz(3.653668293474324) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
rz(4.103032765408583) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[10],q[11];
...
rz(0) q[10];
sx q[10];
rz(3.2391693536010484) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.418368456437113) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[17];
sx q[17];
rz(4.008711097958192) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[30];
sx q[30];
rz(3.1762058294383975) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[30],q[17];
rz(0) q[17];
sx q[17];
rz(4.102688080510819) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[0];
sx q[0];
rz(3.6898832387696863) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.754694535320365) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.171750506098214) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.212118338330133) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.530611460588577) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(3.4536187597308325) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.2079576888884183) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.3476864688154935) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.1929152909285934) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.356888586752094) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[5],q[6],q[7],q[16],q[27],q[29],q[17],q[11],q[10],q[12];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
