...
rz(pi/2) q[116];
x psi[0];
rz(1.5160125831560336) psi[0];
cx psi[0],q[0];
rz(-1.5160125831560336) q[0];
cx psi[0],q[0];
rz(1.5160125831560336) q[0];
rz(-0.10956748727772572) psi[0];
cx psi[0],q[1];
rz(0.10956748727772572) q[1];
cx psi[0],q[1];
rz(-0.10956748727772572) q[1];
rz(-0.21913497455545144) psi[0];
cx psi[0],q[2];
rz(0.21913497455545144) q[2];
cx psi[0],q[2];
rz(-0.21913497455545144) q[2];
rz(-0.4382699491109029) psi[0];
cx psi[0],q[3];
rz(0.4382699491109029) q[3];
cx psi[0],q[3];
rz(-0.4382699491109029) q[3];
rz(-0.8765398982218058) psi[0];
cx psi[0],q[4];
rz(0.8765398982218058) q[4];
cx psi[0],q[4];
rz(-0.8765398982218058) q[4];
rz(1.3885128571461816) psi[0];
cx psi[0],q[5];
rz(-1.3885128571461816) q[5];
cx psi[0],q[5];
rz(1.3885128571461816) q[5];
rz(-0.3645669392974298) psi[0];
cx psi[0],q[6];
rz(0.3645669392974298) q[6];
cx psi[0],q[6];
rz(-0.3645669392974298) q[6];
rz(-0.7291338785948596) psi[0];
cx psi[0],q[7];
rz(0.7291338785948596) q[7];
cx psi[0],q[7];
rz(-0.7291338785948596) q[7];
rz(-1.4582677571897191) psi[0];
cx psi[0],q[8];
rz(1.4582677571897191) q[8];
cx psi[0],q[8];
rz(-1.4582677571897191) q[8];
rz(0.22505713921035492) psi[0];
cx psi[0],q[9];
rz(-0.22505713921035492) q[9];
cx psi[0],q[9];
rz(0.22505713921035492) q[9];
rz(0.45011427842070983) psi[0];
cx psi[0],q[10];
rz(-0.45011427842070983) q[10];
cx psi[0],q[10];
rz(0.45011427842070983) q[10];
rz(0.9002285568414197) psi[0];
cx psi[0],q[11];
rz(-0.9002285568414197) q[11];
cx psi[0],q[11];
rz(0.9002285568414197) q[11];
rz(-1.3411355399069536) psi[0];
cx psi[0],q[12];
rz(1.3411355399069536) q[12];
cx psi[0],q[12];
rz(-1.3411355399069536) q[12];
rz(0.45932157377588584) psi[0];
cx psi[0],q[13];
rz(-0.45932157377588584) q[13];
cx psi[0],q[13];
rz(0.45932157377588584) q[13];
rz(0.9186431475517717) psi[0];
cx psi[0],q[14];
rz(-0.9186431475517717) q[14];
cx psi[0],q[14];
rz(0.9186431475517717) q[14];
