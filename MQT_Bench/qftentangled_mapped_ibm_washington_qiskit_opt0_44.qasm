...
cx q[15],q[22];
cx q[22],q[15];
barrier q[20],q[22],q[41],q[42],q[38],q[34],q[27],q[26],q[24],q[21],q[14],q[31],q[0],q[4],q[11],q[46],q[37],q[9],q[3],q[7],q[6],q[16],q[13],q[5],q[8],q[2],q[35],q[43],q[39],q[10],q[33],q[12],q[17],q[18],q[23],q[30],q[29],q[28],q[25],q[45],q[44],q[40],q[15],q[19];
measure q[20] -> meas[0];
measure q[22] -> meas[1];
measure q[41] -> meas[2];
measure q[42] -> meas[3];
