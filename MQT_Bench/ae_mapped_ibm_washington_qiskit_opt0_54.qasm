...
sx q[47];
rz(pi/2) q[47];
barrier q[47],q[46],q[45],q[48],q[49],q[51],q[36],q[32],q[31],q[30],q[29],q[28],q[26],q[24],q[23],q[21],q[33],q[40],q[41],q[38],q[42],q[39],q[20],q[37],q[22],q[52],q[43],q[19],q[18],q[1],q[2],q[4],q[15],q[34],q[5],q[3],q[25],q[35],q[17],q[8],q[16],q[50],q[7],q[12],q[11],q[10],q[13],q[9],q[6],q[27],q[0],q[14],q[44],q[53];
measure q[47] -> meas[0];
measure q[46] -> meas[1];
measure q[45] -> meas[2];
measure q[48] -> meas[3];
