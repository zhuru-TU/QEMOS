...
rz(0) q[43];
sx q[43];
rz(-127446484318.59009) q[43];
sx q[43];
rz(3*pi) q[43];
cx q[42],q[43];
rz(0) q[43];
sx q[43];
rz(127446484324.87326) q[43];
sx q[43];
rz(3*pi) q[43];
cx q[42],q[43];
cx q[43],q[42];
...
sx q[24];
rz(pi/2) q[24];
barrier q[24],q[23],q[22],q[25],q[26],q[27],q[28],q[47],q[46],q[45],q[54],q[64],q[63],q[62],q[61],q[60],q[53],q[41],q[39],q[40],q[33],q[38],q[20],q[42],q[43],q[48],q[16],q[17],q[11],q[12],q[10],q[30],q[9],q[44],q[13],q[7],q[34],q[49],q[29],q[6],q[5],q[21],q[55],q[35],q[8],q[50],q[51],q[68],q[19],q[31],q[4],q[2],q[3],q[15],q[14],q[18],q[0],q[66];
measure q[24] -> meas[0];
measure q[23] -> meas[1];
measure q[22] -> meas[2];
measure q[25] -> meas[3];
