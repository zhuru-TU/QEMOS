...
rz(pi/2) q[1];
sx q[1];
rz(4.384379921006045) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[1],q[0];
rz(1.8987198091892312) q[0];
cx q[1],q[0];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
...
cx q[1],q[2];
cx q[0],q[1];
rz(1.8987198091892312) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(6.938787595665191) q[0];
sx q[0];
rz(5*pi/2) q[0];
cx q[5],q[4];
rz(-0.6556494833205146) q[4];
cx q[5],q[4];
rz(pi/2) q[4];
sx q[4];
rz(4.384379921006045) q[4];
sx q[4];
rz(5*pi/2) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
cx q[2],q[3];
rz(1.8987198091892312) q[3];
cx q[2],q[3];
rz(pi/2) q[2];
sx q[2];
rz(6.938787595665191) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(pi/2) q[7];
sx q[7];
...
cx q[6],q[7];
cx q[5],q[6];
rz(-0.6556494833205146) q[6];
cx q[5],q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.6556494833205146) q[5];
cx q[4],q[5];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
...
cx q[2],q[3];
cx q[1],q[2];
rz(1.8987198091892312) q[2];
cx q[1],q[2];
rz(pi/2) q[1];
sx q[1];
rz(6.938787595665191) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[5],q[6];
cx q[5],q[4];
rz(1.8987198091892312) q[4];
cx q[5],q[4];
rz(pi/2) q[4];
sx q[4];
rz(6.938787595665191) q[4];
sx q[4];
rz(5*pi/2) q[4];
rz(pi/2) q[6];
sx q[6];
...
cx q[26],q[27];
cx q[16],q[26];
rz(-0.6556494833205146) q[26];
cx q[16],q[26];
rz(pi/2) q[16];
sx q[16];
rz(4.384379921006045) q[16];
sx q[16];
rz(5*pi/2) q[16];
rz(pi/2) q[26];
sx q[26];
rz(4.384379921006045) q[26];
sx q[26];
rz(5*pi/2) q[26];
cx q[16],q[26];
cx q[26],q[16];
...
rz(pi/2) q[16];
sx q[16];
rz(6.938787595665191) q[16];
sx q[16];
rz(5*pi/2) q[16];
rz(pi/2) q[26];
sx q[26];
rz(6.938787595665191) q[26];
sx q[26];
rz(5*pi/2) q[26];
rz(pi/2) q[27];
sx q[27];
rz(6.938787595665191) q[27];
sx q[27];
rz(5*pi/2) q[27];
barrier q[2],q[0],q[6],q[1],q[3],q[27],q[5],q[16],q[4],q[26];
measure q[2] -> meas[0];
measure q[0] -> meas[1];
measure q[6] -> meas[2];
measure q[1] -> meas[3];
