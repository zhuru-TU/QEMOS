...
sx q[25];
rz(pi/2) q[25];
barrier q[18],q[4],q[3],q[5],q[2],q[1],q[6],q[8],q[23],q[9],q[13],q[10],q[16],q[22],q[19],q[27],q[7],q[28],q[14],q[11],q[0],q[24],q[26],q[21],q[29],q[30],q[17],q[20],q[15],q[25],q[12];
measure q[18] -> meas[0];
measure q[4] -> meas[1];
measure q[3] -> meas[2];
measure q[5] -> meas[3];
