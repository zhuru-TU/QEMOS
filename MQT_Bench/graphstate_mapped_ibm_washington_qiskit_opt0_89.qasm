...
sx q[68];
rz(pi/2) q[68];
barrier q[18],q[3],q[19],q[7],q[1],q[14],q[5],q[51],q[32],q[22],q[36],q[9],q[12],q[27],q[23],q[2],q[13],q[10],q[40],q[15],q[24],q[56],q[4],q[20],q[52],q[0],q[6],q[42],q[25],q[29],q[8],q[86],q[28],q[35],q[31],q[83],q[74],q[39],q[38],q[45],q[71],q[26],q[64],q[49],q[48],q[21],q[44],q[47],q[85],q[30],q[50],q[11],q[59],q[37],q[58],q[16],q[57],q[63],q[54],q[75],q[60],q[65],q[43],q[33],q[46],q[69],q[72],q[68],q[34],q[55],q[70],q[61],q[62],q[84],q[88],q[78],q[77],q[79],q[87],q[80],q[76],q[81],q[82],q[66],q[67],q[53],q[41],q[73],q[17];
measure q[18] -> meas[0];
measure q[3] -> meas[1];
measure q[19] -> meas[2];
measure q[7] -> meas[3];
