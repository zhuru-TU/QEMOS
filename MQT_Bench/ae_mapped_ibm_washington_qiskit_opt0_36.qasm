...
rz(0) q[19];
sx q[19];
rz(-7778712.942497415) q[19];
sx q[19];
rz(3*pi) q[19];
cx q[20],q[19];
rz(0) q[19];
sx q[19];
rz(7778719.2256827215) q[19];
sx q[19];
rz(3*pi) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
rz(-pi/16) q[17];
rz(-pi/512) q[32];
barrier q[12],q[11],q[10],q[17],q[9],q[13],q[30],q[31],q[32],q[29],q[27],q[28],q[26],q[24],q[25],q[22],q[21],q[19],q[14],q[0],q[1],q[4],q[5],q[20],q[15],q[6],q[23],q[8],q[7],q[16],q[35],q[2],q[3],q[18],q[33],q[34];
measure q[12] -> meas[0];
measure q[11] -> meas[1];
measure q[10] -> meas[2];
measure q[17] -> meas[3];
