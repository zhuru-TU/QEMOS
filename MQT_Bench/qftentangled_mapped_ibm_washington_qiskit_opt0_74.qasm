...
cx q[84],q[83];
cx q[83],q[84];
barrier q[16],q[43],q[26],q[35],q[24],q[48],q[49],q[54],q[50],q[65],q[60],q[45],q[72],q[83],q[82],q[41],q[33],q[40],q[14],q[21],q[2],q[3],q[58],q[27],q[4],q[17],q[66],q[5],q[61],q[37],q[13],q[25],q[62],q[52],q[39],q[77],q[71],q[57],q[80],q[73],q[56],q[9],q[32],q[31],q[11],q[18],q[12],q[10],q[67],q[47],q[6],q[59],q[22],q[1],q[15],q[19],q[20],q[38],q[46],q[81],q[84],q[63],q[44],q[53],q[30],q[64],q[55],q[29],q[68],q[23],q[28],q[7],q[42],q[8];
measure q[16] -> meas[0];
measure q[43] -> meas[1];
measure q[26] -> meas[2];
measure q[35] -> meas[3];
