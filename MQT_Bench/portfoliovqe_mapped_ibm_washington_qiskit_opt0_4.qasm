...
rz(0) q[0];
sx q[0];
rz(-1.3993918994571635) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(4.878235002140986) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[1];
sx q[1];
rz(-0.26277465155198065) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(-1.5253210954439496) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(7.606779196742153) q[3];
sx q[3];
rz(3*pi) q[3];
