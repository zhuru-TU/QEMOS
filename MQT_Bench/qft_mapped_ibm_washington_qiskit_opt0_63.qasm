...
cx q[61],q[60];
cx q[60],q[61];
barrier q[20],q[21],q[39],q[40],q[38],q[56],q[37],q[60],q[43],q[59],q[53],q[23],q[27],q[24],q[2],q[45],q[8],q[42],q[28],q[0],q[54],q[47],q[64],q[32],q[48],q[55],q[17],q[36],q[46],q[51],q[9],q[11],q[10],q[29],q[13],q[30],q[12],q[50],q[49],q[31],q[63],q[35],q[1],q[62],q[26],q[4],q[7],q[44],q[5],q[3],q[16],q[25],q[57],q[58],q[34],q[61],q[15],q[52],q[33],q[14],q[18],q[22],q[19];
measure q[20] -> meas[0];
measure q[21] -> meas[1];
measure q[39] -> meas[2];
measure q[40] -> meas[3];
