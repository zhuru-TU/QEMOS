...
sx q[7];
rz(pi/2) q[7];
barrier q[44],q[42],q[45],q[47],q[18],q[22],q[13],q[31],q[35],q[15],q[34],q[25],q[8],q[4],q[3],q[2],q[1],q[0],q[14],q[19],q[20],q[21],q[23],q[24],q[26],q[28],q[30],q[12],q[9],q[10],q[11],q[17],q[29],q[27],q[16],q[5],q[6],q[7],q[43];
measure q[44] -> c[0];
measure q[42] -> c[1];
measure q[45] -> c[2];
measure q[47] -> c[3];
