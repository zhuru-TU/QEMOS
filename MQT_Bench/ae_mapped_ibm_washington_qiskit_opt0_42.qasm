...
sx q[47];
rz(pi/2) q[47];
barrier q[47],q[35],q[46],q[28],q[48],q[44],q[45],q[43],q[25],q[26],q[27],q[24],q[34],q[29],q[42],q[16],q[4],q[3],q[0],q[18],q[20],q[21],q[15],q[19],q[22],q[23],q[49],q[41],q[8],q[30],q[12],q[11],q[10],q[13],q[17],q[9],q[31],q[7],q[6],q[2],q[1],q[37];
measure q[47] -> meas[0];
measure q[35] -> meas[1];
measure q[46] -> meas[2];
measure q[28] -> meas[3];
