...
rz(0) q[0];
sx q[0];
rz(3.1422274489947393) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(6.28298636194771) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.141547471609233) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
...
rz(0) q[5];
sx q[5];
rz(1.9256888323145593) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(3.1397327974086315) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(1.574448736155889) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
...
rz(0) q[11];
sx q[11];
rz(4.83994270806923) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
rz(0.37602902297912744) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[13];
sx q[13];
rz(1.572607602125888) q[13];
sx q[13];
rz(3*pi) q[13];
cx q[12],q[13];
cx q[13],q[12];
...
rz(0) q[10];
sx q[10];
rz(3.2094673201342085) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(0.3369444591128157) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[11];
sx q[11];
rz(4.711325036617251) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[17];
sx q[17];
rz(2.747870781260888) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[4];
sx q[4];
rz(3.2035635808037815) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(2.2018842205378553) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[7];
sx q[7];
rz(2.170835758267838) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(3.916401878364618) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
rz(0) q[3];
sx q[3];
rz(6.281487709762507) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.2043407268621795) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.7789033749975547) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(2.847346873255859) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(1.5687010382233575) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.138268046958567) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(4.034818976653713) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[29],q[17],q[11],q[12],q[28],q[8];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
