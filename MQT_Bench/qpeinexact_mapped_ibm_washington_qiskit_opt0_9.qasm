...
cx q[5],q[4];
cx q[4],q[5];
rz(1.3437671701878218) q[4];
cx q[4],q[3];
rz(-1.3437671701878218) q[3];
cx q[4],q[3];
rz(1.3437671701878218) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-0.9081166264282996) q[1];
cx q[1],q[0];
rz(0.9081166264282996) q[0];
cx q[1],q[0];
rz(-0.9081166264282996) q[0];
rz(1.325359400733194) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
rz(-1.325359400733194) q[2];
cx q[1],q[2];
rz(1.325359400733194) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
rz(pi/2) q[3];
rz(-pi/4) q[4];
barrier q[7],q[0],q[1],q[6],q[2],q[5],q[4],q[3],q[8];
measure q[7] -> c[0];
measure q[0] -> c[1];
measure q[1] -> c[2];
measure q[6] -> c[3];
