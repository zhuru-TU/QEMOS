...
sx q[40];
rz(pi/2) q[40];
barrier q[18],q[28],q[8],q[36],q[37],q[32],q[4],q[7],q[12],q[23],q[13],q[29],q[34],q[9],q[15],q[19],q[17],q[33],q[2],q[5],q[3],q[14],q[16],q[0],q[1],q[20],q[27],q[22],q[10],q[45],q[44],q[31],q[6],q[24],q[25],q[26],q[11],q[43],q[41],q[40],q[21];
measure q[18] -> meas[0];
measure q[28] -> meas[1];
measure q[8] -> meas[2];
measure q[36] -> meas[3];
