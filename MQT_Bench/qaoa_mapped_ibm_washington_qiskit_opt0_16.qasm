...
rz(pi/2) q[1];
sx q[1];
rz(10.667770861554363) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[14];
sx q[14];
rz(10.667770861554363) q[14];
sx q[14];
rz(5*pi/2) q[14];
cx q[0],q[14];
rz(1.8985812338185082) q[14];
cx q[0],q[14];
rz(pi/2) q[15];
sx q[15];
rz(pi/2) q[15];
...
cx q[24],q[25];
cx q[24],q[23];
rz(-3.797587801745372) q[23];
cx q[24],q[23];
rz(pi/2) q[23];
sx q[23];
rz(10.667770861554363) q[23];
sx q[23];
rz(5*pi/2) q[23];
rz(pi/2) q[24];
sx q[24];
rz(10.667770861554363) q[24];
sx q[24];
rz(5*pi/2) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(pi/2) q[26];
sx q[26];
rz(10.667770861554363) q[26];
sx q[26];
rz(5*pi/2) q[26];
cx q[30],q[17];
cx q[17],q[30];
cx q[17],q[12];
rz(-3.797587801745372) q[12];
cx q[17],q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
...
cx q[28],q[29];
cx q[27],q[28];
rz(-3.797587801745372) q[28];
cx q[27],q[28];
rz(pi/2) q[30];
sx q[30];
rz(10.667770861554363) q[30];
sx q[30];
rz(5*pi/2) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
cx q[4],q[15];
cx q[4],q[3];
rz(1.8985812338185082) q[3];
cx q[4],q[3];
rz(pi/2) q[3];
sx q[3];
rz(3.7975681223161137) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[4];
sx q[4];
rz(3.7975681223161137) q[4];
sx q[4];
rz(5*pi/2) q[4];
cx q[24],q[23];
rz(1.8985812338185082) q[23];
...
rz(pi/2) q[23];
sx q[23];
rz(3.7975681223161137) q[23];
sx q[23];
rz(5*pi/2) q[23];
rz(1.8985812338185082) q[26];
cx q[16],q[26];
rz(pi/2) q[27];
sx q[27];
rz(10.667770861554363) q[27];
sx q[27];
rz(5*pi/2) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
cx q[7],q[8];
cx q[6],q[7];
rz(1.8985812338185082) q[7];
cx q[6],q[7];
rz(pi/2) q[6];
sx q[6];
rz(3.7975681223161137) q[6];
sx q[6];
rz(5*pi/2) q[6];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[25],q[26];
cx q[24],q[25];
rz(1.8985812338185082) q[25];
cx q[24],q[25];
rz(pi/2) q[24];
sx q[24];
rz(3.7975681223161137) q[24];
sx q[24];
rz(5*pi/2) q[24];
rz(pi/2) q[25];
sx q[25];
rz(3.7975681223161137) q[25];
sx q[25];
rz(5*pi/2) q[25];
rz(pi/2) q[29];
sx q[29];
rz(10.667770861554363) q[29];
sx q[29];
rz(5*pi/2) q[29];
rz(pi/2) q[30];
sx q[30];
...
cx q[17],q[30];
cx q[12],q[17];
rz(1.8985812338185082) q[17];
cx q[12],q[17];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
cx q[30],q[29];
rz(-3.797587801745372) q[29];
cx q[30],q[29];
cx q[28],q[29];
cx q[29],q[28];
cx q[28],q[29];
...
rz(pi/2) q[27];
sx q[27];
rz(3.7975681223161137) q[27];
sx q[27];
rz(5*pi/2) q[27];
rz(1.8985812338185082) q[30];
cx q[17],q[30];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
...
rz(pi/2) q[17];
sx q[17];
rz(3.7975681223161137) q[17];
sx q[17];
rz(5*pi/2) q[17];
rz(pi/2) q[30];
sx q[30];
rz(3.7975681223161137) q[30];
sx q[30];
rz(5*pi/2) q[30];
barrier q[0],q[23],q[14],q[29],q[6],q[8],q[12],q[4],q[16],q[27],q[24],q[26],q[17],q[30],q[3],q[25];
measure q[0] -> meas[0];
measure q[23] -> meas[1];
measure q[14] -> meas[2];
measure q[29] -> meas[3];
