...
sx q[54];
rz(pi/2) q[54];
barrier q[54],q[45],q[64],q[65],q[66],q[68],q[49],q[47],q[35],q[27],q[26],q[24],q[23],q[21],q[20],q[39],q[38],q[37],q[52],q[56],q[57],q[59],q[60],q[61],q[62],q[63],q[67],q[43],q[55],q[44],q[42],q[46],q[29],q[17],q[30],q[12],q[48],q[13],q[11],q[10],q[9],q[28],q[34],q[22],q[25],q[33],q[15],q[3],q[5],q[7],q[16],q[53],q[32],q[8],q[36],q[31],q[6],q[4],q[1],q[19],q[2],q[18],q[14],q[40];
measure q[54] -> meas[0];
measure q[45] -> meas[1];
measure q[64] -> meas[2];
measure q[65] -> meas[3];
