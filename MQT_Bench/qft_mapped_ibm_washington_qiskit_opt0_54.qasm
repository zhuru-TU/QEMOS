...
cx q[47],q[48];
cx q[48],q[47];
barrier q[34],q[48],q[43],q[68],q[27],q[28],q[17],q[35],q[64],q[51],q[32],q[49],q[65],q[54],q[22],q[5],q[7],q[26],q[8],q[4],q[42],q[3],q[1],q[33],q[18],q[40],q[14],q[41],q[38],q[19],q[39],q[20],q[21],q[66],q[15],q[25],q[16],q[6],q[2],q[44],q[45],q[9],q[10],q[31],q[36],q[46],q[11],q[12],q[30],q[29],q[55],q[23],q[47],q[24];
measure q[34] -> meas[0];
measure q[48] -> meas[1];
measure q[43] -> meas[2];
measure q[68] -> meas[3];
