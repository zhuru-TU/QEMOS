...
cx q[26],q[16];
cx q[16],q[26];
rz(1.1844953078787184) q[16];
cx q[16],q[8];
rz(-1.1844953078787184) q[8];
cx q[16],q[8];
rz(1.1844953078787184) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
cx q[3],q[2];
cx q[2],q[3];
rz(0.05118450226036758) q[2];
cx q[2],q[1];
rz(-0.05118450226036758) q[1];
cx q[2],q[1];
rz(0.05118450226036758) q[1];
cx q[1],q[2];
cx q[2],q[1];
