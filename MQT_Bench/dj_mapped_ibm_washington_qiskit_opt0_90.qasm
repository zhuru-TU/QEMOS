...
sx q[88];
rz(pi/2) q[88];
barrier q[35],q[56],q[14],q[4],q[0],q[7],q[1],q[2],q[5],q[12],q[11],q[13],q[9],q[10],q[8],q[3],q[6],q[31],q[22],q[33],q[18],q[19],q[15],q[20],q[21],q[23],q[16],q[28],q[27],q[29],q[17],q[32],q[36],q[24],q[25],q[26],q[30],q[89],q[34],q[52],q[37],q[38],q[39],q[41],q[44],q[54],q[46],q[47],q[51],q[49],q[55],q[50],q[43],q[42],q[45],q[48],q[40],q[58],q[57],q[71],q[53],q[59],q[61],q[60],q[64],q[65],q[74],q[73],q[67],q[69],q[70],q[63],q[62],q[66],q[68],q[72],q[83],q[77],q[76],q[75],q[78],q[79],q[80],q[81],q[82],q[84],q[85],q[86],q[88],q[87];
measure q[35] -> c[0];
measure q[56] -> c[1];
measure q[14] -> c[2];
measure q[4] -> c[3];
