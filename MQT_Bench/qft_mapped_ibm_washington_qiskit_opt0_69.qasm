...
cx q[55],q[68];
cx q[68],q[55];
barrier q[25],q[34],q[27],q[22],q[42],q[4],q[30],q[29],q[44],q[45],q[64],q[31],q[63],q[40],q[60],q[59],q[58],q[19],q[53],q[61],q[38],q[56],q[52],q[7],q[17],q[35],q[47],q[48],q[5],q[68],q[57],q[10],q[46],q[67],q[66],q[9],q[65],q[51],q[50],q[55],q[13],q[11],q[49],q[12],q[36],q[32],q[37],q[62],q[6],q[14],q[0],q[18],q[21],q[20],q[33],q[39],q[1],q[8],q[54],q[28],q[23],q[2],q[16],q[3],q[41],q[15],q[26],q[43],q[24];
measure q[25] -> meas[0];
measure q[34] -> meas[1];
measure q[27] -> meas[2];
measure q[22] -> meas[3];
