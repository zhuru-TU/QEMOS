...
cx q[19],q[18];
cx q[18],q[19];
rz(0.10236775111344266) q[18];
cx q[18],q[14];
rz(-0.10236775111344266) q[14];
cx q[18],q[14];
rz(0.10236775111344266) q[14];
cx q[14],q[18];
cx q[18],q[14];
cx q[14],q[18];
rz(0.20473550222688533) q[14];
cx q[14],q[0];
rz(-0.20473550222688533) q[0];
cx q[14],q[0];
rz(0.20473550222688533) q[0];
cx q[0],q[14];
cx q[14],q[0];
cx q[0],q[14];
rz(0.40947100445377066) q[0];
cx q[0],q[1];
rz(-0.40947100445377066) q[1];
cx q[0],q[1];
rz(0.40947100445377066) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
cx q[0],q[14];
rz(0.8189420089075413) q[1];
cx q[1],q[2];
rz(-0.8189420089075413) q[2];
cx q[1],q[2];
rz(0.8189420089075413) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-1.5037086357747105) q[2];
cx q[2],q[3];
rz(1.5037086357747105) q[3];
cx q[2],q[3];
rz(-1.5037086357747105) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.1341753820403722) q[3];
cx q[3],q[4];
rz(-0.1341753820403722) q[4];
cx q[3],q[4];
rz(0.1341753820403722) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.2683507640807444) q[4];
cx q[4],q[5];
rz(-0.2683507640807444) q[5];
cx q[4],q[5];
rz(0.2683507640807444) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[4],q[15];
rz(0.5367015281614888) q[5];
cx q[5],q[6];
rz(-0.5367015281614888) q[6];
cx q[5],q[6];
rz(0.5367015281614888) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.0734030563229775) q[6];
cx q[6],q[7];
rz(-1.0734030563229775) q[7];
cx q[6],q[7];
rz(1.0734030563229775) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1520195717021164) q[17];
cx q[17],q[12];
rz(-1.1520195717021164) q[12];
cx q[17],q[12];
rz(1.1520195717021164) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8375535101855601) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4664856332186729) q[11];
cx q[11],q[10];
rz(-1.4664856332186729) q[10];
cx q[11],q[10];
rz(1.4664856332186729) q[10];
cx q[10],q[11];
cx q[11],q[10];
cx q[10],q[11];
rz(-0.2086213871524472) q[10];
cx q[29],q[30];
cx q[30],q[29];
cx q[29],q[30];
cx q[30],q[17];
...
cx q[29],q[30];
cx q[17],q[30];
rz(-0.4172427743048944) q[29];
cx q[29],q[28];
rz(0.4172427743048944) q[28];
cx q[29],q[28];
rz(-0.4172427743048944) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.8344855486097889) q[25];
cx q[25],q[24];
rz(0.8344855486097889) q[24];
cx q[25],q[24];
rz(-0.8344855486097889) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
sx q[21];
rz(pi/2) q[21];
barrier q[0],q[3],q[15],q[6],q[26],q[28],q[13],q[11],q[17],q[12],q[30],q[29],q[27],q[25],q[24],q[23],q[22],q[19],q[20],q[21],q[2];
measure q[0] -> c[0];
measure q[3] -> c[1];
measure q[15] -> c[2];
measure q[6] -> c[3];
