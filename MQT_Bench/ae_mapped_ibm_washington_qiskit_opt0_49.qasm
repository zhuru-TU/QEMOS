...
rz(pi/2) q[21];
rz(-pi/4) q[22];
barrier q[21],q[22],q[23],q[20],q[33],q[39],q[40],q[38],q[37],q[41],q[42],q[43],q[34],q[25],q[27],q[35],q[47],q[46],q[28],q[45],q[26],q[36],q[17],q[31],q[30],q[29],q[32],q[12],q[16],q[8],q[11],q[44],q[48],q[10],q[7],q[13],q[6],q[5],q[15],q[24],q[3],q[4],q[2],q[0],q[14],q[19],q[18],q[1],q[9];
measure q[21] -> meas[0];
measure q[22] -> meas[1];
measure q[23] -> meas[2];
measure q[20] -> meas[3];
