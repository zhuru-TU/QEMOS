...
cx q[22],q[15];
cx q[15],q[22];
rz(0.10236899166797388) q[15];
cx q[15],q[4];
rz(-0.10236899166797388) q[4];
cx q[15],q[4];
rz(0.10236899166797388) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(0.20473798333594775) q[3];
cx q[3],q[2];
rz(-0.20473798333594775) q[2];
cx q[3],q[2];
rz(0.20473798333594775) q[2];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-1.503688786902211) q[2];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
cx q[2],q[3];
rz(1.503688786902211) q[3];
cx q[2],q[3];
rz(-1.503688786902211) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.13421507978537117) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.13421507978537117) q[4];
cx q[3],q[4];
rz(0.13421507978537117) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.26843015957074234) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.26843015957074234) q[5];
cx q[4],q[5];
rz(0.26843015957074234) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.5368603191414847) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.5368603191414847) q[6];
cx q[5],q[6];
rz(0.5368603191414847) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[5],q[4];
cx q[4],q[5];
rz(1.0737206382829694) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-1.0737206382829694) q[7];
cx q[6],q[7];
rz(1.0737206382829694) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1532898995420844) q[17];
cx q[17],q[12];
rz(-1.1532898995420844) q[12];
cx q[17],q[12];
rz(1.1532898995420844) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8350128545056245) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4715669445785442) q[11];
cx q[11],q[10];
rz(-1.4715669445785442) q[10];
cx q[11],q[10];
rz(1.4715669445785442) q[10];
rz(-0.19845876443270483) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.19845876443270483) q[12];
cx q[11],q[12];
rz(-0.19845876443270483) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.39691752886540965) q[25];
cx q[25],q[24];
rz(0.39691752886540965) q[24];
cx q[25],q[24];
rz(-0.39691752886540965) q[24];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
rz(-0.7938350577308193) q[24];
cx q[24],q[23];
rz(0.7938350577308193) q[23];
cx q[24],q[23];
rz(-0.7938350577308193) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[29],q[28];
cx q[28],q[29];
rz(-0.0337475773334841) q[29];
cx q[30],q[17];
cx q[17],q[30];
cx q[29],q[30];
rz(0.0337475773334841) q[30];
cx q[29],q[30];
cx q[28],q[29];
cx q[29],q[28];
cx q[28],q[29];
...
cx q[25],q[24];
cx q[24],q[25];
rz(-0.0674951546669682) q[24];
cx q[24],q[23];
rz(0.0674951546669682) q[23];
cx q[24],q[23];
rz(-0.0674951546669682) q[23];
cx q[22],q[23];
cx q[23],q[22];
...
cx q[23],q[22];
cx q[22],q[23];
rz(-0.1349903093339364) q[22];
cx q[22],q[21];
rz(0.1349903093339364) q[21];
cx q[22],q[21];
rz(-0.1349903093339364) q[21];
cx q[21],q[22];
cx q[22],q[21];
...
cx q[20],q[19];
rz(0.2699806186678728) q[19];
cx q[20],q[19];
rz(-0.2699806186678728) q[19];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
rz(-0.5399612373357456) q[19];
cx q[19],q[18];
rz(0.5399612373357456) q[18];
cx q[19],q[18];
rz(-0.5399612373357456) q[18];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[1],q[0];
cx q[0],q[1];
rz(-1.0799224746714913) q[19];
cx q[19],q[18];
rz(1.0799224746714913) q[18];
cx q[19],q[18];
rz(-1.0799224746714913) q[18];
cx q[14],q[18];
cx q[18],q[14];
...
rz(pi/2) q[14];
rz(-pi/4) q[18];
barrier q[20],q[21],q[23],q[22],q[15],q[6],q[8],q[25],q[26],q[28],q[30],q[11],q[10],q[12],q[17],q[29],q[27],q[16],q[7],q[5],q[3],q[1],q[0],q[19],q[18],q[14],q[2];
measure q[20] -> c[0];
measure q[21] -> c[1];
measure q[23] -> c[2];
measure q[22] -> c[3];
