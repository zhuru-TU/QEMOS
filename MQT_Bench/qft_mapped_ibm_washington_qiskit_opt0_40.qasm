...
cx q[33],q[39];
cx q[39],q[33];
barrier q[39],q[41],q[20],q[23],q[34],q[7],q[26],q[29],q[12],q[11],q[9],q[8],q[13],q[16],q[47],q[5],q[4],q[45],q[2],q[14],q[46],q[1],q[21],q[18],q[3],q[30],q[15],q[31],q[28],q[10],q[17],q[35],q[27],q[25],q[6],q[24],q[22],q[19],q[40],q[33];
measure q[39] -> meas[0];
measure q[41] -> meas[1];
measure q[20] -> meas[2];
measure q[23] -> meas[3];
