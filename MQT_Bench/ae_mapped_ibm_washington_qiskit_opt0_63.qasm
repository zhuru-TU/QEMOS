...
rz(pi/2) q[66];
rz(-pi/4) q[67];
barrier q[66],q[67],q[68],q[65],q[64],q[54],q[45],q[44],q[43],q[46],q[47],q[42],q[41],q[35],q[63],q[28],q[55],q[62],q[49],q[60],q[53],q[59],q[58],q[34],q[24],q[26],q[29],q[17],q[11],q[12],q[10],q[13],q[9],q[30],q[48],q[25],q[22],q[20],q[39],q[40],q[38],q[37],q[21],q[33],q[15],q[4],q[5],q[19],q[57],q[3],q[6],q[7],q[8],q[27],q[23],q[18],q[2],q[14],q[0],q[31],q[52],q[1],q[51];
measure q[66] -> meas[0];
measure q[67] -> meas[1];
measure q[68] -> meas[2];
measure q[65] -> meas[3];
