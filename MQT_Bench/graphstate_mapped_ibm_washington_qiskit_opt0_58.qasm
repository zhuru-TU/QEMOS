...
sx q[54];
rz(pi/2) q[54];
barrier q[50],q[7],q[8],q[14],q[6],q[19],q[22],q[36],q[5],q[9],q[47],q[12],q[13],q[31],q[0],q[34],q[4],q[51],q[37],q[21],q[16],q[18],q[3],q[52],q[40],q[35],q[26],q[11],q[29],q[10],q[23],q[30],q[28],q[1],q[2],q[15],q[32],q[44],q[56],q[20],q[39],q[48],q[53],q[46],q[63],q[27],q[41],q[43],q[49],q[55],q[17],q[45],q[42],q[33],q[24],q[25],q[38],q[54];
measure q[50] -> meas[0];
measure q[7] -> meas[1];
measure q[8] -> meas[2];
measure q[14] -> meas[3];
