...
rz(0) q[4];
sx q[4];
rz(4.058309873178505) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.6705733732216137) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[4];
rz(0) q[4];
sx q[4];
rz(3.3002061889254795) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(0) q[0];
sx q[0];
rz(3.534391286455619) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.3943775655067383) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.007352312261136) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(4.140069608839377) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.826180339196533) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(3.842925854659013) q[6];
sx q[6];
rz(3*pi) q[6];
barrier q[0],q[1],q[2],q[4],q[5],q[6],q[3];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
