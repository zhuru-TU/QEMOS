...
cx q[22],q[15];
cx q[15],q[22];
rz(0.40947602017046786) q[15];
cx q[15],q[4];
rz(-0.40947602017046786) q[4];
cx q[15],q[4];
rz(0.40947602017046786) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.8189520403409357) q[4];
cx q[4],q[3];
...
cx q[26],q[16];
cx q[16],q[26];
rz(-0.39669839871320567) q[16];
cx q[16],q[8];
rz(0.39669839871320567) q[8];
cx q[16],q[8];
rz(-0.39669839871320567) q[8];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[20],q[19];
cx q[19],q[20];
rz(-0.2559562889268182) q[19];
cx q[19],q[18];
rz(0.2559562889268182) q[18];
cx q[19],q[18];
rz(-0.2559562889268182) q[18];
cx q[18],q[19];
cx q[19],q[18];
cx q[18],q[19];
rz(-0.5119125778536364) q[18];
cx q[18],q[14];
rz(0.5119125778536364) q[14];
cx q[18],q[14];
rz(-0.5119125778536364) q[14];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[18],q[14];
cx q[14],q[18];
rz(-1.0238251557072728) q[19];
cx q[19],q[20];
rz(1.0238251557072728) q[20];
cx q[19],q[20];
rz(-1.0238251557072728) q[20];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
rz(1.0939423421752474) q[20];
cx q[21],q[22];
cx q[22],q[21];
cx q[21],q[22];
cx q[20],q[21];
rz(-1.0939423421752474) q[21];
cx q[20],q[21];
rz(1.0939423421752474) q[21];
cx q[20],q[21];
cx q[21],q[20];
...
sx q[1];
rz(pi/2) q[1];
barrier q[53],q[61],q[63],q[64],q[54],q[68],q[44],q[13],q[9],q[10],q[11],q[12],q[51],q[55],q[3],q[32],q[17],q[31],q[30],q[36],q[29],q[45],q[49],q[46],q[35],q[48],q[47],q[28],q[25],q[37],q[27],q[16],q[26],q[8],q[6],q[7],q[5],q[22],q[40],q[18],q[38],q[19],q[42],q[24],q[21],q[20],q[33],q[39],q[41],q[43],q[34],q[23],q[15],q[4],q[2],q[14],q[0],q[1],q[58];
measure q[53] -> c[0];
measure q[61] -> c[1];
measure q[63] -> c[2];
measure q[64] -> c[3];
