...
rz(0) q[1];
sx q[1];
rz(3.118694821994792) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(3.1644904851847944) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[1];
sx q[1];
rz(3.0500013272097877) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(3.2331839799697986) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[2];
sx q[2];
rz(2.958410000829782) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[3],q[2];
rz(0) q[2];
sx q[2];
rz(3.3247753063498044) q[2];
sx q[2];
rz(3*pi) q[2];
rz(pi/2) q[2];
sx q[2];
...
rz(pi/2) q[5];
x q[5];
barrier q[1],q[4],q[8],q[0],q[6],q[3],q[2],q[5],q[7];
measure q[1] -> meas[0];
measure q[4] -> meas[1];
measure q[8] -> meas[2];
measure q[0] -> meas[3];
