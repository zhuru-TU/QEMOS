...
cx q[47],q[46];
cx q[46],q[47];
barrier q[20],q[18],q[21],q[38],q[34],q[46],q[35],q[28],q[17],q[27],q[45],q[43],q[42],q[40],q[9],q[8],q[37],q[15],q[10],q[26],q[16],q[5],q[2],q[3],q[6],q[41],q[23],q[0],q[39],q[7],q[11],q[4],q[44],q[25],q[30],q[13],q[12],q[31],q[29],q[47],q[24],q[33],q[22],q[14],q[19];
measure q[20] -> meas[0];
measure q[18] -> meas[1];
measure q[21] -> meas[2];
measure q[38] -> meas[3];
