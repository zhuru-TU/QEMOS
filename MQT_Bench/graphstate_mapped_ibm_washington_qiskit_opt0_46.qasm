...
sx q[34];
rz(pi/2) q[34];
barrier q[16],q[6],q[3],q[1],q[5],q[4],q[15],q[7],q[11],q[9],q[12],q[13],q[47],q[10],q[38],q[33],q[27],q[32],q[0],q[2],q[18],q[14],q[20],q[41],q[19],q[21],q[8],q[31],q[28],q[29],q[17],q[48],q[44],q[24],q[26],q[30],q[43],q[34],q[42],q[39],q[37],q[40],q[25],q[22],q[35],q[23];
measure q[16] -> meas[0];
measure q[6] -> meas[1];
measure q[3] -> meas[2];
measure q[1] -> meas[3];
