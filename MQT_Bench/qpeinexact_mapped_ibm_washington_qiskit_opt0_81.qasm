...
cx q[53],q[41];
cx q[41],q[53];
rz(1.3473871871227625) q[41];
cx q[41],q[40];
rz(-1.3473871871227625) q[40];
cx q[41],q[40];
rz(1.3473871871227625) q[40];
cx q[40],q[41];
cx q[41],q[40];
...
cx q[33],q[20];
cx q[20],q[33];
rz(-0.44681827934426793) q[20];
cx q[20],q[19];
rz(0.44681827934426793) q[19];
cx q[20],q[19];
rz(-0.44681827934426793) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[22],q[15];
cx q[15],q[22];
rz(-0.8936365586885359) q[15];
cx q[15],q[4];
rz(0.8936365586885359) q[4];
cx q[15],q[4];
rz(-0.8936365586885359) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(1.3543195362127214) q[4];
cx q[4],q[3];
...
cx q[4],q[3];
rz(0.43295358116435007) q[3];
cx q[4],q[3];
rz(-0.43295358116435007) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-0.8659071623287001) q[4];
cx q[4],q[5];
rz(0.8659071623287001) q[5];
cx q[4],q[5];
rz(1.4097783289323929) q[4];
rz(-0.8659071623287001) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-1.4097783289323929) q[5];
cx q[4],q[5];
rz(1.4097783289323929) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(-0.32203599572500735) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(0.32203599572500735) q[6];
cx q[5],q[6];
rz(-0.32203599572500735) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[5],q[4];
cx q[4],q[5];
rz(-0.6440719914500147) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(0.6440719914500147) q[7];
cx q[6],q[7];
rz(-0.6440719914500147) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-1.2881439829000294) q[28];
cx q[28],q[29];
rz(1.2881439829000294) q[29];
cx q[28],q[29];
rz(-1.2881439829000294) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.5653046877897342) q[17];
cx q[17],q[12];
rz(-0.5653046877897342) q[12];
cx q[17],q[12];
rz(0.5653046877897342) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(1.1306093755794684) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-0.8803739024308563) q[11];
cx q[11],q[10];
rz(0.8803739024308563) q[10];
cx q[11],q[10];
rz(-0.8803739024308563) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(1.3808448487280804) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(-1.3808448487280804) q[12];
cx q[11],q[12];
rz(1.3808448487280804) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[26],q[16];
cx q[16],q[26];
rz(-0.37990295613363223) q[16];
cx q[16],q[8];
rz(0.37990295613363223) q[8];
cx q[16],q[8];
rz(-0.37990295613363223) q[8];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.7598059122672645) q[25];
cx q[25],q[24];
rz(0.7598059122672645) q[24];
cx q[25],q[24];
rz(-0.7598059122672645) q[24];
cx q[25],q[26];
cx q[26],q[25];
...
rz(-pi/16) q[82];
rz(-pi/128) q[83];
barrier q[57],q[84],q[37],q[52],q[53],q[56],q[38],q[21],q[9],q[77],q[70],q[32],q[85],q[69],q[51],q[36],q[68],q[67],q[50],q[42],q[14],q[41],q[19],q[40],q[33],q[39],q[15],q[1],q[20],q[18],q[0],q[2],q[6],q[3],q[7],q[5],q[4],q[22],q[23],q[8],q[31],q[10],q[55],q[13],q[11],q[12],q[17],q[30],q[35],q[34],q[29],q[28],q[16],q[26],q[27],q[25],q[24],q[49],q[48],q[54],q[43],q[44],q[47],q[46],q[45],q[73],q[60],q[63],q[61],q[65],q[64],q[66],q[62],q[83],q[72],q[78],q[82],q[79],q[81],q[80],q[75];
measure q[57] -> c[0];
measure q[84] -> c[1];
measure q[37] -> c[2];
measure q[52] -> c[3];
