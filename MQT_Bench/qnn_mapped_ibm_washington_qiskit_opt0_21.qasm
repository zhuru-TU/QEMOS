...
rz(0) q[11];
sx q[11];
rz(3.9854681985480234) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(3.85006381388435) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[17],q[30];
cx q[30],q[17];
...
rz(0) q[24];
sx q[24];
rz(3.962509205199552) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.571611906578603) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[24],q[25];
cx q[23],q[24];
...
rz(0) q[25];
sx q[25];
rz(3.7211007229290685) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[27];
sx q[27];
rz(3.2079780534972255) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[10];
sx q[10];
rz(3.1626108465132505) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(4.017970903933456) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[20];
sx q[20];
rz(3.3077118367135396) q[20];
sx q[20];
rz(3*pi) q[20];
rz(0) q[22];
sx q[22];
rz(3.78440140622165) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[15],q[22];
cx q[22],q[15];
...
rz(0) q[0];
sx q[0];
rz(3.450203306361929) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.8750587843134268) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.9106520687573822) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.6517214449357676) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[15];
sx q[15];
rz(3.613314692684337) q[15];
sx q[15];
rz(3*pi) q[15];
rz(0) q[23];
sx q[23];
rz(4.036057694526051) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[25];
sx q[25];
rz(3.700566060962151) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[29];
sx q[29];
rz(3.7596193726666454) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[15],q[21],q[20],q[22],q[23],q[25],q[29],q[17],q[11],q[10],q[12],q[30],q[28],q[27],q[24],q[19],q[26];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
