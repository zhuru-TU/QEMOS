...
cx q[4],q[3];
rz(1.5036885812580307) q[3];
cx q[4],q[3];
rz(-1.5036885812580307) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.13421549107373182) q[4];
cx q[4],q[5];
rz(-0.13421549107373182) q[5];
cx q[4],q[5];
rz(0.26843098214746364) q[4];
rz(0.13421549107373182) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.26843098214746364) q[5];
cx q[4],q[5];
rz(0.26843098214746364) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(0.5368619642949273) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.5368619642949273) q[6];
cx q[5],q[6];
rz(0.5368619642949273) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[4],q[5];
cx q[4],q[15];
rz(1.0737239285898545) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-1.0737239285898545) q[7];
cx q[6],q[7];
rz(1.0737239285898545) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.471619589488706) q[11];
cx q[11],q[10];
rz(-1.471619589488706) q[10];
cx q[11],q[10];
rz(1.471619589488706) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.19835347461238112) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.19835347461238112) q[12];
cx q[11],q[12];
rz(-0.19835347461238112) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[20],q[19];
cx q[19],q[20];
rz(-0.2565035216664369) q[19];
cx q[19],q[18];
rz(0.2565035216664369) q[18];
cx q[19],q[18];
rz(-0.2565035216664369) q[18];
cx q[18],q[19];
cx q[19],q[18];
cx q[18],q[19];
rz(-0.5130070433328738) q[18];
cx q[18],q[14];
rz(0.5130070433328738) q[14];
cx q[18],q[14];
rz(-0.5130070433328738) q[14];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[18],q[14];
cx q[14],q[18];
rz(-1.0260140866657477) q[19];
cx q[19],q[20];
rz(1.0260140866657477) q[20];
cx q[19],q[20];
rz(-1.0260140866657477) q[20];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
rz(1.0895644802582976) q[20];
cx q[21],q[22];
cx q[22],q[21];
cx q[21],q[22];
cx q[20],q[21];
rz(-1.0895644802582976) q[21];
cx q[20],q[21];
rz(1.0895644802582976) q[21];
cx q[20],q[21];
cx q[21],q[20];
cx q[20],q[21];
cx q[20],q[33];
rz(-0.9624636930731979) q[21];
cx q[22],q[23];
cx q[23],q[22];
cx q[22],q[23];
cx q[21],q[22];
rz(0.9624636930731979) q[22];
cx q[21],q[22];
rz(-0.9624636930731979) q[22];
cx q[21],q[22];
cx q[22],q[21];
...
cx q[24],q[25];
cx q[23],q[24];
rz(-1.2166652674433973) q[24];
cx q[23],q[24];
rz(1.2166652674433973) q[24];
cx q[23],q[24];
cx q[24],q[23];
cx q[23],q[24];
rz(-0.7082621187029985) q[24];
cx q[26],q[16];
cx q[16],q[26];
cx q[8],q[16];
cx q[16],q[8];
...
cx q[25],q[26];
cx q[24],q[25];
rz(0.7082621187029985) q[25];
cx q[24],q[25];
rz(-0.7082621187029985) q[25];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
rz(-1.416524237405997) q[25];
cx q[26],q[27];
cx q[27],q[26];
cx q[26],q[27];
cx q[25],q[26];
rz(1.416524237405997) q[26];
cx q[25],q[26];
rz(-1.416524237405997) q[26];
cx q[25],q[26];
cx q[26],q[25];
cx q[25],q[26];
rz(0.30854417877779905) q[26];
cx q[27],q[28];
cx q[28],q[27];
cx q[27],q[28];
cx q[26],q[27];
rz(-0.30854417877779905) q[27];
cx q[26],q[27];
rz(0.30854417877779905) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(pi/2) q[45];
rz(-pi/4) q[54];
barrier q[57],q[58],q[52],q[0],q[14],q[18],q[8],q[2],q[13],q[9],q[10],q[11],q[12],q[55],q[7],q[6],q[5],q[4],q[3],q[1],q[37],q[16],q[63],q[46],q[51],q[36],q[33],q[48],q[49],q[50],q[32],q[17],q[39],q[24],q[19],q[20],q[15],q[23],q[21],q[22],q[38],q[40],q[34],q[28],q[25],q[31],q[26],q[30],q[29],q[27],q[35],q[47],q[64],q[43],q[41],q[62],q[59],q[61],q[60],q[53],q[42],q[44],q[54],q[45],q[56];
measure q[57] -> c[0];
measure q[58] -> c[1];
measure q[52] -> c[2];
measure q[0] -> c[3];
