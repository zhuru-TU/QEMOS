...
cx q[24],q[34];
cx q[34],q[24];
barrier q[40],q[33],q[34],q[42],q[44],q[23],q[15],q[53],q[21],q[54],q[47],q[28],q[16],q[63],q[49],q[65],q[61],q[8],q[6],q[18],q[48],q[37],q[14],q[0],q[31],q[13],q[12],q[10],q[9],q[30],q[11],q[17],q[55],q[38],q[29],q[46],q[19],q[2],q[7],q[3],q[64],q[62],q[60],q[26],q[27],q[35],q[45],q[5],q[41],q[4],q[22],q[25],q[43],q[24],q[20],q[39];
measure q[40] -> meas[0];
measure q[33] -> meas[1];
measure q[34] -> meas[2];
measure q[42] -> meas[3];
