...
cx q[20],q[19];
cx q[19],q[20];
rz(0.10236850012749925) q[19];
cx q[19],q[18];
rz(-0.10236850012749925) q[18];
cx q[19],q[18];
rz(0.10236850012749925) q[18];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[18],q[14];
cx q[14],q[18];
rz(0.2047370002549985) q[14];
cx q[14],q[0];
rz(-0.2047370002549985) q[0];
cx q[14],q[0];
rz(0.2047370002549985) q[0];
cx q[0],q[14];
cx q[14],q[0];
cx q[0],q[14];
rz(0.409474000509997) q[0];
cx q[0],q[1];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-1.5036966515498051) q[2];
cx q[2],q[3];
rz(1.5036966515498051) q[3];
cx q[2],q[3];
rz(-1.5036966515498051) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.1341993504901829) q[3];
cx q[3],q[4];
rz(-0.1341993504901829) q[4];
cx q[3],q[4];
rz(0.1341993504901829) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.2683987009803658) q[4];
cx q[4],q[5];
rz(-0.2683987009803658) q[5];
cx q[4],q[5];
rz(0.2683987009803658) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.5367974019607316) q[5];
cx q[5],q[6];
rz(-0.5367974019607316) q[6];
cx q[5],q[6];
rz(0.5367974019607316) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.0735948039214631) q[6];
cx q[6],q[7];
rz(-1.0735948039214631) q[7];
cx q[6],q[7];
rz(1.0735948039214631) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1527865620960593) q[17];
cx q[17],q[12];
rz(-1.1527865620960593) q[12];
cx q[17],q[12];
rz(1.1527865620960593) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8360195293976744) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4695535947944443) q[11];
cx q[11],q[10];
rz(-1.4695535947944443) q[10];
cx q[11],q[10];
rz(1.4695535947944443) q[10];
cx q[10],q[11];
cx q[11],q[10];
cx q[10],q[11];
rz(-0.20248546400090464) q[10];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
cx q[12],q[13];
...
cx q[29],q[30];
cx q[17],q[30];
rz(-0.4049709280018093) q[29];
cx q[29],q[28];
rz(0.4049709280018093) q[28];
cx q[29],q[28];
rz(-0.4049709280018093) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
cx q[27],q[26];
cx q[26],q[27];
rz(-0.8099418560036186) q[26];
cx q[26],q[25];
rz(0.8099418560036186) q[25];
cx q[26],q[25];
cx q[16],q[26];
rz(-0.8099418560036186) q[25];
cx q[24],q[25];
...
sx q[1];
rz(pi/2) q[1];
barrier q[20],q[21],q[22],q[3],q[6],q[16],q[28],q[30],q[10],q[11],q[12],q[17],q[29],q[27],q[25],q[23],q[15],q[4],q[2],q[0],q[1],q[18];
measure q[20] -> c[0];
measure q[21] -> c[1];
measure q[22] -> c[2];
measure q[3] -> c[3];
