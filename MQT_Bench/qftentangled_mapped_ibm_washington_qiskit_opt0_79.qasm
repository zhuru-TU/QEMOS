...
cx q[43],q[44];
cx q[44],q[43];
barrier q[44],q[61],q[34],q[54],q[78],q[39],q[65],q[48],q[47],q[29],q[51],q[17],q[66],q[32],q[85],q[68],q[15],q[49],q[73],q[9],q[81],q[8],q[22],q[2],q[40],q[18],q[19],q[53],q[23],q[70],q[72],q[59],q[42],q[87],q[86],q[69],q[4],q[67],q[80],q[6],q[27],q[50],q[37],q[14],q[62],q[16],q[5],q[57],q[38],q[82],q[64],q[41],q[21],q[3],q[20],q[1],q[26],q[7],q[74],q[10],q[13],q[63],q[25],q[55],q[83],q[31],q[11],q[12],q[36],q[30],q[28],q[35],q[46],q[33],q[77],q[45],q[24],q[60],q[43];
measure q[44] -> meas[0];
measure q[61] -> meas[1];
measure q[34] -> meas[2];
measure q[54] -> meas[3];
