...
cx q[55],q[49];
cx q[49],q[55];
barrier q[18],q[33],q[41],q[0],q[26],q[29],q[28],q[25],q[22],q[24],q[46],q[45],q[44],q[21],q[32],q[54],q[49],q[68],q[10],q[11],q[8],q[9],q[60],q[64],q[61],q[6],q[67],q[66],q[65],q[38],q[5],q[3],q[20],q[4],q[16],q[7],q[15],q[43],q[48],q[55],q[42],q[40],q[34],q[31],q[35],q[47],q[13],q[23],q[12],q[17],q[30],q[27],q[1],q[53],q[39],q[14];
measure q[18] -> meas[0];
measure q[33] -> meas[1];
measure q[41] -> meas[2];
measure q[0] -> meas[3];
