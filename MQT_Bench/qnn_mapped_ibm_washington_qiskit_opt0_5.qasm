...
rz(0) q[3];
sx q[3];
rz(3.302134748069393) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.739964398522525) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[4],q[3];
cx q[2],q[3];
...
rz(0) q[0];
sx q[0];
rz(3.215382599378768) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.4971119106301285) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.328195707030176) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(4.0267181680423585) q[4];
sx q[4];
rz(3*pi) q[4];
