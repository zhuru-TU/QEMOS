...
cx q[47],q[35];
cx q[35],q[47];
barrier q[20],q[33],q[14],q[22],q[4],q[26],q[25],q[16],q[8],q[31],q[32],q[7],q[21],q[35],q[48],q[46],q[23],q[41],q[45],q[42],q[44],q[24],q[43],q[55],q[39],q[63],q[61],q[64],q[56],q[67],q[68],q[66],q[65],q[58],q[36],q[57],q[62],q[59],q[50],q[37],q[60],q[52],q[40],q[54],q[53],q[34],q[49],q[6],q[47],q[5],q[11],q[12],q[17],q[30],q[29],q[28],q[27],q[3],q[15],q[0],q[18],q[19];
measure q[20] -> meas[0];
measure q[33] -> meas[1];
measure q[14] -> meas[2];
measure q[22] -> meas[3];
