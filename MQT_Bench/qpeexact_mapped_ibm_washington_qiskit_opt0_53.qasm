...
cx q[39],q[33];
cx q[33],q[39];
rz(0.10236796503964359) q[33];
cx q[33],q[20];
rz(-0.10236796503964359) q[20];
cx q[33],q[20];
rz(0.10236796503964359) q[20];
cx q[20],q[33];
cx q[33],q[20];
...
cx q[19],q[18];
cx q[18],q[19];
rz(0.20473593007928717) q[18];
cx q[18],q[14];
rz(-0.20473593007928717) q[14];
cx q[18],q[14];
rz(0.20473593007928717) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(0.40947186015857434) q[0];
cx q[0],q[1];
rz(-0.40947186015857434) q[1];
cx q[0],q[1];
rz(0.40947186015857434) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(0.8189437203171487) q[1];
cx q[1],q[2];
rz(-0.8189437203171487) q[2];
cx q[1],q[2];
rz(0.8189437203171487) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-1.5037052129554958) q[2];
cx q[2],q[3];
rz(1.5037052129554958) q[3];
cx q[2],q[3];
rz(-1.5037052129554958) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.13418222767880175) q[3];
cx q[3],q[4];
rz(-0.13418222767880175) q[4];
cx q[3],q[4];
rz(0.13418222767880175) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.2683644553576035) q[4];
cx q[4],q[5];
rz(-0.2683644553576035) q[5];
cx q[4],q[5];
rz(0.2683644553576035) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[6],q[5];
cx q[5],q[6];
rz(1.073457821430414) q[6];
cx q[6],q[7];
rz(-1.073457821430414) q[7];
cx q[6],q[7];
rz(1.073457821430414) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[27],q[26];
cx q[26],q[27];
rz(-0.9946770107289652) q[28];
cx q[28],q[29];
rz(0.9946770107289652) q[29];
cx q[28],q[29];
rz(-0.9946770107289652) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1522386321318627) q[17];
cx q[17],q[12];
rz(-1.1522386321318627) q[12];
cx q[17],q[12];
rz(1.1522386321318627) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8371153893260677) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4673618749376578) q[11];
cx q[11],q[10];
rz(-1.4673618749376578) q[10];
cx q[11],q[10];
rz(1.4673618749376578) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.2068689037144777) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.2068689037144777) q[12];
cx q[11],q[12];
rz(-0.2068689037144777) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[30],q[29];
cx q[29],q[30];
rz(-0.4137378074289554) q[29];
cx q[29],q[28];
rz(0.4137378074289554) q[28];
cx q[29],q[28];
rz(-0.4137378074289554) q[28];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.8274756148579108) q[25];
cx q[25],q[24];
rz(0.8274756148579108) q[24];
cx q[25],q[24];
rz(-0.8274756148579108) q[24];
cx q[25],q[26];
cx q[26],q[25];
...
rz(pi/2) q[0];
rz(-pi/4) q[14];
barrier q[52],q[37],q[38],q[19],q[40],q[6],q[7],q[16],q[9],q[8],q[17],q[13],q[10],q[12],q[11],q[29],q[51],q[32],q[30],q[31],q[36],q[49],q[25],q[48],q[5],q[26],q[45],q[28],q[46],q[3],q[35],q[27],q[47],q[44],q[42],q[33],q[39],q[41],q[24],q[43],q[34],q[20],q[23],q[22],q[21],q[15],q[4],q[2],q[1],q[18],q[14],q[0],q[50];
measure q[52] -> c[0];
measure q[37] -> c[1];
measure q[38] -> c[2];
measure q[19] -> c[3];
