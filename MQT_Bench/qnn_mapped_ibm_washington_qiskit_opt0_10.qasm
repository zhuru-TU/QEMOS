...
rz(0) q[26];
sx q[26];
rz(4.1163272632507315) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.4902790358420988) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(4.106051101160742) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[16],q[26];
cx q[26],q[16];
...
rz(0) q[0];
sx q[0];
rz(3.772993956162413) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.415106318619721) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.234926284919094) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.5010910345068744) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.8540253071955526) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.2351679325588902) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(4.02154910557551) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.7783487633006247) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[28];
sx q[28];
rz(3.4496311142522704) q[28];
sx q[28];
rz(3*pi) q[28];
barrier q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[28],q[26];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
