...
rz(0) q[3];
sx q[3];
rz(3.8884548081952013) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[14];
sx q[14];
rz(4.138183028256743) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[18];
sx q[18];
rz(4.071423903209671) q[18];
sx q[18];
rz(3*pi) q[18];
rz(0) q[19];
sx q[19];
rz(3.7403252987574946) q[19];
sx q[19];
rz(3*pi) q[19];
rz(0) q[20];
sx q[20];
rz(3.338023848035431) q[20];
sx q[20];
rz(3*pi) q[20];
rz(0) q[21];
sx q[21];
rz(3.395162128887631) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[15];
cx q[15],q[22];
...
rz(0) q[26];
sx q[26];
rz(3.2192288212392555) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(4.0646738836707454) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(3.9284325011972943) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[1];
sx q[1];
rz(3.6736540709867773) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.839472874973347) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.4259569937678913) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(0) q[0];
sx q[0];
rz(3.6173142332541026) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[15];
sx q[15];
rz(3.9190801822797203) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[18],q[14];
rz(0) q[14];
sx q[14];
rz(3.22043180817398) q[14];
sx q[14];
rz(3*pi) q[14];
cx q[19],q[18];
rz(0) q[18];
sx q[18];
rz(3.3739730795789598) q[18];
sx q[18];
rz(3*pi) q[18];
cx q[20],q[19];
rz(0) q[19];
sx q[19];
rz(3.8645986287003566) q[19];
sx q[19];
rz(3*pi) q[19];
cx q[21],q[20];
rz(0) q[20];
sx q[20];
rz(3.819101051128418) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[20],q[33];
cx q[22],q[21];
...
rz(0) q[22];
sx q[22];
rz(4.096893248871199) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[23];
sx q[23];
rz(4.032659696497534) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[24];
sx q[24];
rz(3.278502192701484) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.308112457981123) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[26],q[16];
cx q[16],q[26];
...
rz(0) q[27];
sx q[27];
rz(3.428479339774554) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[28];
sx q[28];
rz(3.889456663461324) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[28],q[29];
cx q[29],q[28];
...
rz(0) q[10];
sx q[10];
rz(3.2281841729593572) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.8039661991575593) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
rz(0) q[13];
sx q[13];
rz(3.682048945157389) q[13];
sx q[13];
rz(3*pi) q[13];
rz(0) q[30];
sx q[30];
rz(3.403532940360194) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[30],q[31];
cx q[31],q[30];
...
rz(0) q[12];
sx q[12];
rz(3.354067703018504) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[30],q[17];
rz(0) q[17];
sx q[17];
rz(3.68366976734455) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[4];
sx q[4];
rz(3.177722134131535) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[6];
sx q[6];
rz(3.355577000808457) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[26];
sx q[26];
rz(3.81905364411968) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.2118432407551265) q[27];
sx q[27];
rz(3*pi) q[27];
barrier q[27],q[26],q[4],q[5],q[6],q[8],q[28],q[17],q[12],q[10],q[11],q[9],q[13],q[32],q[30],q[16],q[23],q[20],q[21],q[33],q[19],q[18],q[14],q[0],q[1],q[2],q[3],q[15],q[22],q[24],q[25],q[29],q[31],q[7];
measure q[27] -> meas[0];
measure q[26] -> meas[1];
measure q[4] -> meas[2];
measure q[5] -> meas[3];
