...
cx q[44],q[43];
cx q[43],q[44];
rz(0.10236796503964359) q[43];
cx q[43],q[42];
rz(-0.10236796503964359) q[42];
cx q[43],q[42];
cx q[34],q[43];
rz(0.10236796503964359) q[42];
cx q[43],q[34];
...
cx q[23],q[22];
cx q[22],q[23];
rz(0.20473593007928717) q[22];
cx q[22],q[15];
rz(-0.20473593007928717) q[15];
cx q[22],q[15];
rz(0.20473593007928717) q[15];
cx q[15],q[22];
cx q[22],q[15];
...
cx q[15],q[4];
cx q[4],q[15];
rz(0.40947186015857434) q[4];
cx q[4],q[3];
rz(-0.40947186015857434) q[3];
cx q[4],q[3];
rz(0.40947186015857434) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[25],q[26];
cx q[16],q[26];
rz(-0.4137378074289554) q[25];
cx q[25],q[24];
rz(0.4137378074289554) q[24];
cx q[25],q[24];
rz(-0.4137378074289554) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[25],q[24];
cx q[24],q[25];
rz(1.4866414238739716) q[25];
cx q[26],q[16];
cx q[16],q[26];
cx q[25],q[26];
rz(-1.4866414238739716) q[26];
cx q[25],q[26];
rz(1.4866414238739716) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(pi/2) q[39];
rz(-pi/4) q[40];
barrier q[45],q[6],q[5],q[22],q[37],q[42],q[38],q[43],q[44],q[34],q[50],q[49],q[48],q[46],q[47],q[13],q[9],q[36],q[32],q[10],q[31],q[35],q[11],q[12],q[17],q[30],q[29],q[28],q[27],q[21],q[26],q[7],q[8],q[16],q[25],q[24],q[23],q[15],q[4],q[3],q[2],q[1],q[0],q[14],q[18],q[19],q[20],q[33],q[41],q[40],q[39],q[51];
measure q[45] -> c[0];
measure q[6] -> c[1];
measure q[5] -> c[2];
measure q[22] -> c[3];
