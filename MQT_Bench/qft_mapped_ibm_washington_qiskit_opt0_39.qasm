...
cx q[45],q[46];
cx q[46],q[45];
barrier q[18],q[22],q[19],q[4],q[21],q[24],q[16],q[25],q[46],q[28],q[30],q[7],q[12],q[11],q[35],q[44],q[13],q[10],q[47],q[31],q[6],q[42],q[9],q[43],q[2],q[34],q[17],q[29],q[26],q[27],q[45],q[20],q[8],q[23],q[3],q[5],q[0],q[15],q[14];
measure q[18] -> meas[0];
measure q[22] -> meas[1];
measure q[19] -> meas[2];
measure q[4] -> meas[3];
