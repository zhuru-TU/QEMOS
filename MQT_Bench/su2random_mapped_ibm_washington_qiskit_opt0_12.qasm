...
sx q[27];
rz(3*pi) q[27];
rz(3.9350782083455442) q[27];
cx q[27],q[28];
cx q[28],q[27];
cx q[27],q[28];
rz(0) q[29];
sx q[29];
rz(7.023137055968935) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0.29465826494733527) q[29];
cx q[29],q[30];
cx q[30],q[29];
cx q[29],q[30];
cx q[17],q[30];
