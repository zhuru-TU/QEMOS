...
cx q[47],q[46];
cx q[46],q[47];
barrier q[21],q[22],q[15],q[24],q[39],q[23],q[46],q[35],q[44],q[29],q[54],q[41],q[64],q[43],q[62],q[53],q[60],q[61],q[40],q[0],q[65],q[27],q[18],q[9],q[67],q[6],q[55],q[68],q[8],q[26],q[32],q[7],q[10],q[48],q[49],q[11],q[13],q[66],q[16],q[2],q[5],q[14],q[59],q[33],q[12],q[63],q[25],q[17],q[31],q[42],q[30],q[45],q[28],q[47],q[34],q[38],q[3],q[4],q[19],q[20];
measure q[21] -> meas[0];
measure q[22] -> meas[1];
measure q[15] -> meas[2];
measure q[24] -> meas[3];
