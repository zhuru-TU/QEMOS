...
cx q[8],q[16];
cx q[16],q[8];
barrier q[16],q[28],q[24],q[25],q[30],q[11],q[12],q[26],q[6],q[5],q[34],q[4],q[20],q[2],q[1],q[19],q[42],q[41],q[40],q[46],q[45],q[44],q[43],q[3],q[31],q[47],q[35],q[21],q[9],q[7],q[17],q[13],q[10],q[29],q[22],q[23],q[27],q[8];
measure q[16] -> meas[0];
measure q[28] -> meas[1];
measure q[24] -> meas[2];
measure q[25] -> meas[3];
