...
rz(0) q[0];
sx q[0];
rz(2.8295186917352337) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(0.04022041149267963) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[2];
sx q[2];
rz(-0.9836919358268092) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(8.10911585799262) q[3];
sx q[3];
rz(3*pi) q[3];
rz(pi/2) q[3];
sx q[3];
...
rz(0) q[3];
sx q[3];
rz(-3.0703279613267123) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(-1.4626275711619305) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(0) q[1];
sx q[1];
rz(-1.332869105866056) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(-3.008661278364859) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(-1.6067395413053527) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(4.513757149316504) q[4];
sx q[4];
rz(3*pi) q[4];
