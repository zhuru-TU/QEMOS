...
cx q[2],q[3];
cx q[1],q[2];
rz(4.993720932699333) q[2];
cx q[1],q[2];
rz(pi/2) q[2];
sx q[2];
rz(11.92167149999652) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(pi/2) q[3];
sx q[3];
rz(11.92167149999652) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[9];
sx q[9];
...
cx q[0],q[14];
cx q[1],q[0];
rz(4.993720932699333) q[0];
cx q[1],q[0];
rz(pi/2) q[1];
sx q[1];
rz(11.92167149999652) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[8],q[16];
cx q[16],q[8];
...
rz(pi/2) q[5];
sx q[5];
rz(11.92167149999652) q[5];
sx q[5];
rz(5*pi/2) q[5];
rz(pi/2) q[6];
sx q[6];
rz(11.92167149999652) q[6];
sx q[6];
rz(5*pi/2) q[6];
cx q[16],q[26];
cx q[26],q[16];
...
cx q[12],q[17];
cx q[12],q[11];
rz(4.993720932699333) q[11];
cx q[12],q[11];
rz(pi/2) q[12];
sx q[12];
rz(11.92167149999652) q[12];
sx q[12];
rz(5*pi/2) q[12];
cx q[29],q[30];
cx q[30],q[29];
...
cx q[16],q[26];
cx q[8],q[16];
rz(4.993720932699333) q[16];
cx q[8],q[16];
rz(pi/2) q[8];
sx q[8];
rz(11.92167149999652) q[8];
sx q[8];
rz(5*pi/2) q[8];
cx q[27],q[28];
cx q[28],q[27];
...
cx q[23],q[24];
cx q[27],q[28];
rz(4.993720932699333) q[28];
cx q[27],q[28];
rz(pi/2) q[29];
sx q[29];
rz(11.92167149999652) q[29];
sx q[29];
rz(5*pi/2) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[15],q[22];
cx q[15],q[4];
rz(3.786274883257689) q[4];
cx q[15],q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
cx q[2],q[3];
rz(3.786274883257689) q[3];
cx q[2],q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
...
cx q[23],q[24];
cx q[23],q[22];
rz(3.786274883257689) q[22];
cx q[23],q[22];
cx q[15],q[22];
cx q[22],q[15];
cx q[15],q[22];
cx q[4],q[15];
rz(3.786274883257689) q[15];
cx q[4],q[15];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(pi/2) q[3];
sx q[3];
rz(1.289404758235431) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[22];
sx q[22];
rz(1.289404758235431) q[22];
sx q[22];
rz(5*pi/2) q[22];
rz(pi/2) q[23];
sx q[23];
rz(1.289404758235431) q[23];
sx q[23];
rz(5*pi/2) q[23];
cx q[26],q[16];
cx q[16],q[26];
...
cx q[16],q[26];
cx q[25],q[24];
rz(4.993720932699333) q[24];
cx q[25],q[24];
rz(pi/2) q[24];
sx q[24];
rz(11.92167149999652) q[24];
sx q[24];
rz(5*pi/2) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(pi/2) q[25];
sx q[25];
rz(11.92167149999652) q[25];
sx q[25];
rz(5*pi/2) q[25];
cx q[26],q[16];
cx q[16],q[26];
cx q[27],q[28];
rz(3.786274883257689) q[28];
cx q[27],q[28];
cx q[30],q[17];
cx q[17],q[30];
cx q[29],q[30];
...
rz(pi/2) q[25];
sx q[25];
rz(1.289404758235431) q[25];
sx q[25];
rz(5*pi/2) q[25];
rz(pi/2) q[28];
sx q[28];
rz(1.289404758235431) q[28];
sx q[28];
rz(5*pi/2) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(5*pi/2) q[28];
cx q[29],q[30];
rz(3.786274883257689) q[30];
cx q[29],q[30];
rz(pi/2) q[29];
sx q[29];
rz(1.289404758235431) q[29];
sx q[29];
rz(5*pi/2) q[29];
rz(pi/2) q[30];
sx q[30];
rz(1.289404758235431) q[30];
sx q[30];
rz(5*pi/2) q[30];
barrier q[26],q[23],q[27],q[3],q[28],q[22],q[4],q[2],q[6],q[15],q[7],q[29],q[25],q[30],q[24];
measure q[26] -> meas[0];
measure q[23] -> meas[1];
measure q[27] -> meas[2];
measure q[3] -> meas[3];
