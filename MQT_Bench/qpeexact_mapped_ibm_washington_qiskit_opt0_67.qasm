...
rz(-pi/128) q[23];
rz(-pi/1048576) q[68];
barrier q[34],q[56],q[6],q[19],q[58],q[0],q[1],q[18],q[37],q[14],q[66],q[65],q[64],q[54],q[45],q[62],q[63],q[59],q[57],q[52],q[33],q[38],q[39],q[40],q[53],q[61],q[60],q[41],q[43],q[42],q[44],q[46],q[26],q[25],q[29],q[9],q[13],q[10],q[11],q[12],q[17],q[30],q[31],q[32],q[51],q[50],q[68],q[55],q[49],q[48],q[47],q[35],q[28],q[27],q[16],q[7],q[5],q[24],q[2],q[23],q[20],q[21],q[22],q[15],q[3],q[4],q[67];
measure q[34] -> c[0];
measure q[56] -> c[1];
measure q[6] -> c[2];
measure q[19] -> c[3];
