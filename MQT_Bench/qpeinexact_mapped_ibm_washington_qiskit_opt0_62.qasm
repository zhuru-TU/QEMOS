...
cx q[18],q[14];
cx q[14],q[18];
rz(0.40947602017259566) q[14];
cx q[14],q[0];
rz(-0.40947602017259566) q[0];
cx q[14],q[0];
rz(0.40947602017259566) q[0];
cx q[0],q[14];
cx q[14],q[0];
cx q[0],q[14];
rz(0.8189520403451913) q[0];
cx q[0],q[1];
rz(-0.8189520403451913) q[1];
cx q[0],q[1];
rz(0.8189520403451913) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(-1.5036885728994107) q[1];
cx q[1],q[2];
rz(1.5036885728994107) q[2];
cx q[1],q[2];
rz(-1.5036885728994107) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
cx q[30],q[29];
cx q[29],q[30];
rz(-0.39669838999789847) q[29];
cx q[29],q[28];
rz(0.39669838999789847) q[28];
cx q[29],q[28];
rz(-0.39669838999789847) q[28];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[22],q[15];
rz(1.0238229245886235) q[15];
cx q[22],q[15];
rz(-1.0238229245886235) q[15];
cx q[15],q[22];
cx q[22],q[15];
cx q[15],q[22];
rz(1.093946804412546) q[15];
cx q[15],q[4];
rz(-1.093946804412546) q[4];
cx q[15],q[4];
rz(1.093946804412546) q[4];
cx q[15],q[22];
cx q[22],q[15];
...
cx q[26],q[16];
rz(0.6732035254690113) q[16];
cx q[26],q[16];
rz(-0.6732035254690113) q[16];
cx q[16],q[26];
cx q[26],q[16];
cx q[16],q[26];
rz(-1.3464070509380226) q[16];
cx q[16],q[8];
rz(1.3464070509380226) q[8];
cx q[16],q[8];
rz(-1.3464070509380226) q[8];
cx q[16],q[26];
cx q[26],q[16];
...
rz(pi/2) q[24];
rz(-pi/4) q[25];
barrier q[37],q[1],q[14],q[0],q[19],q[18],q[38],q[58],q[39],q[3],q[50],q[2],q[44],q[67],q[33],q[59],q[40],q[60],q[53],q[64],q[61],q[62],q[54],q[36],q[41],q[42],q[15],q[6],q[8],q[4],q[27],q[46],q[16],q[7],q[5],q[20],q[21],q[22],q[9],q[13],q[10],q[11],q[12],q[17],q[29],q[32],q[30],q[31],q[51],q[49],q[48],q[28],q[35],q[47],q[45],q[43],q[23],q[34],q[26],q[25],q[24],q[52];
measure q[37] -> c[0];
measure q[1] -> c[1];
measure q[14] -> c[2];
measure q[0] -> c[3];
