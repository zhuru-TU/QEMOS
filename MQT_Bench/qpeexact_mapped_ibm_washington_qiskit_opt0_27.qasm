...
cx q[22],q[15];
cx q[15],q[22];
rz(-1.346478460632523) q[15];
cx q[15],q[4];
rz(1.346478460632523) q[4];
cx q[15],q[4];
rz(-1.346478460632523) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(0.4486357323247472) q[3];
cx q[3],q[2];
rz(-0.4486357323247472) q[2];
cx q[3],q[2];
rz(0.4486357323247472) q[2];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
rz(-0.8972714646494944) q[1];
cx q[2],q[1];
rz(0.8972714646494944) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-1.3470497242908044) q[1];
cx q[1],q[0];
rz(1.3470497242908044) q[0];
cx q[1],q[0];
rz(-1.3470497242908044) q[0];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(0.4474932050081841) q[2];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
cx q[2],q[3];
rz(-0.4474932050081841) q[3];
cx q[2],q[3];
rz(0.4474932050081841) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.8949864100163683) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.8949864100163683) q[4];
cx q[3],q[4];
rz(0.8949864100163683) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3516198335570566) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(1.3516198335570566) q[5];
cx q[4],q[5];
rz(-1.3516198335570566) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.3652312382156469) q[17];
cx q[17],q[12];
rz(-0.3652312382156469) q[12];
cx q[17],q[12];
rz(0.3652312382156469) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.7304624764312938) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4609249528625876) q[11];
cx q[11],q[10];
rz(-1.4609249528625876) q[10];
cx q[11],q[10];
rz(1.4609249528625876) q[10];
rz(-0.2197427478646181) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.4394854957292362) q[25];
cx q[25],q[24];
rz(0.4394854957292362) q[24];
cx q[25],q[24];
rz(-0.4394854957292362) q[24];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
rz(-0.8789709914584724) q[24];
cx q[24],q[23];
rz(0.8789709914584724) q[23];
cx q[24],q[23];
rz(-0.8789709914584724) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[29],q[28];
cx q[28],q[29];
rz(-0.37429131224409645) q[29];
cx q[30],q[17];
cx q[17],q[30];
cx q[29],q[30];
rz(0.37429131224409645) q[30];
cx q[29],q[30];
cx q[28],q[29];
cx q[29],q[28];
cx q[28],q[29];
...
cx q[25],q[24];
cx q[24],q[25];
rz(-0.7485826244881929) q[24];
cx q[24],q[23];
rz(0.7485826244881929) q[23];
cx q[24],q[23];
rz(-0.7485826244881929) q[23];
cx q[22],q[23];
cx q[23],q[22];
