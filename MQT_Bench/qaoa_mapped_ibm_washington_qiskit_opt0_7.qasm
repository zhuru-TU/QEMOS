...
rz(pi/2) q[0];
sx q[0];
rz(-1.1979476144697587) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(pi/2) q[1];
sx q[1];
rz(-1.1979476144697587) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(-1.1979476144697587) q[2];
sx q[2];
rz(5*pi/2) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[1],q[0];
rz(4.3394572073669355) q[0];
cx q[1],q[0];
cx q[1],q[2];
rz(4.3394572073669355) q[2];
cx q[1],q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(4.3394572073669355) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(-0.8623614926447916) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(pi/2) q[1];
sx q[1];
rz(-0.8623614926447916) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(-0.8623614926447916) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(pi/2) q[5];
sx q[5];
...
cx q[4],q[5];
cx q[3],q[4];
rz(4.003838533646073) q[4];
cx q[3],q[4];
rz(pi/2) q[3];
sx q[3];
rz(-1.1979476144697587) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[6];
sx q[6];
rz(pi/2) q[6];
cx q[5],q[6];
rz(4.003838533646073) q[6];
cx q[5],q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(4.003838533646073) q[5];
cx q[4],q[5];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
...
cx q[5],q[6];
cx q[4],q[5];
rz(4.3394572073669355) q[5];
cx q[4],q[5];
cx q[4],q[3];
rz(4.3394572073669355) q[3];
cx q[4],q[3];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
...
rz(pi/2) q[4];
sx q[4];
rz(-0.8623614926447916) q[4];
sx q[4];
rz(5*pi/2) q[4];
rz(pi/2) q[5];
sx q[5];
rz(-0.8623614926447916) q[5];
sx q[5];
rz(5*pi/2) q[5];
rz(pi/2) q[6];
sx q[6];
rz(-0.8623614926447916) q[6];
sx q[6];
rz(5*pi/2) q[6];
barrier q[3],q[2],q[0],q[6],q[1],q[4],q[5];
measure q[3] -> meas[0];
measure q[2] -> meas[1];
measure q[0] -> meas[2];
measure q[6] -> meas[3];
