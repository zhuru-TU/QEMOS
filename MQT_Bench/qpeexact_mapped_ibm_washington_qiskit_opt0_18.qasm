...
cx q[15],q[4];
cx q[4],q[15];
rz(0.8971870133146144) q[4];
cx q[4],q[3];
rz(-0.8971870133146144) q[3];
cx q[4],q[3];
rz(0.8971870133146144) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
rz(pi/2) q[4];
rz(-pi/4096) q[30];
barrier q[24],q[6],q[17],q[16],q[26],q[30],q[29],q[28],q[27],q[25],q[23],q[20],q[21],q[22],q[15],q[3],q[4],q[5];
measure q[24] -> c[0];
measure q[6] -> c[1];
measure q[17] -> c[2];
measure q[16] -> c[3];
