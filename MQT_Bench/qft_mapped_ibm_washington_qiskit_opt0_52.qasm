...
cx q[51],q[50];
cx q[50],q[51];
barrier q[25],q[7],q[44],q[23],q[27],q[35],q[34],q[50],q[29],q[49],q[45],q[47],q[28],q[2],q[39],q[33],q[19],q[14],q[3],q[42],q[4],q[46],q[5],q[31],q[11],q[13],q[9],q[10],q[12],q[17],q[32],q[37],q[40],q[21],q[0],q[18],q[20],q[38],q[1],q[15],q[48],q[41],q[36],q[8],q[51],q[26],q[30],q[16],q[22],q[43],q[6],q[24];
measure q[25] -> meas[0];
measure q[7] -> meas[1];
measure q[44] -> meas[2];
measure q[23] -> meas[3];
