...
cx q[53],q[60];
cx q[60],q[53];
barrier q[34],q[60],q[43],q[27],q[16],q[35],q[48],q[68],q[36],q[30],q[55],q[50],q[22],q[44],q[25],q[33],q[54],q[39],q[52],q[37],q[58],q[61],q[63],q[72],q[82],q[18],q[80],q[77],q[83],q[73],q[85],q[65],q[45],q[46],q[11],q[29],q[2],q[10],q[9],q[13],q[14],q[21],q[31],q[0],q[51],q[64],q[12],q[6],q[1],q[3],q[67],q[66],q[84],q[78],q[81],q[40],q[79],q[62],q[59],q[41],q[57],q[38],q[56],q[19],q[42],q[20],q[5],q[4],q[15],q[49],q[7],q[17],q[32],q[69],q[47],q[28],q[8],q[26],q[23],q[53],q[24];
measure q[34] -> meas[0];
measure q[60] -> meas[1];
measure q[43] -> meas[2];
measure q[27] -> meas[3];
