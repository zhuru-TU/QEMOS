...
sx q[12];
rz(pi/2) q[12];
barrier q[12],q[11],q[10],q[17],q[13],q[30],q[28],q[26],q[24],q[23],q[22],q[21],q[20],q[15],q[4],q[3],q[6],q[7],q[16],q[27],q[25],q[29],q[5],q[2],q[1],q[19],q[0],q[8],q[14],q[18],q[9];
measure q[12] -> meas[0];
measure q[11] -> meas[1];
measure q[10] -> meas[2];
measure q[17] -> meas[3];
