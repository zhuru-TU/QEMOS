...
cx q[24],q[34];
cx q[34],q[24];
barrier q[34],q[60],q[43],q[44],q[45],q[64],q[3],q[42],q[47],q[30],q[40],q[66],q[8],q[49],q[85],q[39],q[33],q[59],q[19],q[6],q[65],q[56],q[38],q[5],q[72],q[68],q[35],q[67],q[70],q[71],q[81],q[51],q[0],q[13],q[61],q[62],q[58],q[9],q[12],q[28],q[10],q[84],q[11],q[69],q[32],q[29],q[31],q[46],q[50],q[55],q[27],q[21],q[57],q[18],q[16],q[14],q[1],q[20],q[73],q[63],q[41],q[7],q[2],q[26],q[17],q[48],q[4],q[25],q[54],q[15],q[22],q[23],q[53],q[24];
measure q[34] -> meas[0];
measure q[60] -> meas[1];
measure q[43] -> meas[2];
measure q[44] -> meas[3];
