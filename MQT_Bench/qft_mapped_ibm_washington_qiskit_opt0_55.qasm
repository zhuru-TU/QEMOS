...
cx q[28],q[35];
cx q[35],q[28];
barrier q[60],q[61],q[66],q[35],q[47],q[48],q[17],q[50],q[67],q[49],q[45],q[24],q[34],q[42],q[44],q[20],q[15],q[37],q[22],q[23],q[39],q[31],q[19],q[21],q[1],q[0],q[14],q[8],q[7],q[3],q[2],q[6],q[18],q[16],q[10],q[27],q[5],q[38],q[4],q[33],q[68],q[43],q[26],q[25],q[46],q[11],q[36],q[51],q[12],q[30],q[29],q[28],q[54],q[41],q[53];
measure q[60] -> meas[0];
measure q[61] -> meas[1];
measure q[66] -> meas[2];
measure q[35] -> meas[3];
