...
cx q[36],q[32];
cx q[32],q[36];
barrier q[15],q[39],q[23],q[22],q[34],q[26],q[43],q[16],q[32],q[28],q[30],q[12],q[10],q[11],q[25],q[9],q[51],q[48],q[45],q[41],q[5],q[1],q[2],q[46],q[6],q[7],q[35],q[19],q[47],q[31],q[17],q[29],q[27],q[36],q[8],q[42],q[44],q[24],q[3],q[21],q[33],q[4];
measure q[15] -> meas[0];
measure q[39] -> meas[1];
measure q[23] -> meas[2];
measure q[22] -> meas[3];
