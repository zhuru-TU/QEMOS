...
rz(pi/2) q[26];
rz(-pi/4) q[27];
barrier q[30],q[29],q[7],q[5],q[3],q[1],q[2],q[4],q[6],q[8],q[28],q[27],q[26],q[17];
measure q[30] -> c[0];
measure q[29] -> c[1];
measure q[7] -> c[2];
measure q[5] -> c[3];
