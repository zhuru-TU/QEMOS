...
rz(0) q[0];
sx q[0];
rz(-2.806368603236079) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(-0.40562423545957005) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[5];
sx q[5];
rz(7.228071812084266) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[8];
sx q[8];
rz(2.9404405837024576) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[7],q[8];
cx q[8],q[7];
...
rz(0) q[1];
sx q[1];
rz(-1.9001441427321266) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(5.356469300040171) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(5.529257303942661) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(4.154302407514374) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.57629799605732) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(-0.8716834969935183) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(8.951292422285794) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(-0.916936672776349) q[8];
sx q[8];
rz(3*pi) q[8];
