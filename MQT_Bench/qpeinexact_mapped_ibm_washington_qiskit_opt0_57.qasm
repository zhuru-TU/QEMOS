...
sx q[1];
rz(pi/2) q[1];
barrier q[20],q[33],q[19],q[18],q[5],q[7],q[27],q[51],q[50],q[55],q[49],q[21],q[30],q[17],q[13],q[31],q[10],q[11],q[12],q[29],q[28],q[35],q[47],q[46],q[44],q[23],q[42],q[37],q[40],q[59],q[57],q[56],q[52],q[38],q[39],q[41],q[60],q[61],q[63],q[54],q[45],q[43],q[34],q[15],q[6],q[8],q[26],q[25],q[24],q[22],q[4],q[3],q[2],q[14],q[0],q[1],q[9];
measure q[20] -> c[0];
measure q[33] -> c[1];
measure q[19] -> c[2];
measure q[18] -> c[3];
