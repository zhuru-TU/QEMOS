...
cx q[85],q[84];
cx q[84],q[85];
barrier q[21],q[19],q[25],q[23],q[4],q[40],q[34],q[24],q[0],q[33],q[52],q[42],q[56],q[53],q[59],q[54],q[60],q[57],q[44],q[72],q[82],q[79],q[77],q[63],q[84],q[35],q[81],q[29],q[83],q[78],q[62],q[17],q[49],q[30],q[10],q[67],q[73],q[48],q[36],q[41],q[9],q[86],q[55],q[13],q[32],q[51],q[66],q[68],q[31],q[11],q[50],q[12],q[8],q[80],q[65],q[27],q[47],q[28],q[85],q[64],q[58],q[71],q[76],q[7],q[46],q[6],q[16],q[45],q[61],q[38],q[1],q[5],q[37],q[14],q[2],q[43],q[15],q[39],q[3],q[22],q[26],q[18],q[20];
measure q[21] -> meas[0];
measure q[19] -> meas[1];
measure q[25] -> meas[2];
measure q[23] -> meas[3];
