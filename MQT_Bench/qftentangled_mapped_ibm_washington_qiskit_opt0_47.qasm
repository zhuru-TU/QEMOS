...
cx q[43],q[34];
cx q[34],q[43];
barrier q[14],q[18],q[23],q[15],q[3],q[34],q[7],q[28],q[22],q[16],q[42],q[6],q[20],q[39],q[41],q[46],q[33],q[17],q[12],q[45],q[35],q[13],q[11],q[9],q[47],q[10],q[48],q[37],q[31],q[2],q[25],q[19],q[40],q[38],q[30],q[21],q[44],q[27],q[26],q[29],q[8],q[43],q[5],q[4],q[24],q[1],q[0];
measure q[14] -> meas[0];
measure q[18] -> meas[1];
measure q[23] -> meas[2];
measure q[15] -> meas[3];
