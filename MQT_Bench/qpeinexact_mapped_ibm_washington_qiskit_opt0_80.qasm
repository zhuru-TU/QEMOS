...
rz(-pi/4) q[56];
rz(0) q[67];
barrier q[33],q[58],q[25],q[65],q[82],q[70],q[69],q[49],q[42],q[51],q[50],q[36],q[55],q[68],q[63],q[48],q[62],q[61],q[53],q[80],q[77],q[60],q[71],q[78],q[79],q[81],q[83],q[73],q[66],q[54],q[67],q[64],q[44],q[45],q[13],q[32],q[9],q[10],q[31],q[11],q[17],q[12],q[46],q[47],q[30],q[35],q[27],q[28],q[29],q[26],q[8],q[16],q[7],q[5],q[6],q[4],q[1],q[2],q[3],q[15],q[22],q[18],q[0],q[14],q[19],q[20],q[21],q[23],q[24],q[34],q[43],q[41],q[40],q[39],q[38],q[37],q[57],q[56],q[52],q[76];
measure q[33] -> c[0];
measure q[58] -> c[1];
measure q[25] -> c[2];
measure q[65] -> c[3];
