...
cx q[45],q[44];
cx q[44],q[45];
barrier q[7],q[25],q[8],q[15],q[44],q[29],q[30],q[20],q[12],q[19],q[28],q[16],q[2],q[9],q[34],q[49],q[46],q[1],q[47],q[38],q[40],q[50],q[33],q[0],q[14],q[18],q[39],q[37],q[41],q[23],q[42],q[3],q[43],q[48],q[10],q[26],q[31],q[27],q[11],q[22],q[17],q[35],q[45],q[21],q[5],q[24],q[6];
measure q[7] -> meas[0];
measure q[25] -> meas[1];
measure q[8] -> meas[2];
measure q[15] -> meas[3];
