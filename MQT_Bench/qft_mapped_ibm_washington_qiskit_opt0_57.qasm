...
cx q[66],q[65];
cx q[65],q[66];
barrier q[20],q[33],q[39],q[40],q[24],q[27],q[43],q[44],q[21],q[4],q[15],q[41],q[42],q[26],q[8],q[29],q[53],q[65],q[54],q[35],q[48],q[63],q[12],q[62],q[55],q[61],q[10],q[67],q[60],q[64],q[13],q[50],q[49],q[11],q[31],q[30],q[47],q[17],q[46],q[66],q[16],q[6],q[7],q[1],q[23],q[2],q[5],q[3],q[22],q[45],q[34],q[28],q[25],q[0],q[14],q[18],q[19];
measure q[20] -> meas[0];
measure q[33] -> meas[1];
measure q[39] -> meas[2];
measure q[40] -> meas[3];
