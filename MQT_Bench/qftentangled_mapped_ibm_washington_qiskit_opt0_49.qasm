...
cx q[36],q[32];
cx q[32],q[36];
barrier q[25],q[30],q[23],q[26],q[32],q[16],q[12],q[7],q[48],q[11],q[47],q[31],q[35],q[5],q[15],q[2],q[0],q[43],q[20],q[42],q[18],q[40],q[1],q[33],q[37],q[38],q[44],q[39],q[14],q[41],q[19],q[4],q[3],q[27],q[34],q[45],q[28],q[51],q[49],q[10],q[46],q[6],q[17],q[8],q[36],q[21],q[22],q[29],q[24];
measure q[25] -> meas[0];
measure q[30] -> meas[1];
measure q[23] -> meas[2];
measure q[26] -> meas[3];
