...
sx q[23];
rz(pi/2) q[23];
barrier q[14],q[4],q[1],q[3],q[6],q[0],q[8],q[36],q[27],q[7],q[30],q[13],q[35],q[10],q[2],q[28],q[16],q[39],q[31],q[20],q[21],q[19],q[34],q[18],q[17],q[26],q[29],q[9],q[24],q[11],q[15],q[12],q[32],q[33],q[22],q[5],q[25],q[23];
measure q[14] -> meas[0];
measure q[4] -> meas[1];
measure q[1] -> meas[2];
measure q[3] -> meas[3];
