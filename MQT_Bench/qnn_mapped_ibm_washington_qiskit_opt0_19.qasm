...
rz(0) q[11];
sx q[11];
rz(4.072280803131587) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(3.2984284006848243) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[26];
sx q[26];
rz(3.7329446010134624) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.2993614028069858) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[25],q[26];
...
rz(0) q[27];
sx q[27];
rz(3.6592982865107606) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.333926913961773) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
rz(0) q[10];
sx q[10];
rz(3.4729075177390807) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.3983249043757926) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[0];
sx q[0];
rz(3.639650891926334) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.743492810939597) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.661370006449192) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.268490698491635) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[15];
sx q[15];
rz(4.07858126064613) q[15];
sx q[15];
rz(3*pi) q[15];
rz(0) q[23];
sx q[23];
rz(3.446868452986467) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[24];
sx q[24];
rz(4.047618790265441) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.7230591482446265) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(4.12574164553718) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[28];
sx q[28];
rz(3.4250751220780455) q[28];
sx q[28];
rz(3*pi) q[28];
barrier q[0],q[1],q[2],q[4],q[15],q[23],q[24],q[25],q[26],q[28],q[17],q[11],q[10],q[12],q[30],q[29],q[16],q[22],q[27];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
