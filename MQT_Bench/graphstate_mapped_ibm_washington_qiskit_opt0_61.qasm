...
sx q[47];
rz(pi/2) q[47];
barrier q[37],q[7],q[5],q[0],q[23],q[15],q[4],q[25],q[6],q[36],q[51],q[13],q[9],q[18],q[19],q[1],q[34],q[43],q[26],q[14],q[3],q[38],q[20],q[33],q[2],q[24],q[8],q[32],q[64],q[10],q[30],q[16],q[31],q[60],q[35],q[55],q[28],q[59],q[57],q[56],q[21],q[44],q[50],q[46],q[54],q[22],q[27],q[11],q[47],q[17],q[12],q[48],q[53],q[40],q[42],q[45],q[52],q[29],q[39],q[49],q[41];
measure q[37] -> meas[0];
measure q[7] -> meas[1];
measure q[5] -> meas[2];
measure q[0] -> meas[3];
