...
cx q[48],q[47];
cx q[47],q[48];
barrier q[19],q[4],q[14],q[21],q[15],q[24],q[25],q[47],q[27],q[45],q[34],q[50],q[28],q[43],q[29],q[30],q[12],q[40],q[31],q[13],q[49],q[10],q[32],q[9],q[41],q[1],q[11],q[33],q[5],q[17],q[7],q[35],q[22],q[8],q[46],q[42],q[44],q[16],q[48],q[26],q[23],q[2],q[20],q[0],q[3],q[18];
measure q[19] -> meas[0];
measure q[4] -> meas[1];
measure q[14] -> meas[2];
measure q[21] -> meas[3];
