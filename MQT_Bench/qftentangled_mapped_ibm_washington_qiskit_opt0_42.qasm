...
cx q[47],q[35];
cx q[35],q[47];
barrier q[20],q[22],q[18],q[0],q[26],q[2],q[33],q[25],q[30],q[11],q[29],q[35],q[10],q[9],q[45],q[24],q[16],q[43],q[4],q[5],q[6],q[7],q[39],q[41],q[42],q[23],q[46],q[44],q[34],q[31],q[47],q[12],q[13],q[17],q[28],q[21],q[3],q[27],q[1],q[14],q[15],q[19];
measure q[20] -> meas[0];
measure q[22] -> meas[1];
measure q[18] -> meas[2];
measure q[0] -> meas[3];
