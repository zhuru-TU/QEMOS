...
cx q[26],q[25];
cx q[25],q[26];
rz(-1.3466433841651073) q[25];
cx q[25],q[24];
rz(1.3466433841651073) q[24];
cx q[25],q[24];
rz(-1.3466433841651073) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[15],q[4];
rz(-0.44830588525957865) q[4];
cx q[15],q[4];
rz(0.44830588525957865) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.8966117705191573) q[4];
cx q[4],q[3];
rz(-0.8966117705191573) q[3];
cx q[4],q[3];
rz(0.8966117705191573) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
rz(pi/2) q[24];
rz(-pi/4) q[25];
barrier q[28],q[8],q[7],q[1],q[5],q[2],q[3],q[4],q[22],q[23],q[26],q[25],q[24],q[11];
measure q[28] -> c[0];
measure q[8] -> c[1];
measure q[7] -> c[2];
measure q[1] -> c[3];
