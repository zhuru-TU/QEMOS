...
rz(pi/2) q[34];
rz(-pi/16384) q[61];
barrier q[34],q[24],q[23],q[43],q[41],q[39],q[38],q[37],q[40],q[53],q[60],q[59],q[58],q[61],q[57],q[56],q[42],q[62],q[45],q[64],q[21],q[44],q[54],q[47],q[46],q[35],q[33],q[48],q[49],q[51],q[50],q[30],q[31],q[55],q[36],q[27],q[67],q[63],q[26],q[16],q[65],q[25],q[20],q[15],q[4],q[18],q[3],q[14],q[19],q[29],q[32],q[68],q[12],q[17],q[11],q[10],q[13],q[9],q[28],q[7],q[6],q[5],q[2],q[1],q[0],q[52];
measure q[34] -> meas[0];
measure q[24] -> meas[1];
measure q[23] -> meas[2];
measure q[43] -> meas[3];
