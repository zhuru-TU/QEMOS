...
rz(0) q[52];
sx q[52];
rz(2.214297435588181) q[52];
sx q[52];
rz(3*pi) q[52];
cx q[37],q[52];
rz(0) q[52];
sx q[52];
rz(4.068887871591405) q[52];
sx q[52];
rz(3*pi) q[52];
cx q[37],q[52];
cx q[52],q[37];
...
rz(0) q[64];
sx q[64];
rz(-4176166398254500.5) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[63],q[64];
rz(0) q[64];
sx q[64];
rz(1329315050912963*pi) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[63],q[64];
cx q[64],q[63];
...
rz(0) q[62];
sx q[62];
rz(-2658630101825923*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[61],q[62];
rz(0) q[62];
sx q[62];
rz(2658630101825925*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[62],q[63];
cx q[63],q[62];
...
rz(0) q[65];
sx q[65];
rz(-10634520407303696*pi) q[65];
sx q[65];
rz(3*pi) q[65];
cx q[66],q[65];
rz(0) q[65];
sx q[65];
rz(10634520407303698*pi) q[65];
sx q[65];
rz(3*pi) q[65];
cx q[64],q[65];
cx q[65],q[64];
...
rz(0) q[59];
sx q[59];
rz(-1361218612134873088*pi) q[59];
sx q[59];
rz(3*pi) q[59];
cx q[60],q[59];
rz(0) q[59];
...
rz(0) q[66];
sx q[66];
rz(-43558995588315938816*pi) q[66];
sx q[66];
rz(3*pi) q[66];
cx q[67],q[66];
rz(0) q[66];
...
rz(0) q[67];
sx q[67];
rz(-87117991176631877632*pi) q[67];
sx q[67];
rz(3*pi) q[67];
cx q[68],q[67];
rz(0) q[67];
...
rz(pi/2) q[30];
rz(-pi/4) q[31];
barrier q[30],q[31],q[29],q[28],q[47],q[46],q[54],q[63],q[62],q[64],q[45],q[35],q[48],q[49],q[68],q[67],q[66],q[73],q[84],q[82],q[72],q[65],q[61],q[60],q[53],q[59],q[58],q[40],q[41],q[38],q[33],q[37],q[39],q[52],q[20],q[22],q[24],q[34],q[43],q[25],q[27],q[32],q[26],q[50],q[21],q[44],q[17],q[12],q[11],q[10],q[23],q[16],q[9],q[36],q[19],q[5],q[4],q[15],q[2],q[1],q[0],q[8],q[51],q[7],q[77],q[42],q[55],q[83],q[6],q[13],q[57],q[3],q[14],q[56],q[18],q[74];
measure q[30] -> meas[0];
measure q[31] -> meas[1];
measure q[29] -> meas[2];
measure q[28] -> meas[3];
