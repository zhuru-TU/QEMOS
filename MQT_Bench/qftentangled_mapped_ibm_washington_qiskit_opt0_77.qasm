...
cx q[27],q[28];
cx q[28],q[27];
barrier q[62],q[43],q[28],q[32],q[49],q[84],q[73],q[85],q[51],q[55],q[68],q[46],q[26],q[54],q[40],q[33],q[53],q[59],q[60],q[63],q[67],q[22],q[44],q[4],q[7],q[42],q[0],q[80],q[5],q[58],q[64],q[72],q[65],q[71],q[15],q[57],q[1],q[17],q[56],q[13],q[38],q[37],q[12],q[52],q[23],q[10],q[66],q[81],q[9],q[82],q[21],q[86],q[16],q[8],q[24],q[25],q[45],q[14],q[18],q[19],q[41],q[20],q[39],q[11],q[29],q[35],q[47],q[50],q[36],q[69],q[70],q[83],q[48],q[31],q[27],q[34],q[61];
measure q[62] -> meas[0];
measure q[43] -> meas[1];
measure q[28] -> meas[2];
measure q[32] -> meas[3];
