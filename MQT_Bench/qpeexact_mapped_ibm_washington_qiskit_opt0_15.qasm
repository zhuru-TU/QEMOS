...
cx q[14],q[0];
cx q[0],q[14];
rz(0.44830588525957865) q[0];
cx q[0],q[1];
rz(-0.44830588525957865) q[1];
cx q[0],q[1];
rz(0.8966117705191573) q[0];
rz(0.44830588525957865) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(-0.8966117705191573) q[1];
cx q[0],q[1];
rz(0.8966117705191573) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
cx q[0],q[14];
rz(-1.3483691125514785) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
rz(1.3483691125514785) q[2];
cx q[1],q[2];
rz(-1.3483691125514785) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(0.44485442848683593) q[2];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
cx q[2],q[3];
rz(-0.44485442848683593) q[3];
cx q[2],q[3];
rz(0.44485442848683593) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.8897088569736719) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.8897088569736719) q[4];
cx q[3],q[4];
rz(0.8897088569736719) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3621749396424494) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(1.3621749396424494) q[5];
cx q[4],q[5];
rz(-1.3621749396424494) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.4172427743048944) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.4172427743048944) q[6];
cx q[5],q[6];
rz(0.4172427743048944) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.8344855486097889) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-0.8344855486097889) q[7];
cx q[6],q[7];
rz(0.8344855486097889) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
rz(pi/2) q[24];
rz(-pi/4) q[25];
barrier q[27],q[28],q[16],q[7],q[6],q[2],q[5],q[3],q[15],q[4],q[22],q[23],q[25],q[24],q[10];
measure q[27] -> c[0];
measure q[28] -> c[1];
measure q[16] -> c[2];
measure q[7] -> c[3];
