...
cx q[1],q[2];
cx q[0],q[1];
rz(4.4310922406953095) q[1];
cx q[0],q[1];
rz(pi/2) q[3];
sx q[3];
rz(pi/2) q[3];
cx q[2],q[3];
rz(4.4310922406953095) q[3];
cx q[2],q[3];
rz(pi/2) q[4];
sx q[4];
rz(pi/2) q[4];
...
rz(pi/2) q[1];
sx q[1];
rz(10.069472423690979) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[0],q[1];
rz(-3.786317095021701) q[1];
cx q[0],q[1];
rz(pi/2) q[6];
sx q[6];
rz(pi/2) q[6];
...
rz(pi/2) q[2];
sx q[2];
rz(10.069472423690979) q[2];
sx q[2];
rz(5*pi/2) q[2];
cx q[6],q[7];
rz(4.4310922406953095) q[7];
cx q[6],q[7];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
...
cx q[7],q[8];
cx q[7],q[6];
rz(4.4310922406953095) q[6];
cx q[7],q[6];
rz(pi/2) q[6];
sx q[6];
rz(10.069472423690979) q[6];
sx q[6];
rz(5*pi/2) q[6];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[26],q[27];
cx q[25],q[26];
rz(4.4310922406953095) q[26];
cx q[25],q[26];
cx q[16],q[26];
rz(pi/2) q[25];
sx q[25];
rz(10.069472423690979) q[25];
sx q[25];
rz(5*pi/2) q[25];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[21],q[22];
cx q[20],q[21];
rz(-3.786317095021701) q[21];
cx q[20],q[21];
rz(pi/2) q[20];
sx q[20];
rz(-1.2895165230875323) q[20];
sx q[20];
rz(5*pi/2) q[20];
cx q[21],q[22];
cx q[22],q[21];
...
cx q[7],q[8];
cx q[6],q[7];
rz(-3.786317095021701) q[7];
cx q[6],q[7];
rz(pi/2) q[8];
sx q[8];
rz(10.069472423690979) q[8];
sx q[8];
rz(5*pi/2) q[8];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[7],q[8];
cx q[7],q[6];
rz(-3.786317095021701) q[6];
cx q[7],q[6];
rz(pi/2) q[6];
sx q[6];
rz(-1.2895165230875323) q[6];
sx q[6];
rz(5*pi/2) q[6];
rz(pi/2) q[8];
sx q[8];
rz(-1.2895165230875323) q[8];
sx q[8];
rz(5*pi/2) q[8];
cx q[7],q[8];
cx q[8],q[7];
...
cx q[23],q[24];
cx q[22],q[23];
rz(-3.786317095021701) q[23];
cx q[22],q[23];
rz(pi/2) q[22];
sx q[22];
rz(-1.2895165230875323) q[22];
sx q[22];
rz(5*pi/2) q[22];
rz(pi/2) q[23];
sx q[23];
rz(-1.2895165230875323) q[23];
sx q[23];
rz(5*pi/2) q[23];
rz(pi/2) q[25];
sx q[25];
rz(-1.2895165230875323) q[25];
sx q[25];
rz(5*pi/2) q[25];
cx q[26],q[16];
cx q[16],q[26];
rz(pi/2) q[27];
sx q[27];
rz(10.069472423690979) q[27];
sx q[27];
rz(5*pi/2) q[27];
cx q[26],q[27];
rz(-3.786317095021701) q[27];
cx q[26],q[27];
cx q[26],q[27];
cx q[27],q[26];
cx q[26],q[27];
...
rz(pi/2) q[16];
sx q[16];
rz(-1.2895165230875323) q[16];
sx q[16];
rz(5*pi/2) q[16];
rz(pi/2) q[27];
sx q[27];
rz(-1.2895165230875323) q[27];
sx q[27];
rz(5*pi/2) q[27];
barrier q[2],q[20],q[7],q[5],q[25],q[27],q[22],q[8],q[6],q[16],q[23];
measure q[2] -> meas[0];
measure q[20] -> meas[1];
measure q[7] -> meas[2];
measure q[5] -> meas[3];
