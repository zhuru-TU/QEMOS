...
cx q[39],q[40];
cx q[40],q[39];
barrier q[40],q[41],q[80],q[42],q[60],q[62],q[61],q[66],q[46],q[16],q[26],q[54],q[38],q[18],q[1],q[37],q[52],q[15],q[20],q[56],q[78],q[17],q[58],q[35],q[12],q[65],q[25],q[48],q[49],q[13],q[72],q[73],q[81],q[69],q[3],q[51],q[36],q[70],q[55],q[29],q[9],q[6],q[68],q[23],q[30],q[27],q[10],q[50],q[11],q[45],q[63],q[32],q[28],q[59],q[31],q[57],q[5],q[71],q[4],q[22],q[0],q[21],q[14],q[19],q[44],q[7],q[8],q[47],q[67],q[24],q[53],q[34],q[43],q[79],q[33],q[39];
measure q[40] -> meas[0];
measure q[41] -> meas[1];
measure q[80] -> meas[2];
measure q[42] -> meas[3];
