...
sx q[46];
rz(pi/2) q[46];
barrier q[37],q[0],q[15],q[1],q[2],q[6],q[3],q[4],q[5],q[31],q[11],q[13],q[9],q[10],q[7],q[16],q[8],q[12],q[28],q[21],q[18],q[14],q[19],q[33],q[20],q[22],q[23],q[25],q[27],q[29],q[17],q[32],q[36],q[34],q[24],q[26],q[30],q[47],q[43],q[38],q[39],q[40],q[41],q[42],q[44],q[46],q[45];
measure q[37] -> c[0];
measure q[0] -> c[1];
measure q[15] -> c[2];
measure q[1] -> c[3];
