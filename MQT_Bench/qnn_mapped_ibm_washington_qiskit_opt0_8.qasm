...
rz(0) q[6];
sx q[6];
rz(3.5041675034393567) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(4.053733480550328) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[7],q[6];
cx q[5],q[6];
...
rz(0) q[0];
sx q[0];
rz(4.116022657857445) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(4.109696344640192) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.1299076037009605) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.866691691444877) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.7390911596262315) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.7072966892125576) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.5938039724274247) q[7];
sx q[7];
rz(3*pi) q[7];
barrier q[1],q[0],q[2],q[3],q[4],q[5],q[7],q[6];
measure q[1] -> meas[0];
measure q[0] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
