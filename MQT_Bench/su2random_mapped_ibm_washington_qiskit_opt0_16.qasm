...
rz(0) q[25];
sx q[25];
rz(5.147412157444096) q[25];
sx q[25];
rz(3*pi) q[25];
rz(1.0368254640000032) q[25];
cx q[24],q[25];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
...
rz(0) q[28];
sx q[28];
rz(3.7099655078257845) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
cx q[27],q[28];
rz(2.4663339782035085) q[27];
cx q[26],q[27];
cx q[27],q[26];
cx q[26],q[27];
cx q[16],q[26];
...
barrier q[8],q[16],q[28],q[17],q[12],q[30],q[29],q[27],q[25],q[23],q[15],q[4],q[3],q[2],q[0],q[1];
measure q[8] -> meas[0];
measure q[16] -> meas[1];
measure q[28] -> meas[2];
measure q[17] -> meas[3];
