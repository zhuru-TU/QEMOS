...
sx q[66];
rz(pi/2) q[66];
barrier q[66],q[65],q[64],q[67],q[55],q[49],q[48],q[47],q[46],q[54],q[63],q[44],q[43],q[45],q[40],q[53],q[41],q[39],q[33],q[38],q[20],q[60],q[21],q[61],q[42],q[37],q[22],q[19],q[4],q[3],q[2],q[15],q[24],q[23],q[34],q[18],q[5],q[6],q[26],q[16],q[25],q[8],q[7],q[27],q[17],q[12],q[11],q[10],q[30],q[9],q[13],q[29],q[28],q[31],q[0],q[1],q[14],q[62],q[58];
measure q[66] -> meas[0];
measure q[65] -> meas[1];
measure q[64] -> meas[2];
measure q[67] -> meas[3];
