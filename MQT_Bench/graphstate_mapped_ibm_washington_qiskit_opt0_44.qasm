...
sx q[27];
rz(pi/2) q[27];
barrier q[0],q[18],q[3],q[1],q[8],q[28],q[43],q[35],q[11],q[9],q[12],q[13],q[10],q[37],q[14],q[25],q[20],q[2],q[6],q[16],q[30],q[32],q[42],q[4],q[36],q[29],q[7],q[41],q[34],q[26],q[17],q[31],q[27],q[15],q[23],q[5],q[22],q[21],q[24],q[39],q[38],q[33],q[40],q[19];
measure q[0] -> meas[0];
measure q[18] -> meas[1];
measure q[3] -> meas[2];
measure q[1] -> meas[3];
