...
cx q[41],q[40];
cx q[40],q[41];
rz(1.3261591585810122) q[40];
cx q[40],q[39];
rz(-1.3261591585810122) q[39];
cx q[40],q[39];
rz(1.3261591585810122) q[39];
cx q[39],q[40];
cx q[40],q[39];
...
cx q[33],q[20];
cx q[20],q[33];
rz(-0.4892743364277687) q[20];
cx q[20],q[19];
rz(0.4892743364277687) q[19];
cx q[20],q[19];
rz(-0.4892743364277687) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[22],q[15];
cx q[15],q[22];
rz(-0.9785486728555374) q[15];
cx q[15],q[4];
rz(0.9785486728555374) q[4];
cx q[15],q[4];
rz(-0.9785486728555374) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
rz(pi/2) q[0];
rz(-pi/4) q[14];
barrier q[66],q[59],q[4],q[69],q[31],q[32],q[67],q[68],q[36],q[51],q[55],q[50],q[49],q[62],q[38],q[37],q[52],q[56],q[57],q[71],q[58],q[41],q[42],q[48],q[6],q[65],q[29],q[9],q[10],q[11],q[30],q[13],q[12],q[17],q[35],q[19],q[34],q[8],q[2],q[15],q[33],q[39],q[40],q[53],q[60],q[61],q[63],q[64],q[54],q[43],q[44],q[45],q[46],q[47],q[28],q[27],q[26],q[22],q[20],q[21],q[23],q[24],q[25],q[16],q[7],q[5],q[3],q[1],q[18],q[14],q[0],q[70];
measure q[66] -> c[0];
measure q[59] -> c[1];
measure q[4] -> c[2];
measure q[69] -> c[3];
