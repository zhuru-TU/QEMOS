...
cx q[40],q[39];
cx q[39],q[40];
rz(0.10222885254659912) q[39];
cx q[39],q[33];
rz(-0.10222885254659912) q[33];
cx q[39],q[33];
rz(0.10222885254659912) q[33];
cx q[33],q[39];
cx q[39],q[33];
...
cx q[20],q[19];
cx q[19],q[20];
rz(0.20445770509319824) q[19];
cx q[19],q[18];
rz(-0.20445770509319824) q[18];
cx q[19],q[18];
rz(0.20445770509319824) q[18];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[18],q[14];
cx q[14],q[18];
rz(0.4089154101863965) q[14];
cx q[14],q[0];
rz(-0.4089154101863965) q[0];
cx q[14],q[0];
rz(0.4089154101863965) q[0];
cx q[0],q[14];
cx q[14],q[0];
...
cx q[1],q[0];
cx q[0],q[1];
rz(-1.5059310128442072) q[1];
cx q[1],q[2];
rz(1.5059310128442072) q[2];
cx q[1],q[2];
rz(-1.5059310128442072) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
cx q[3],q[2];
cx q[2],q[3];
rz(0.1297306279013786) q[3];
cx q[3],q[4];
rz(-0.1297306279013786) q[4];
cx q[3],q[4];
rz(0.1297306279013786) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[0],q[1];
cx q[0],q[14];
rz(0.2594612558027572) q[4];
cx q[4],q[5];
rz(-0.2594612558027572) q[5];
cx q[4],q[5];
rz(0.2594612558027572) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[3],q[4];
cx q[4],q[15];
rz(0.5189225116055144) q[5];
cx q[5],q[6];
rz(-0.5189225116055144) q[6];
cx q[5],q[6];
rz(0.5189225116055144) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.0378450232110288) q[6];
cx q[6],q[7];
rz(-1.0378450232110288) q[7];
cx q[6],q[7];
rz(1.0378450232110288) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[27],q[26];
cx q[26],q[27];
rz(-1.0659026071677353) q[28];
cx q[28],q[29];
rz(1.0659026071677353) q[29];
cx q[28],q[29];
rz(-1.0659026071677353) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.0097874392543222) q[17];
cx q[17],q[12];
rz(-1.0097874392543222) q[12];
cx q[17],q[12];
rz(1.0097874392543222) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-1.1220177750811486) q[12];
cx q[12],q[11];
...
cx q[15],q[4];
rz(-0.36524546948272196) q[4];
cx q[15],q[4];
rz(0.36524546948272196) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.7304909389654439) q[4];
cx q[21],q[22];
cx q[22],q[21];
cx q[21],q[22];
cx q[20],q[21];
...
rz(pi/2) q[21];
rz(-pi/32768) q[43];
barrier q[33],q[2],q[37],q[38],q[39],q[40],q[41],q[5],q[44],q[46],q[35],q[13],q[32],q[9],q[29],q[31],q[30],q[10],q[11],q[12],q[17],q[28],q[6],q[27],q[7],q[16],q[8],q[26],q[25],q[43],q[23],q[34],q[24],q[15],q[18],q[0],q[14],q[1],q[3],q[4],q[22],q[19],q[20],q[21],q[42];
measure q[33] -> c[0];
measure q[2] -> c[1];
measure q[37] -> c[2];
measure q[38] -> c[3];
