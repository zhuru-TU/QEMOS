...
rz(pi/2) q[28];
rz(-pi/4) q[29];
barrier q[28],q[29],q[27],q[26],q[24],q[23],q[22],q[21],q[20],q[15],q[4],q[3],q[2],q[5],q[6],q[7],q[8],q[16],q[30],q[17],q[11],q[12],q[13],q[10],q[9],q[25],q[1],q[0],q[19],q[18],q[14],q[31];
measure q[28] -> meas[0];
measure q[29] -> meas[1];
measure q[27] -> meas[2];
measure q[26] -> meas[3];
