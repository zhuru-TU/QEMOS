...
sx q[62];
rz(pi/2) q[62];
barrier q[14],q[25],q[1],q[0],q[5],q[3],q[15],q[7],q[9],q[32],q[13],q[27],q[10],q[45],q[2],q[29],q[16],q[22],q[20],q[26],q[18],q[41],q[56],q[4],q[57],q[11],q[8],q[30],q[28],q[17],q[24],q[53],q[36],q[46],q[37],q[21],q[31],q[38],q[6],q[19],q[12],q[40],q[52],q[23],q[50],q[39],q[60],q[54],q[35],q[47],q[49],q[48],q[34],q[51],q[44],q[55],q[33],q[42],q[64],q[43],q[61],q[62];
measure q[14] -> meas[0];
measure q[25] -> meas[1];
measure q[1] -> meas[2];
measure q[0] -> meas[3];
