...
rz(0) q[25];
sx q[25];
rz(-30382.46811082324) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[24],q[25];
rz(0) q[25];
sx q[25];
rz(30388.751296130416) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[19];
sx q[19];
rz(-3889354.9004523805) q[19];
sx q[19];
rz(3*pi) q[19];
cx q[20],q[19];
rz(0) q[19];
sx q[19];
rz(3889361.1836376875) q[19];
sx q[19];
rz(3*pi) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
rz(0) q[21];
sx q[21];
rz(-15557429.026587483) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[21];
rz(0) q[21];
sx q[21];
rz(15557435.30977279) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[21],q[22];
cx q[22],q[21];
...
rz(0) q[25];
sx q[25];
rz(-15930810537.074867) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[24],q[25];
rz(0) q[25];
sx q[25];
rz(15930810543.358051) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[40];
sx q[40];
rz(-2039143749144.5652) q[40];
sx q[40];
rz(3*pi) q[40];
cx q[41],q[40];
rz(0) q[40];
sx q[40];
rz(2039143749150.8484) q[40];
sx q[40];
rz(3*pi) q[40];
rz(0) q[40];
cx q[41],q[42];
...
rz(0) q[42];
sx q[42];
rz(-16313149993178.514) q[42];
sx q[42];
rz(3*pi) q[42];
cx q[43],q[42];
rz(0) q[42];
sx q[42];
rz(16313149993184.795) q[42];
sx q[42];
rz(3*pi) q[42];
cx q[42],q[43];
cx q[43],q[42];
...
rz(0) q[44];
sx q[44];
rz(-32626299986360.168) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[45],q[44];
rz(0) q[44];
sx q[44];
rz(32626299986366.45) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[44],q[45];
cx q[45],q[44];
...
rz(0) q[45];
sx q[45];
rz(-65252599972723.48) q[45];
sx q[45];
rz(3*pi) q[45];
cx q[46],q[45];
rz(0) q[45];
sx q[45];
rz(65252599972729.76) q[45];
sx q[45];
rz(3*pi) q[45];
cx q[45],q[46];
cx q[46],q[45];
...
rz(0) q[43];
sx q[43];
rz(-5317260203651847*pi) q[43];
sx q[43];
rz(3*pi) q[43];
cx q[44],q[43];
rz(0) q[43];
sx q[43];
rz(5317260203651850*pi) q[43];
sx q[43];
rz(3*pi) q[43];
cx q[43],q[44];
cx q[44],q[43];
...
rz(0) q[46];
sx q[46];
rz(-10634520407303696*pi) q[46];
sx q[46];
rz(3*pi) q[46];
cx q[47],q[46];
rz(0) q[46];
sx q[46];
rz(10634520407303698*pi) q[46];
sx q[46];
rz(3*pi) q[46];
cx q[45],q[46];
cx q[46],q[45];
...
rz(0) q[61];
sx q[61];
rz(-1361218612134873088*pi) q[61];
sx q[61];
rz(3*pi) q[61];
cx q[62],q[61];
rz(0) q[61];
...
rz(0) q[61];
sx q[61];
rz(-2722437224269746176*pi) q[61];
sx q[61];
rz(3*pi) q[61];
cx q[62],q[61];
rz(0) q[61];
...
rz(0) q[62];
sx q[62];
rz(-5444874448539492352*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[63],q[62];
rz(0) q[62];
...
rz(0) q[63];
sx q[63];
rz(-10889748897078984704*pi) q[63];
sx q[63];
rz(3*pi) q[63];
cx q[64],q[63];
rz(0) q[63];
...
rz(0) q[64];
sx q[64];
rz(-21779497794157969408*pi) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[65],q[64];
rz(0) q[64];
...
rz(0) q[65];
sx q[65];
rz(-43558995588315938816*pi) q[65];
sx q[65];
rz(3*pi) q[65];
cx q[66],q[65];
rz(0) q[65];
...
rz(0) q[66];
sx q[66];
rz(-87117991176631877632*pi) q[66];
sx q[66];
rz(3*pi) q[66];
cx q[67],q[66];
rz(0) q[66];
...
rz(0) q[67];
sx q[67];
rz(-174235982353263755264*pi) q[67];
sx q[67];
rz(3*pi) q[67];
cx q[68],q[67];
rz(0) q[67];
...
rz(0) q[68];
sx q[68];
rz(-348471964706527510528*pi) q[68];
sx q[68];
rz(3*pi) q[68];
cx q[69],q[68];
rz(0) q[68];
...
rz(0) q[63];
sx q[63];
rz(-696943929413055021056*pi) q[63];
sx q[63];
rz(3*pi) q[63];
cx q[62],q[63];
rz(0) q[63];
...
rz(0) q[62];
sx q[62];
rz(-1393887858826110042112*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[72],q[62];
rz(0) q[62];
...
rz(0) q[64];
sx q[64];
rz(-2787775717652220084224*pi) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[65],q[64];
rz(0) q[64];
...
rz(0) q[67];
sx q[67];
rz(-5575551435304440168448*pi) q[67];
sx q[67];
rz(3*pi) q[67];
cx q[68],q[67];
rz(0) q[67];
...
rz(0) q[72];
sx q[72];
rz(-11151102870608880336896*pi) q[72];
sx q[72];
rz(3*pi) q[72];
cx q[81],q[72];
rz(0) q[72];
...
rz(0) q[79];
sx q[79];
rz(-22302205741217760673792*pi) q[79];
sx q[79];
rz(3*pi) q[79];
cx q[78],q[79];
rz(0) q[79];
...
rz(0) q[78];
sx q[78];
rz(-44604411482435521347584*pi) q[78];
sx q[78];
rz(3*pi) q[78];
cx q[77],q[78];
rz(0) q[78];
...
rz(0) q[77];
sx q[77];
rz(-89208822964871042695168*pi) q[77];
sx q[77];
rz(3*pi) q[77];
cx q[76],q[77];
rz(0) q[77];
...
rz(0) q[76];
sx q[76];
rz(-178417645929742085390336*pi) q[76];
sx q[76];
rz(3*pi) q[76];
cx q[75],q[76];
rz(0) q[76];
...
rz(0) q[78];
sx q[78];
rz(-356835291859484170780672*pi) q[78];
sx q[78];
rz(3*pi) q[78];
cx q[79],q[78];
rz(0) q[78];
...
rz(0) q[79];
sx q[79];
rz(-713670583718968341561344*pi) q[79];
sx q[79];
rz(3*pi) q[79];
cx q[80],q[79];
rz(0) q[79];
...
rz(-pi/64) q[83];
rz(-pi/1073741824) q[85];
barrier q[62],q[61],q[72],q[81],q[82],q[83],q[80],q[79],q[78],q[77],q[58],q[59],q[53],q[41],q[43],q[34],q[24],q[44],q[54],q[45],q[64],q[23],q[42],q[46],q[47],q[65],q[63],q[66],q[71],q[85],q[73],q[86],q[60],q[48],q[68],q[55],q[49],q[35],q[27],q[28],q[29],q[30],q[31],q[26],q[67],q[84],q[25],q[36],q[32],q[17],q[51],q[12],q[50],q[8],q[6],q[7],q[5],q[15],q[21],q[20],q[38],q[39],q[52],q[37],q[40],q[22],q[16],q[57],q[33],q[69],q[19],q[4],q[13],q[11],q[10],q[9],q[3],q[2],q[18],q[1],q[0],q[14],q[75];
measure q[62] -> meas[0];
measure q[61] -> meas[1];
measure q[72] -> meas[2];
measure q[81] -> meas[3];
