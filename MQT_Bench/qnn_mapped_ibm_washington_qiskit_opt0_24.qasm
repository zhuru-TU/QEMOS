...
rz(0) q[1];
sx q[1];
rz(3.9596224028736358) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.428219831491288) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(3.265850695918692) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
rz(0) q[2];
sx q[2];
rz(3.6320421737250475) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.3701283719595545) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[18];
sx q[18];
rz(3.6630063561016306) q[18];
sx q[18];
rz(3*pi) q[18];
cx q[14],q[18];
cx q[18],q[14];
...
rz(0) q[10];
sx q[10];
rz(3.6089979544266373) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.182631189431122) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[2];
sx q[2];
rz(3.391512564273682) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[5];
sx q[5];
rz(3.722049114525021) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(3.634600964896323) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[14];
sx q[14];
rz(3.776829515430668) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[15];
sx q[15];
rz(3.996320520920781) q[15];
sx q[15];
rz(3*pi) q[15];
rz(0) q[24];
sx q[24];
rz(4.1170070400167695) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.7637583027199173) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[27];
sx q[27];
rz(3.558777455519607) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(4.102248396629178) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[14],q[0],q[2],q[5],q[15],q[24],q[25],q[27],q[29],q[17],q[11],q[10],q[12],q[30],q[28],q[16],q[26],q[23],q[20],q[19],q[18],q[3],q[4],q[1];
measure q[14] -> meas[0];
measure q[0] -> meas[1];
measure q[2] -> meas[2];
measure q[5] -> meas[3];
