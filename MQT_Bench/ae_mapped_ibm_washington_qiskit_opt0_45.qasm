...
rz(pi/2) q[40];
rz(-pi/4) q[41];
barrier q[40],q[41],q[42],q[39],q[33],q[22],q[21],q[24],q[34],q[44],q[45],q[47],q[35],q[28],q[27],q[26],q[29],q[17],q[11],q[10],q[12],q[9],q[30],q[25],q[13],q[31],q[48],q[43],q[46],q[23],q[20],q[4],q[5],q[7],q[6],q[8],q[16],q[15],q[32],q[1],q[0],q[18],q[14],q[38],q[37];
measure q[40] -> meas[0];
measure q[41] -> meas[1];
measure q[42] -> meas[2];
measure q[39] -> meas[3];
