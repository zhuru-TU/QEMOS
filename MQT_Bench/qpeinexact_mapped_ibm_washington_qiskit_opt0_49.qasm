...
rz(-pi/4) q[1];
rz(-pi/549755813888) q[48];
barrier q[3],q[37],q[38],q[19],q[33],q[39],q[46],q[50],q[49],q[48],q[45],q[44],q[40],q[41],q[42],q[43],q[34],q[6],q[47],q[8],q[23],q[24],q[25],q[31],q[35],q[26],q[30],q[13],q[10],q[11],q[12],q[17],q[29],q[28],q[27],q[16],q[7],q[5],q[4],q[15],q[22],q[21],q[20],q[18],q[14],q[2],q[1],q[0],q[9];
measure q[3] -> c[0];
measure q[37] -> c[1];
measure q[38] -> c[2];
measure q[19] -> c[3];
