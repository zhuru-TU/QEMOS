...
sx q[33];
rz(3*pi) q[33];
barrier q[9],q[13],q[31],q[32],q[10],q[11],q[12],q[30],q[17],q[29],q[6],q[28],q[7],q[27],q[8],q[16],q[26],q[25],q[33],q[24],q[5],q[20],q[15],q[3],q[19],q[21],q[23],q[22],q[4],q[2],q[1],q[0],q[18],q[14];
measure q[9] -> meas[0];
measure q[13] -> meas[1];
measure q[31] -> meas[2];
measure q[32] -> meas[3];
