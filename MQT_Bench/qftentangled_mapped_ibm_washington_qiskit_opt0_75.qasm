...
cx q[66],q[73];
cx q[73],q[66];
barrier q[71],q[40],q[41],q[79],q[73],q[85],q[46],q[64],q[35],q[49],q[65],q[29],q[70],q[82],q[68],q[13],q[32],q[24],q[8],q[12],q[25],q[6],q[16],q[36],q[80],q[4],q[43],q[42],q[48],q[63],q[53],q[81],q[51],q[2],q[1],q[38],q[83],q[84],q[9],q[0],q[14],q[18],q[61],q[19],q[20],q[62],q[10],q[60],q[34],q[3],q[72],q[21],q[15],q[5],q[22],q[26],q[7],q[23],q[31],q[27],q[69],q[44],q[55],q[30],q[45],q[50],q[28],q[54],q[47],q[67],q[66],q[78],q[33],q[39],q[58];
measure q[71] -> meas[0];
measure q[40] -> meas[1];
measure q[41] -> meas[2];
measure q[79] -> meas[3];
