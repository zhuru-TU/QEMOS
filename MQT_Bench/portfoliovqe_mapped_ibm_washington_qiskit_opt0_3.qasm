...
rz(0) q[0];
sx q[0];
rz(3.5153211013563688) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(6.536518323620917) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[1];
sx q[1];
rz(2.171670059385363) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(8.838926732259353) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
rz(0) q[1];
sx q[1];
rz(5.3768128654790885) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(7.175396956146267) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
rz(0) q[1];
sx q[1];
rz(-3.0029895599104055) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(-2.3749358018796682) q[2];
sx q[2];
rz(3*pi) q[2];
barrier q[0],q[2],q[1];
measure q[0] -> meas[0];
