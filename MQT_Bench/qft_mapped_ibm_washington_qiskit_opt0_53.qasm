...
cx q[42],q[43];
cx q[43],q[42];
barrier q[26],q[16],q[24],q[28],q[21],q[43],q[10],q[11],q[17],q[27],q[6],q[5],q[14],q[19],q[2],q[15],q[1],q[0],q[34],q[41],q[29],q[39],q[30],q[48],q[46],q[32],q[51],q[36],q[50],q[49],q[9],q[45],q[4],q[40],q[44],q[52],q[37],q[38],q[3],q[18],q[33],q[47],q[7],q[31],q[12],q[35],q[13],q[42],q[20],q[22],q[23],q[8],q[25];
measure q[26] -> meas[0];
measure q[16] -> meas[1];
measure q[24] -> meas[2];
measure q[28] -> meas[3];
