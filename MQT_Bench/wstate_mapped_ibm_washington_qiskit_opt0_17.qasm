...
cx q[0],q[1];
cx q[14],q[0];
barrier q[14],q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[30],q[11],q[10],q[17],q[28],q[8],q[22],q[6];
measure q[14] -> meas[0];
measure q[0] -> meas[1];
measure q[1] -> meas[2];
measure q[2] -> meas[3];
