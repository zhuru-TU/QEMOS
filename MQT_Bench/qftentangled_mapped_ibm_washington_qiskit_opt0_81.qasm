...
cx q[89],q[88];
cx q[88],q[89];
barrier q[40],q[41],q[20],q[62],q[18],q[60],q[28],q[68],q[67],q[66],q[88],q[48],q[36],q[45],q[30],q[51],q[7],q[42],q[43],q[16],q[63],q[80],q[65],q[78],q[23],q[81],q[61],q[59],q[38],q[15],q[25],q[12],q[73],q[69],q[74],q[31],q[32],q[11],q[13],q[84],q[1],q[37],q[35],q[22],q[9],q[10],q[70],q[2],q[4],q[17],q[5],q[3],q[0],q[21],q[58],q[83],q[71],q[77],q[44],q[79],q[64],q[8],q[24],q[34],q[6],q[26],q[27],q[54],q[47],q[46],q[89],q[50],q[49],q[55],q[29],q[53],q[14],q[72],q[19],q[33],q[39];
measure q[40] -> meas[0];
measure q[41] -> meas[1];
measure q[20] -> meas[2];
measure q[62] -> meas[3];
