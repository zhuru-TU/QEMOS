...
sx q[65];
rz(pi/2) q[65];
barrier q[7],q[57],q[25],q[19],q[8],q[13],q[20],q[6],q[33],q[5],q[32],q[36],q[9],q[41],q[18],q[4],q[31],q[27],q[2],q[37],q[16],q[68],q[21],q[3],q[88],q[14],q[72],q[11],q[12],q[10],q[48],q[89],q[85],q[15],q[1],q[38],q[17],q[64],q[53],q[22],q[0],q[29],q[42],q[47],q[75],q[26],q[69],q[83],q[35],q[70],q[51],q[28],q[54],q[62],q[67],q[66],q[60],q[63],q[52],q[71],q[45],q[56],q[80],q[30],q[65],q[44],q[50],q[86],q[73],q[55],q[84],q[24],q[23],q[46],q[74],q[81],q[90],q[92],q[77],q[39],q[40],q[78],q[43],q[58],q[91],q[79],q[34],q[87],q[93],q[82],q[76],q[59],q[49],q[61];
measure q[7] -> meas[0];
measure q[57] -> meas[1];
measure q[25] -> meas[2];
measure q[19] -> meas[3];
