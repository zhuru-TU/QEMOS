...
cx q[2],q[3];
cx q[1],q[2];
rz(-2.4857517482213765) q[2];
cx q[1],q[2];
rz(pi/2) q[1];
sx q[1];
rz(8.181908691947982) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(8.181908691947982) q[2];
sx q[2];
rz(5*pi/2) q[2];
cx q[6],q[7];
rz(-2.4857517482213765) q[7];
cx q[6],q[7];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
...
cx q[25],q[26];
cx q[24],q[25];
rz(-2.4857517482213765) q[25];
cx q[24],q[25];
rz(pi/2) q[24];
sx q[24];
rz(8.181908691947982) q[24];
sx q[24];
rz(5*pi/2) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(pi/2) q[7];
sx q[7];
rz(8.181908691947982) q[7];
sx q[7];
rz(5*pi/2) q[7];
cx q[7],q[6];
rz(-1.8987333028843452) q[6];
cx q[7],q[6];
cx q[26],q[27];
cx q[27],q[26];
cx q[26],q[27];
...
rz(pi/2) q[4];
sx q[4];
rz(-10.08070542742673) q[4];
sx q[4];
rz(5*pi/2) q[4];
rz(pi/2) q[5];
sx q[5];
rz(-10.08070542742673) q[5];
sx q[5];
rz(5*pi/2) q[5];
rz(pi/2) q[6];
sx q[6];
rz(-10.08070542742673) q[6];
sx q[6];
rz(5*pi/2) q[6];
rz(pi/2) q[7];
sx q[7];
rz(-10.08070542742673) q[7];
sx q[7];
rz(5*pi/2) q[7];
rz(pi/2) q[26];
sx q[26];
rz(8.181908691947982) q[26];
sx q[26];
rz(5*pi/2) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(pi/2) q[8];
sx q[8];
rz(-10.08070542742673) q[8];
sx q[8];
rz(5*pi/2) q[8];
cx q[26],q[25];
rz(-1.8987333028843452) q[25];
cx q[26],q[25];
cx q[25],q[26];
cx q[26],q[25];
cx q[25],q[26];
...
cx q[24],q[25];
cx q[23],q[24];
rz(-1.8987333028843452) q[24];
cx q[23],q[24];
rz(pi/2) q[23];
sx q[23];
rz(-10.08070542742673) q[23];
sx q[23];
rz(5*pi/2) q[23];
cx q[24],q[25];
cx q[25],q[24];
...
rz(pi/2) q[25];
sx q[25];
rz(-10.08070542742673) q[25];
sx q[25];
rz(5*pi/2) q[25];
rz(pi/2) q[29];
sx q[29];
rz(8.181908691947982) q[29];
sx q[29];
rz(5*pi/2) q[29];
cx q[28],q[29];
rz(-1.8987333028843452) q[29];
cx q[28],q[29];
cx q[28],q[29];
cx q[29],q[28];
cx q[28],q[29];
...
cx q[27],q[28];
cx q[27],q[26];
rz(-1.8987333028843452) q[26];
cx q[27],q[26];
rz(pi/2) q[26];
sx q[26];
rz(-10.08070542742673) q[26];
sx q[26];
rz(5*pi/2) q[26];
rz(pi/2) q[27];
sx q[27];
rz(-10.08070542742673) q[27];
sx q[27];
rz(5*pi/2) q[27];
rz(pi/2) q[28];
sx q[28];
rz(-10.08070542742673) q[28];
sx q[28];
rz(5*pi/2) q[28];
rz(pi/2) q[29];
sx q[29];
rz(-10.08070542742673) q[29];
sx q[29];
rz(5*pi/2) q[29];
barrier q[16],q[15],q[25],q[6],q[23],q[8],q[29],q[5],q[7],q[4],q[27],q[26],q[28];
measure q[16] -> meas[0];
measure q[15] -> meas[1];
measure q[25] -> meas[2];
measure q[6] -> meas[3];
