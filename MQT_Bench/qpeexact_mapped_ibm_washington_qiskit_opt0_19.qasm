...
cx q[14],q[0];
cx q[0],q[14];
rz(0.4486174751071179) q[0];
cx q[0],q[1];
rz(-0.4486174751071179) q[1];
cx q[0],q[1];
rz(0.8972349502142358) q[0];
rz(0.4486174751071179) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(-0.8972349502142358) q[1];
cx q[0],q[1];
rz(0.8972349502142358) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(-1.3471227531613215) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
