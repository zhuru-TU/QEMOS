...
cx q[26],q[16];
cx q[16],q[26];
rz(-1.346835131763593) q[16];
cx q[16],q[8];
rz(1.346835131763593) q[8];
cx q[16],q[8];
rz(-1.346835131763593) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
cx q[6],q[5];
cx q[5],q[6];
rz(0.4479223900626072) q[5];
cx q[5],q[4];
rz(-0.4479223900626072) q[4];
cx q[5],q[4];
rz(0.4479223900626072) q[4];
cx q[4],q[5];
cx q[5],q[4];
