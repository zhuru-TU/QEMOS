...
rz(0) q[28];
sx q[28];
rz(3.2593895936783928) q[28];
sx q[28];
rz(3*pi) q[28];
rz(0) q[29];
sx q[29];
rz(3.960898469368514) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[29],q[28];
rz(0) q[28];
sx q[28];
rz(4.017655773165411) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[0];
sx q[0];
rz(3.9141902288026515) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.9171896754044853) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.558875293927609) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.55971611519331) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.2019147124501153) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6803049949895903) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.470661802324339) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.458182139138737) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.7229943752452996) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0) q[30];
sx q[30];
rz(3.44226919508282) q[30];
sx q[30];
rz(3*pi) q[30];
barrier q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[29],q[30],q[28];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
