...
rz(-pi/128) q[64];
rz(-pi/2048) q[68];
barrier q[41],q[14],q[0],q[2],q[3],q[1],q[19],q[18],q[20],q[40],q[33],q[62],q[42],q[23],q[61],q[60],q[53],q[59],q[57],q[52],q[39],q[22],q[21],q[5],q[15],q[25],q[4],q[6],q[7],q[8],q[16],q[36],q[9],q[24],q[27],q[49],q[35],q[13],q[10],q[11],q[12],q[17],q[28],q[29],q[30],q[31],q[32],q[51],q[50],q[68],q[55],q[48],q[47],q[64],q[46],q[34],q[54],q[43],q[44],q[45],q[38];
measure q[41] -> c[0];
measure q[14] -> c[1];
measure q[0] -> c[2];
measure q[2] -> c[3];
