...
cx q[26],q[27];
cx q[27],q[26];
barrier q[27],q[30],q[17],q[25],q[28],q[22],q[12],q[9],q[11],q[31],q[19],q[47],q[7],q[18],q[3],q[15],q[4],q[6],q[1],q[2],q[14],q[5],q[39],q[46],q[8],q[33],q[13],q[20],q[10],q[23],q[21],q[24],q[16],q[35],q[29],q[26];
measure q[27] -> meas[0];
measure q[30] -> meas[1];
measure q[17] -> meas[2];
measure q[25] -> meas[3];
