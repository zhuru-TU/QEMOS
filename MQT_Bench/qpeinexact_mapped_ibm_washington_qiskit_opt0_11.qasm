...
cx q[26],q[16];
cx q[16],q[26];
rz(-1.3268933815210797) q[16];
cx q[16],q[8];
rz(1.3268933815210797) q[8];
cx q[16],q[8];
rz(-1.3268933815210797) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
cx q[6],q[5];
cx q[5],q[6];
rz(0.4878058905476339) q[5];
cx q[5],q[4];
rz(-0.4878058905476339) q[4];
cx q[5],q[4];
rz(0.4878058905476339) q[4];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[3],q[2];
cx q[2],q[3];
rz(-1.1903690913992575) q[2];
cx q[2],q[1];
rz(1.1903690913992575) q[1];
cx q[2],q[1];
rz(-1.1903690913992575) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(0.760854470791278) q[1];
cx q[1],q[0];
rz(-0.760854470791278) q[0];
cx q[1],q[0];
rz(0.760854470791278) q[0];
cx q[1],q[2];
cx q[2],q[1];
...
rz(pi/2) q[3];
rz(-pi/4) q[4];
barrier q[16],q[8],q[7],q[6],q[0],q[1],q[2],q[5],q[4],q[3],q[29];
measure q[16] -> c[0];
measure q[8] -> c[1];
measure q[7] -> c[2];
measure q[6] -> c[3];
