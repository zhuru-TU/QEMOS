...
sx q[29];
rz(3*pi) q[29];
barrier q[19],q[18],q[14],q[0],q[1],q[3],q[7],q[6],q[20],q[21],q[22],q[24],q[28],q[30],q[11],q[10],q[12],q[17],q[29],q[27],q[8],q[16],q[26],q[25],q[23],q[5],q[4],q[15];
measure q[19] -> meas[0];
measure q[18] -> meas[1];
measure q[14] -> meas[2];
measure q[0] -> meas[3];
