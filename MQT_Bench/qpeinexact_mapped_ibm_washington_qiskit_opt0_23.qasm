...
cx q[15],q[4];
cx q[4],q[15];
rz(0.10236887463452754) q[4];
cx q[4],q[3];
rz(-0.10236887463452754) q[3];
cx q[4],q[3];
rz(0.10236887463452754) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.40947549853811016) q[1];
cx q[1],q[0];
rz(-0.40947549853811016) q[0];
cx q[1],q[0];
rz(0.40947549853811016) q[0];
cx q[0],q[14];
rz(0.8189509970762203) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
rz(-0.8189509970762203) q[2];
cx q[1],q[2];
rz(0.8189509970762203) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
cx q[3],q[4];
rz(0.13421133471508825) q[3];
rz(-1.5036906594373525) q[4];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.13421133471508825) q[4];
cx q[3],q[4];
rz(0.13421133471508825) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.2684226694301765) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.2684226694301765) q[5];
cx q[4],q[5];
rz(0.2684226694301765) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[6],q[5];
cx q[5],q[6];
rz(1.073690677720706) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-1.073690677720706) q[7];
cx q[6],q[7];
rz(1.073690677720706) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1531700572930308) q[17];
cx q[17],q[12];
rz(-1.1531700572930308) q[12];
cx q[17],q[12];
rz(1.1531700572930308) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8352525390037316) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4710875755823298) q[11];
cx q[11],q[10];
rz(-1.4710875755823298) q[10];
cx q[11],q[10];
rz(1.4710875755823298) q[10];
cx q[10],q[11];
cx q[11],q[10];
cx q[10],q[11];
rz(-0.19941750242513334) q[10];
cx q[17],q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[13];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-0.3988350048502667) q[27];
cx q[27],q[26];
rz(0.3988350048502667) q[26];
cx q[27],q[26];
rz(-0.3988350048502667) q[26];
cx q[16],q[26];
cx q[26],q[16];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-0.7976700097005334) q[25];
cx q[25],q[24];
rz(0.7976700097005334) q[24];
cx q[25],q[24];
rz(-0.7976700097005334) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
sx q[1];
rz(pi/2) q[1];
barrier q[20],q[21],q[15],q[6],q[7],q[26],q[8],q[16],q[30],q[11],q[12],q[17],q[29],q[27],q[25],q[24],q[22],q[4],q[2],q[14],q[0],q[1],q[18];
measure q[20] -> c[0];
measure q[21] -> c[1];
measure q[15] -> c[2];
measure q[6] -> c[3];
