...
rz(pi/2) q[5];
cx q[4],q[5];
rz(1.5640163777242566) q[5];
cx q[4],q[5];
rz(pi/2) q[4];
sx q[4];
rz(pi/2) q[4];
rz(0.026261989337056146) q[4];
sx q[4];
rz(4.6423803131896815) q[4];
sx q[4];
rz(6.882366594982223) q[4];
rz(pi/2) q[5];
sx q[5];
rz(pi/2) q[5];
rz(pi/2) q[5];
...
cx q[3],q[2];
cx q[2],q[3];
rz(1.8578290617371822) q[2];
sx q[2];
rz(4.347957450985875) q[2];
sx q[2];
rz(11.579694656174166) q[2];
rz(0) q[4];
sx q[4];
rz(4.637097219175522) q[4];
sx q[4];
rz(7.74565312903592) q[4];
rz(-3.871541346234685) q[5];
sx q[5];
...
cx q[3],q[2];
cx q[2],q[3];
rz(1.7191619225159478) q[5];
sx q[5];
rz(5.867434594011127) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(pi/4) q[5];
...
rz(pi/2) q[2];
cx q[2],q[1];
rz(2.867615720945729) q[1];
cx q[2],q[1];
rz(pi/2) q[1];
sx q[1];
rz(pi/2) q[1];
rz(1.4510178277509702) q[1];
sx q[1];
rz(4.7620682354219905) q[1];
sx q[1];
rz(9.471632625519607) q[1];
rz(pi/2) q[2];
sx q[2];
rz(pi/2) q[2];
rz(pi/2) q[2];
...
rz(0) q[6];
sx q[6];
rz(3.079153330910928) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[5],q[6];
rz(-1.1721221709586835) q[5];
sx q[5];
rz(-pi/2) q[5];
rz(2.2593201473701177) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
...
sx q[1];
rz(pi/2) q[1];
rz(-2.209194095686099) q[1];
sx q[1];
rz(5.104915462151738) q[1];
sx q[1];
rz(6.9492442135326336) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(pi/2) q[2];
...
sx q[5];
rz(4.605480416650385) q[5];
sx q[5];
rz(6.553092194038799) q[5];
rz(0) q[6];
sx q[6];
...
rz(pi/16) q[5];
rz(4.213907225096717) q[6];
barrier q[3],q[4],q[1],q[7],q[2],q[6],q[5],q[0];
measure q[3] -> meas[0];
measure q[4] -> meas[1];
measure q[1] -> meas[2];
measure q[7] -> meas[3];
