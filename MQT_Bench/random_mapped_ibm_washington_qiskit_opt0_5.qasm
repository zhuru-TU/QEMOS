...
rz(-3*pi/2) q[2];
sx q[2];
rz(-1.4587406578322795) q[2];
rz(1.9481604360279685) q[2];
rz(2.7978235820987063) q[3];
rz(-3*pi/2) q[4];
sx q[4];
rz(pi) q[4];
...
rz(0) q[2];
sx q[2];
rz(3.6267333204798238) q[2];
sx q[2];
rz(10.994163834333255) q[2];
rz(pi/4) q[2];
rz(pi/2) q[3];
sx q[3];
rz(pi/2) q[3];
...
cx q[4],q[3];
rz(pi/4) q[3];
rz(2.350158842286967) q[3];
rz(5.540732708314469) q[4];
rz(2.781535113640924) q[4];
cx q[4],q[3];
rz(-2.781535113640924) q[3];
sx q[3];
rz(0.4253617599041246) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[4],q[3];
rz(0) q[3];
sx q[3];
rz(5.857823547275462) q[3];
sx q[3];
rz(9.856154232123336) q[3];
cx q[3],q[2];
rz(pi/2) q[2];
sx q[2];
rz(pi/2) q[2];
