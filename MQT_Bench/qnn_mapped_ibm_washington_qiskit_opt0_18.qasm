...
rz(0) q[11];
sx q[11];
rz(3.3739970743466605) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(3.419525387862706) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[26];
sx q[26];
rz(3.2040041720010777) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.6512259564846166) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[16],q[26];
...
rz(0) q[27];
sx q[27];
rz(3.291786466111828) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.9923115510006686) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
rz(0) q[10];
sx q[10];
rz(3.3115077708844307) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.9281742603745684) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[1];
sx q[1];
rz(3.6816228854003876) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.078722243270285) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.937607041504213) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[15];
sx q[15];
rz(3.9742468925222916) q[15];
sx q[15];
rz(3*pi) q[15];
rz(0) q[23];
sx q[23];
rz(3.561322564335362) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[24];
sx q[24];
rz(3.1471891031696946) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.631962367417922) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(3.214551181057481) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.3550956122470845) q[27];
sx q[27];
rz(3*pi) q[27];
barrier q[1],q[2],q[4],q[15],q[23],q[24],q[25],q[26],q[27],q[17],q[11],q[10],q[12],q[30],q[29],q[16],q[8],q[28];
measure q[1] -> meas[0];
measure q[2] -> meas[1];
measure q[4] -> meas[2];
measure q[15] -> meas[3];
