...
sx q[62];
rz(pi/2) q[62];
barrier q[2],q[8],q[1],q[18],q[5],q[16],q[38],q[32],q[10],q[35],q[42],q[11],q[12],q[0],q[31],q[3],q[6],q[30],q[14],q[21],q[37],q[58],q[17],q[29],q[7],q[33],q[4],q[51],q[9],q[13],q[27],q[43],q[25],q[15],q[23],q[19],q[40],q[54],q[44],q[22],q[28],q[46],q[41],q[52],q[50],q[34],q[24],q[53],q[47],q[20],q[66],q[36],q[61],q[48],q[45],q[49],q[26],q[59],q[39],q[62];
measure q[2] -> meas[0];
measure q[8] -> meas[1];
measure q[1] -> meas[2];
measure q[18] -> meas[3];
