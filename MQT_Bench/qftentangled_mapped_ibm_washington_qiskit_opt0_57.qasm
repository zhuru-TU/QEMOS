...
cx q[39],q[40];
cx q[40],q[39];
barrier q[40],q[41],q[20],q[18],q[21],q[53],q[24],q[47],q[30],q[29],q[35],q[32],q[54],q[51],q[46],q[36],q[10],q[8],q[16],q[43],q[9],q[23],q[15],q[4],q[38],q[2],q[1],q[6],q[34],q[5],q[62],q[3],q[63],q[61],q[60],q[50],q[45],q[42],q[26],q[7],q[27],q[11],q[49],q[55],q[44],q[31],q[28],q[12],q[17],q[48],q[25],q[22],q[0],q[14],q[19],q[33],q[39];
measure q[40] -> meas[0];
measure q[41] -> meas[1];
measure q[20] -> meas[2];
measure q[18] -> meas[3];
