...
cx q[24],q[23];
cx q[23],q[24];
rz(0.112194637928437) q[23];
cx q[23],q[22];
rz(-0.112194637928437) q[22];
cx q[23],q[22];
rz(0.112194637928437) q[22];
cx q[22],q[23];
cx q[23],q[22];
...
sx q[15];
rz(pi/2) q[15];
barrier q[34],q[22],q[13],q[32],q[9],q[31],q[30],q[16],q[7],q[6],q[2],q[18],q[1],q[0],q[14],q[19],q[33],q[39],q[40],q[42],q[43],q[24],q[26],q[28],q[11],q[10],q[12],q[17],q[29],q[27],q[25],q[23],q[5],q[4],q[15],q[3];
measure q[34] -> c[0];
measure q[22] -> c[1];
measure q[13] -> c[2];
measure q[32] -> c[3];
