...
cx q[22],q[23];
cx q[23],q[22];
barrier q[23],q[24],q[40],q[20],q[33],q[14],q[41],q[21],q[25],q[45],q[42],q[44],q[37],q[34],q[2],q[6],q[8],q[27],q[29],q[31],q[12],q[17],q[50],q[13],q[11],q[9],q[10],q[32],q[51],q[43],q[35],q[30],q[16],q[28],q[7],q[5],q[1],q[49],q[3],q[48],q[47],q[46],q[26],q[4],q[38],q[0],q[18],q[19],q[39],q[15],q[22];
measure q[23] -> meas[0];
measure q[24] -> meas[1];
measure q[40] -> meas[2];
measure q[20] -> meas[3];
