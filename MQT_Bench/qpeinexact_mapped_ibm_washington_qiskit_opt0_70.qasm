...
cx q[27],q[26];
cx q[26],q[27];
rz(1.3269589164288305) q[26];
cx q[26],q[16];
rz(-1.3269589164288305) q[16];
cx q[26],q[16];
rz(1.3269589164288305) q[16];
cx q[25],q[26];
cx q[26],q[25];
...
cx q[3],q[2];
cx q[2],q[3];
rz(1.1908933706612643) q[2];
cx q[2],q[1];
rz(-1.1908933706612643) q[1];
cx q[2],q[1];
rz(1.1908933706612643) q[1];
cx q[1],q[2];
cx q[2],q[1];
...
rz(pi/2) q[19];
rz(-pi/4) q[20];
barrier q[50],q[48],q[18],q[38],q[3],q[49],q[67],q[68],q[51],q[55],q[66],q[54],q[65],q[37],q[61],q[52],q[64],q[63],q[62],q[57],q[58],q[59],q[56],q[60],q[31],q[45],q[36],q[46],q[32],q[9],q[13],q[10],q[12],q[11],q[30],q[17],q[47],q[29],q[35],q[5],q[16],q[26],q[6],q[7],q[8],q[27],q[28],q[53],q[41],q[40],q[44],q[21],q[39],q[22],q[25],q[42],q[43],q[34],q[24],q[23],q[15],q[4],q[2],q[1],q[0],q[14],q[33],q[20],q[19],q[69];
measure q[50] -> c[0];
measure q[48] -> c[1];
measure q[18] -> c[2];
measure q[38] -> c[3];
