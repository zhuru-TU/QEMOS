...
rz(0) q[0];
sx q[0];
rz(8.157324676205423) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.792466646650727) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[5];
sx q[5];
rz(1.007806479770852) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(-1.1628479273336243) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[1];
sx q[1];
rz(8.12603372185314) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(7.157908811588937) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(7.355052900811309) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(0.6408214971903048) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(-1.7309560856597477) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(6.620336163504648) q[6];
sx q[6];
rz(3*pi) q[6];
