...
rz(pi/2) q[44];
rz(-pi/4) q[45];
barrier q[44],q[45],q[46],q[43],q[42],q[41],q[40],q[39],q[33],q[21],q[22],q[24],q[25],q[16],q[8],q[27],q[26],q[7],q[29],q[35],q[30],q[28],q[23],q[15],q[18],q[38],q[2],q[4],q[34],q[20],q[3],q[6],q[31],q[17],q[13],q[12],q[11],q[10],q[32],q[9],q[5],q[14],q[0],q[37],q[19],q[47];
measure q[44] -> meas[0];
measure q[45] -> meas[1];
measure q[46] -> meas[2];
measure q[43] -> meas[3];
