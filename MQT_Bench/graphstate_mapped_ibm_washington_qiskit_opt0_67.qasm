...
sx q[44];
rz(pi/2) q[44];
barrier q[3],q[0],q[6],q[15],q[4],q[5],q[31],q[27],q[17],q[40],q[10],q[28],q[50],q[36],q[59],q[1],q[51],q[8],q[58],q[56],q[37],q[2],q[14],q[22],q[25],q[23],q[7],q[11],q[49],q[16],q[9],q[24],q[13],q[33],q[18],q[32],q[12],q[19],q[57],q[46],q[20],q[39],q[42],q[38],q[65],q[68],q[54],q[29],q[30],q[63],q[55],q[45],q[21],q[64],q[34],q[62],q[52],q[44],q[60],q[61],q[35],q[43],q[26],q[41],q[53],q[47],q[48];
measure q[3] -> meas[0];
measure q[0] -> meas[1];
measure q[6] -> meas[2];
measure q[15] -> meas[3];
