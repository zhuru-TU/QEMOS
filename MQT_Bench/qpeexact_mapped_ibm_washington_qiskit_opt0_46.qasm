...
cx q[22],q[15];
cx q[15],q[22];
rz(0.4089154101863965) q[15];
cx q[15],q[4];
rz(-0.4089154101863965) q[4];
cx q[15],q[4];
rz(0.4089154101863965) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.817830820372793) q[4];
cx q[4],q[3];
