...
sx q[29];
rz(pi/2) q[29];
barrier q[19],q[7],q[6],q[3],q[4],q[5],q[26],q[30],q[18],q[13],q[31],q[9],q[11],q[17],q[25],q[14],q[2],q[27],q[1],q[0],q[28],q[24],q[20],q[22],q[21],q[12],q[8],q[29],q[10],q[16],q[23],q[15];
measure q[19] -> meas[0];
measure q[7] -> meas[1];
measure q[6] -> meas[2];
measure q[3] -> meas[3];
