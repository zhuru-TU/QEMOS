...
cx q[55],q[68];
cx q[68],q[55];
barrier q[19],q[20],q[33],q[1],q[15],q[22],q[21],q[46],q[44],q[28],q[53],q[61],q[41],q[59],q[40],q[38],q[56],q[48],q[57],q[45],q[63],q[25],q[64],q[30],q[66],q[68],q[12],q[51],q[49],q[31],q[13],q[65],q[16],q[8],q[9],q[42],q[10],q[32],q[26],q[36],q[11],q[55],q[50],q[17],q[43],q[7],q[24],q[27],q[3],q[35],q[23],q[39],q[52],q[58],q[34],q[62],q[60],q[29],q[54],q[47],q[37],q[5],q[4],q[2],q[0],q[14],q[18];
measure q[19] -> meas[0];
measure q[20] -> meas[1];
measure q[33] -> meas[2];
measure q[1] -> meas[3];
