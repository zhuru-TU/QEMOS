...
cx q[43],q[34];
cx q[34],q[43];
rz(1.3439671096497763) q[34];
cx q[34],q[24];
rz(-1.3439671096497763) q[24];
cx q[34],q[24];
rz(1.3439671096497763) q[24];
cx q[24],q[34];
cx q[34],q[24];
...
cx q[22],q[21];
cx q[21],q[22];
rz(-0.45365843429024066) q[21];
cx q[21],q[20];
rz(0.45365843429024066) q[20];
cx q[21],q[20];
rz(-0.45365843429024066) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[15],q[4];
cx q[4],q[15];
rz(-0.9073168685804813) q[4];
cx q[4],q[3];
rz(0.9073168685804813) q[3];
cx q[4],q[3];
rz(-0.9073168685804813) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(-1.3269589164288305) q[2];
cx q[3],q[2];
rz(1.3269589164288305) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-0.4876748207321322) q[2];
cx q[2],q[1];
...
cx q[5],q[6];
cx q[4],q[5];
rz(-1.1908933706612643) q[5];
cx q[4],q[5];
rz(1.1908933706612643) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(-0.7598059122672645) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
