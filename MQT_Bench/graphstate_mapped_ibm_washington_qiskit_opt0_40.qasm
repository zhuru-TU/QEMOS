...
sx q[43];
rz(pi/2) q[43];
barrier q[5],q[1],q[23],q[22],q[36],q[7],q[17],q[8],q[20],q[10],q[16],q[30],q[13],q[9],q[2],q[6],q[21],q[12],q[32],q[0],q[33],q[18],q[38],q[4],q[34],q[14],q[26],q[25],q[11],q[27],q[28],q[31],q[3],q[37],q[29],q[24],q[44],q[43],q[15],q[19];
measure q[5] -> meas[0];
measure q[1] -> meas[1];
measure q[23] -> meas[2];
measure q[22] -> meas[3];
