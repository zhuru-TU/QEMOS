...
rz(pi/2) q[52];
rz(-pi/4) q[56];
barrier q[52],q[56],q[57],q[37],q[39],q[33],q[20],q[21],q[22],q[23],q[24],q[25],q[26],q[34],q[43],q[41],q[60],q[61],q[62],q[64],q[63],q[54],q[65],q[45],q[66],q[67],q[55],q[49],q[47],q[35],q[29],q[30],q[17],q[32],q[31],q[51],q[12],q[36],q[28],q[27],q[8],q[6],q[3],q[1],q[0],q[14],q[19],q[38],q[42],q[18],q[53],q[11],q[46],q[10],q[40],q[48],q[50],q[13],q[16],q[9],q[7],q[58],q[4],q[15],q[2],q[5],q[59];
measure q[52] -> meas[0];
measure q[56] -> meas[1];
measure q[57] -> meas[2];
measure q[37] -> meas[3];
