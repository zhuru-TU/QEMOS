...
sx q[50];
rz(pi/2) q[50];
barrier q[41],q[19],q[7],q[1],q[0],q[2],q[3],q[5],q[6],q[31],q[11],q[13],q[9],q[10],q[16],q[15],q[8],q[12],q[34],q[4],q[18],q[14],q[20],q[21],q[22],q[24],q[25],q[28],q[27],q[29],q[17],q[32],q[36],q[23],q[43],q[26],q[30],q[35],q[40],q[39],q[37],q[38],q[33],q[42],q[44],q[45],q[46],q[51],q[47],q[48],q[50],q[49];
measure q[41] -> c[0];
measure q[19] -> c[1];
measure q[7] -> c[2];
measure q[1] -> c[3];
