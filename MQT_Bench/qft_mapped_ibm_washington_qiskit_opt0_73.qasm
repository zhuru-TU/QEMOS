...
cx q[61],q[62];
cx q[62],q[61];
barrier q[62],q[59],q[64],q[16],q[55],q[35],q[36],q[51],q[47],q[17],q[65],q[68],q[40],q[71],q[58],q[72],q[42],q[37],q[20],q[41],q[21],q[27],q[46],q[49],q[25],q[13],q[34],q[57],q[7],q[15],q[4],q[1],q[6],q[0],q[14],q[9],q[38],q[10],q[18],q[3],q[23],q[2],q[5],q[22],q[26],q[45],q[24],q[11],q[31],q[48],q[67],q[28],q[19],q[44],q[33],q[52],q[43],q[54],q[66],q[56],q[39],q[70],q[60],q[12],q[30],q[69],q[32],q[29],q[50],q[8],q[63],q[53],q[61];
measure q[62] -> meas[0];
measure q[59] -> meas[1];
measure q[64] -> meas[2];
measure q[16] -> meas[3];
