...
rz(-pi/4) q[40];
rz(-pi/524288) q[47];
barrier q[14],q[0],q[1],q[2],q[19],q[31],q[3],q[18],q[38],q[37],q[41],q[48],q[44],q[23],q[34],q[4],q[15],q[5],q[8],q[6],q[7],q[16],q[43],q[42],q[45],q[46],q[26],q[13],q[47],q[35],q[9],q[10],q[11],q[12],q[17],q[30],q[29],q[28],q[27],q[25],q[24],q[22],q[21],q[20],q[33],q[40],q[39],q[32];
measure q[14] -> c[0];
measure q[0] -> c[1];
measure q[1] -> c[2];
measure q[2] -> c[3];
