...
sx q[44];
rz(3*pi) q[44];
barrier q[9],q[13],q[10],q[17],q[11],q[12],q[30],q[2],q[29],q[27],q[40],q[46],q[28],q[35],q[47],q[45],q[42],q[44],q[41],q[39],q[33],q[23],q[8],q[26],q[24],q[43],q[34],q[25],q[16],q[7],q[6],q[5],q[4],q[15],q[22],q[21],q[18],q[19],q[20];
measure q[9] -> meas[0];
measure q[13] -> meas[1];
measure q[10] -> meas[2];
measure q[17] -> meas[3];
