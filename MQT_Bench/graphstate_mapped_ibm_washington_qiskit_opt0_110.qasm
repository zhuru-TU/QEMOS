...
sx q[101];
rz(pi/2) q[101];
barrier q[39],q[25],q[5],q[2],q[14],q[4],q[34],q[1],q[36],q[50],q[9],q[15],q[24],q[10],q[38],q[59],q[3],q[48],q[6],q[18],q[40],q[20],q[0],q[47],q[30],q[21],q[13],q[44],q[31],q[11],q[49],q[22],q[66],q[23],q[27],q[32],q[82],q[51],q[37],q[90],q[55],q[79],q[41],q[42],q[77],q[84],q[104],q[29],q[108],q[74],q[17],q[8],q[7],q[19],q[26],q[70],q[56],q[61],q[52],q[43],q[71],q[98],q[12],q[58],q[45],q[72],q[67],q[64],q[69],q[63],q[85],q[93],q[78],q[103],q[28],q[57],q[96],q[94],q[91],q[75],q[97],q[88],q[16],q[86],q[80],q[100],q[89],q[60],q[68],q[35],q[54],q[99],q[106],q[46],q[109],q[95],q[76],q[105],q[62],q[53],q[65],q[33],q[73],q[92],q[81],q[107],q[102],q[87],q[83],q[101];
measure q[39] -> meas[0];
measure q[25] -> meas[1];
measure q[5] -> meas[2];
measure q[2] -> meas[3];
...
measure q[65] -> meas[100];
measure q[33] -> meas[101];
measure q[73] -> meas[102];
measure q[92] -> meas[103];
measure q[81] -> meas[104];
measure q[107] -> meas[105];
measure q[102] -> meas[106];
