...
cx q[82],q[83];
cx q[83],q[82];
barrier q[47],q[20],q[33],q[24],q[23],q[42],q[17],q[30],q[13],q[28],q[8],q[27],q[21],q[15],q[43],q[12],q[41],q[2],q[40],q[60],q[46],q[37],q[56],q[54],q[1],q[57],q[64],q[53],q[62],q[81],q[71],q[59],q[36],q[58],q[66],q[69],q[83],q[79],q[82],q[68],q[80],q[77],q[51],q[9],q[39],q[72],q[63],q[10],q[65],q[38],q[45],q[50],q[55],q[49],q[29],q[61],q[14],q[6],q[44],q[26],q[3],q[5],q[4],q[16],q[7],q[48],q[11],q[32],q[31],q[34],q[22],q[25],q[18],q[19],q[35];
measure q[47] -> meas[0];
measure q[20] -> meas[1];
measure q[33] -> meas[2];
measure q[24] -> meas[3];
