...
rz(-pi/4) q[1];
rz(-pi/16) q[14];
barrier q[18],q[20],q[21],q[22],q[15],q[6],q[8],q[26],q[28],q[12],q[17],q[30],q[29],q[27],q[16],q[7],q[5],q[4],q[3],q[14],q[2],q[1],q[0],q[19];
measure q[18] -> c[0];
measure q[20] -> c[1];
measure q[21] -> c[2];
measure q[22] -> c[3];
