...
rz(pi/2) q[1];
sx q[1];
rz(4.3895168916979195) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(4.3895168916979195) q[2];
sx q[2];
rz(5*pi/2) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
rz(pi/2) q[1];
sx q[1];
rz(-4.07298704474178) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(-4.07298704474178) q[2];
sx q[2];
rz(5*pi/2) q[2];
barrier q[0],q[2],q[1];
measure q[0] -> meas[0];
