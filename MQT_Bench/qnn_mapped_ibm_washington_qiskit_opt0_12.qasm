...
rz(0) q[17];
sx q[17];
rz(3.3970725503555377) q[17];
sx q[17];
rz(3*pi) q[17];
rz(0) q[30];
sx q[30];
rz(3.352290089298857) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[17],q[30];
cx q[12],q[17];
...
rz(0) q[12];
sx q[12];
rz(3.9647439999870997) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[30];
sx q[30];
rz(4.08879281200624) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[0];
sx q[0];
rz(3.8241779109770753) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.762728105696843) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.9115174822388874) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.6541375421625952) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.3262108254787752) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.9967010559311813) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.281292135202733) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.4347993129348797) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.4918272256982985) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[29],q[17],q[12],q[30];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
