...
cx q[43],q[34];
cx q[34],q[43];
rz(1.1844953078787184) q[34];
cx q[34],q[24];
rz(-1.1844953078787184) q[24];
cx q[34],q[24];
rz(1.1844953078787184) q[24];
cx q[24],q[34];
cx q[34],q[24];
...
sx q[21];
rz(pi/2) q[21];
barrier q[56],q[64],q[62],q[1],q[63],q[6],q[66],q[5],q[65],q[68],q[26],q[46],q[8],q[7],q[40],q[49],q[54],q[0],q[18],q[52],q[37],q[14],q[58],q[61],q[38],q[57],q[60],q[59],q[53],q[42],q[19],q[41],q[2],q[16],q[39],q[3],q[4],q[15],q[23],q[34],q[25],q[9],q[10],q[11],q[12],q[51],q[13],q[32],q[29],q[17],q[27],q[35],q[28],q[30],q[31],q[36],q[50],q[48],q[47],q[45],q[44],q[43],q[24],q[22],q[33],q[20],q[21],q[67];
measure q[56] -> c[0];
measure q[64] -> c[1];
measure q[62] -> c[2];
measure q[1] -> c[3];
