...
rz(pi/2) q[50];
rz(-pi/4) q[51];
barrier q[50],q[51],q[49],q[48],q[47],q[46],q[45],q[44],q[42],q[41],q[40],q[39],q[38],q[37],q[33],q[20],q[21],q[22],q[24],q[23],q[25],q[26],q[27],q[28],q[29],q[30],q[17],q[12],q[11],q[10],q[9],q[13],q[31],q[34],q[16],q[15],q[19],q[3],q[5],q[6],q[4],q[8],q[18],q[32],q[35],q[43],q[14],q[7],q[1],q[2],q[0],q[36];
measure q[50] -> meas[0];
measure q[51] -> meas[1];
measure q[49] -> meas[2];
measure q[48] -> meas[3];
