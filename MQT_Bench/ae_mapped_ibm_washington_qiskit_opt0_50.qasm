...
rz(pi/2) q[11];
rz(-pi/8) q[12];
barrier q[11],q[10],q[12],q[9],q[13],q[17],q[30],q[32],q[36],q[50],q[48],q[47],q[46],q[35],q[45],q[49],q[28],q[26],q[25],q[24],q[34],q[43],q[42],q[40],q[41],q[39],q[20],q[33],q[38],q[22],q[21],q[15],q[27],q[23],q[44],q[8],q[29],q[16],q[3],q[7],q[5],q[2],q[1],q[4],q[6],q[19],q[18],q[14],q[37],q[0];
measure q[11] -> meas[0];
measure q[10] -> meas[1];
measure q[12] -> meas[2];
measure q[9] -> meas[3];
