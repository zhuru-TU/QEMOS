...
sx q[43];
rz(pi/2) q[43];
barrier q[1],q[0],q[2],q[16],q[8],q[35],q[7],q[38],q[18],q[11],q[25],q[36],q[32],q[29],q[20],q[6],q[31],q[4],q[14],q[37],q[42],q[39],q[3],q[40],q[19],q[15],q[5],q[17],q[27],q[13],q[9],q[12],q[30],q[21],q[34],q[24],q[10],q[26],q[22],q[23],q[28],q[43],q[33];
measure q[1] -> meas[0];
measure q[0] -> meas[1];
measure q[2] -> meas[2];
measure q[16] -> meas[3];
