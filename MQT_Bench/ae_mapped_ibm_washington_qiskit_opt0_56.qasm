...
sx q[18];
rz(pi/2) q[18];
barrier q[18],q[14],q[19],q[20],q[21],q[22],q[24],q[34],q[43],q[40],q[42],q[23],q[15],q[41],q[33],q[39],q[44],q[0],q[38],q[53],q[45],q[47],q[35],q[28],q[29],q[46],q[27],q[30],q[31],q[32],q[49],q[48],q[54],q[26],q[25],q[16],q[17],q[50],q[8],q[4],q[7],q[6],q[36],q[12],q[11],q[10],q[9],q[55],q[13],q[51],q[5],q[3],q[2],q[37],q[1],q[60];
measure q[18] -> meas[0];
measure q[14] -> meas[1];
measure q[19] -> meas[2];
measure q[20] -> meas[3];
