...
cx q[22],q[21];
cx q[21],q[22];
rz(-0.44772245060065263) q[21];
cx q[21],q[20];
rz(0.44772245060065263) q[20];
cx q[21],q[20];
rz(-0.44772245060065263) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[15],q[4];
cx q[4],q[15];
rz(-0.8954449012013053) q[4];
cx q[4],q[3];
rz(0.8954449012013053) q[3];
cx q[4],q[3];
rz(-0.8954449012013053) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(-1.3507028511871826) q[2];
cx q[3],q[2];
rz(1.3507028511871826) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-0.44018695121542817) q[2];
cx q[2],q[1];
...
rz(pi/2) q[7];
rz(-pi/32) q[16];
barrier q[15],q[22],q[1],q[53],q[63],q[72],q[60],q[71],q[33],q[23],q[68],q[47],q[44],q[43],q[14],q[19],q[21],q[40],q[41],q[42],q[34],q[24],q[25],q[13],q[31],q[9],q[10],q[11],q[12],q[17],q[30],q[29],q[26],q[27],q[28],q[35],q[48],q[46],q[45],q[54],q[70],q[36],q[32],q[51],q[50],q[69],q[49],q[55],q[67],q[66],q[65],q[64],q[62],q[61],q[59],q[58],q[57],q[56],q[52],q[37],q[38],q[39],q[20],q[18],q[0],q[2],q[3],q[4],q[16],q[8],q[5],q[6],q[7],q[81];
measure q[15] -> c[0];
measure q[22] -> c[1];
measure q[1] -> c[2];
measure q[53] -> c[3];
