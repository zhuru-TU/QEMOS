...
cx q[46],q[45];
cx q[45],q[46];
barrier q[40],q[20],q[23],q[45],q[48],q[26],q[25],q[34],q[30],q[17],q[11],q[15],q[24],q[13],q[4],q[7],q[8],q[44],q[3],q[47],q[41],q[1],q[42],q[37],q[35],q[14],q[0],q[38],q[2],q[18],q[16],q[5],q[6],q[33],q[9],q[21],q[43],q[10],q[12],q[31],q[29],q[28],q[27],q[49],q[46],q[22],q[19],q[39];
measure q[40] -> meas[0];
measure q[20] -> meas[1];
measure q[23] -> meas[2];
measure q[45] -> meas[3];
