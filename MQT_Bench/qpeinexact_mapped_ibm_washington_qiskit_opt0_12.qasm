...
cx q[26],q[25];
cx q[25],q[26];
rz(0.10200972239439514) q[25];
cx q[25],q[24];
rz(-0.10200972239439514) q[24];
cx q[25],q[24];
rz(0.10200972239439514) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[22],q[15];
cx q[15],q[22];
rz(0.20401944478879028) q[15];
cx q[15],q[4];
rz(-0.20401944478879028) q[4];
cx q[15],q[4];
rz(0.20401944478879028) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.2454369260617026) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.2454369260617026) q[5];
cx q[4],q[5];
rz(0.2454369260617026) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[3],q[2];
cx q[2],q[3];
rz(0.4908738521234052) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.4908738521234052) q[6];
cx q[5],q[6];
rz(0.4908738521234052) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
rz(pi/2) q[8];
rz(-pi/4) q[16];
barrier q[27],q[24],q[23],q[15],q[2],q[3],q[4],q[6],q[26],q[16],q[8],q[12];
measure q[27] -> c[0];
measure q[24] -> c[1];
measure q[23] -> c[2];
measure q[15] -> c[3];
