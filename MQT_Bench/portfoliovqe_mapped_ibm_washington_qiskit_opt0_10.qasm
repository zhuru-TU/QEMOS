...
rz(0) q[0];
sx q[0];
rz(9.240292321825144) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(0.5722108617276631) q[1];
sx q[1];
rz(3*pi) q[1];
rz(pi/2) q[1];
sx q[1];
...
rz(0) q[2];
sx q[2];
rz(-2.6351590925439075) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(9.021393505050904) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(-0.6876118629551442) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.5827200621166977) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[7];
sx q[7];
rz(7.689902644201103) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(7.335633305788962) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
rz(0) q[27];
sx q[27];
rz(0.03487819810199477) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[28];
sx q[28];
rz(0.7151740208829844) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[1];
sx q[1];
rz(7.627388203073911) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(0.5805218723573407) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(8.119793943419959) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(-1.938749970005425) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(-2.980818105865608) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.0962194007390273) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(-2.246281184547893) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(1.685559997737207) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[28];
sx q[28];
rz(5.162412578296259) q[28];
sx q[28];
rz(3*pi) q[28];
