...
rz(pi/2) q[3];
rz(-pi/4) q[4];
barrier q[14],q[21],q[2],q[6],q[7],q[23],q[16],q[28],q[12],q[17],q[30],q[29],q[27],q[26],q[25],q[24],q[22],q[20],q[18],q[0],q[1],q[5],q[4],q[3],q[19];
measure q[14] -> c[0];
measure q[21] -> c[1];
measure q[2] -> c[2];
measure q[6] -> c[3];
