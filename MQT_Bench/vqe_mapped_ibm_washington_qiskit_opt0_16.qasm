...
rz(0) q[2];
sx q[2];
rz(6.283167408872974) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.141582483847878) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.1416497705570507) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(2.7431593301485537) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(4.711742220769406) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(4.712735694565579) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(1.5703386639129704) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[9];
sx q[9];
rz(1.5708043368967457) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[10];
sx q[10];
rz(4.711787861110168) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[11];
sx q[11];
rz(1.5712617931551718) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
rz(1.570386981352143) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[13];
sx q[13];
rz(1.5708674204627255) q[13];
sx q[13];
rz(3*pi) q[13];
cx q[12],q[13];
cx q[13],q[12];
...
rz(0) q[14];
sx q[14];
rz(1.5707977324923434) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[15];
sx q[15];
rz(4.712334270804799) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[8],q[16];
cx q[16],q[8];
...
rz(0) q[9];
sx q[9];
rz(1.5707868623978105) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(1.5705918469708664) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
rz(6.048373574288714) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[10];
sx q[10];
rz(3.1413147858536954) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(1.6288788888890415) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[17],q[30];
cx q[30],q[17];
...
rz(0) q[4];
sx q[4];
rz(1.149514906595428e-05) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.1416593582254144) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.132395083418298) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
...
rz(0) q[27];
sx q[27];
rz(3.505846739234074) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[30];
sx q[30];
rz(0.489383249293442) q[30];
sx q[30];
rz(3*pi) q[30];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[30],q[11],q[10],q[12],q[29],q[8],q[23];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
