...
cx q[47],q[46];
cx q[46],q[47];
barrier q[46],q[34],q[42],q[25],q[40],q[35],q[27],q[45],q[65],q[31],q[36],q[50],q[64],q[66],q[44],q[8],q[41],q[26],q[12],q[55],q[48],q[21],q[49],q[11],q[10],q[6],q[3],q[0],q[2],q[18],q[5],q[1],q[19],q[9],q[20],q[33],q[14],q[68],q[53],q[16],q[4],q[15],q[7],q[22],q[63],q[54],q[51],q[32],q[17],q[62],q[29],q[30],q[28],q[39],q[23],q[43],q[24],q[47];
measure q[46] -> meas[0];
measure q[34] -> meas[1];
measure q[42] -> meas[2];
measure q[25] -> meas[3];
