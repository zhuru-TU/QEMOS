...
cx q[23],q[24];
cx q[24],q[23];
barrier q[40],q[24],q[41],q[42],q[43],q[34],q[54],q[22],q[35],q[49],q[55],q[48],q[66],q[45],q[3],q[1],q[64],q[0],q[5],q[29],q[16],q[31],q[8],q[26],q[11],q[7],q[68],q[9],q[36],q[10],q[32],q[13],q[12],q[17],q[27],q[30],q[6],q[14],q[44],q[21],q[2],q[53],q[63],q[4],q[65],q[47],q[28],q[15],q[46],q[25],q[19],q[20],q[33],q[23],q[39];
measure q[40] -> meas[0];
measure q[24] -> meas[1];
measure q[41] -> meas[2];
measure q[42] -> meas[3];
