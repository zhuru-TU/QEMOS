...
cx q[24],q[25];
cx q[25],q[24];
barrier q[25],q[16],q[27],q[26],q[10],q[12],q[31],q[30],q[46],q[29],q[43],q[28],q[2],q[3],q[5],q[33],q[19],q[18],q[14],q[52],q[41],q[15],q[0],q[1],q[48],q[49],q[45],q[51],q[50],q[35],q[34],q[21],q[42],q[40],q[37],q[38],q[20],q[39],q[6],q[4],q[36],q[22],q[44],q[13],q[47],q[17],q[32],q[11],q[9],q[23],q[7],q[8],q[24];
measure q[25] -> meas[0];
measure q[16] -> meas[1];
measure q[27] -> meas[2];
measure q[26] -> meas[3];
