...
rz(0) q[27];
sx q[27];
rz(-15189.663259084824) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
rz(0) q[27];
sx q[27];
rz(15195.946444392004) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[8];
sx q[8];
rz(-60768.077814300064) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[7],q[8];
rz(0) q[8];
sx q[8];
rz(60774.36099960725) q[8];
sx q[8];
rz(3*pi) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
rz(0) q[7];
sx q[7];
rz(-243081.73603516104) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
rz(0) q[7];
sx q[7];
rz(243088.0192204682) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
rz(0) q[15];
sx q[15];
rz(-486166.61366297567) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[22],q[15];
rz(0) q[15];
sx q[15];
rz(486172.89684828283) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[15],q[22];
cx q[22],q[15];
...
rz(0) q[15];
sx q[15];
rz(-62229725.53112789) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[4],q[15];
rz(0) q[15];
sx q[15];
rz(62229731.814313196) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[15],q[22];
cx q[22],q[15];
...
rz(0) q[27];
sx q[27];
rz(-31861621077.291325) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[28],q[27];
rz(0) q[27];
sx q[27];
rz(31861621083.574512) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[30];
sx q[30];
rz(-63723242157.72424) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[31],q[30];
rz(0) q[30];
sx q[30];
rz(63723242164.00743) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[42];
sx q[42];
rz(-4078287498292.272) q[42];
sx q[42];
rz(3*pi) q[42];
cx q[43],q[42];
rz(0) q[42];
sx q[42];
rz(4078287498298.555) q[42];
sx q[42];
rz(3*pi) q[42];
cx q[42],q[43];
cx q[43],q[42];
...
rz(0) q[69];
sx q[69];
rz(-348471964706527510528*pi) q[69];
sx q[69];
rz(3*pi) q[69];
cx q[70],q[69];
rz(0) q[69];
...
rz(0) q[64];
sx q[64];
rz(-696943929413055021056*pi) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[63],q[64];
rz(0) q[64];
...
rz(0) q[63];
sx q[63];
rz(-1393887858826110042112*pi) q[63];
sx q[63];
rz(3*pi) q[63];
cx q[62],q[63];
rz(0) q[63];
...
rz(0) q[65];
sx q[65];
rz(-2787775717652220084224*pi) q[65];
sx q[65];
rz(3*pi) q[65];
cx q[66],q[65];
rz(0) q[65];
...
rz(pi/2) q[69];
rz(-pi/4) q[70];
barrier q[69],q[70],q[74],q[68],q[67],q[66],q[65],q[64],q[63],q[62],q[72],q[81],q[80],q[79],q[77],q[58],q[57],q[56],q[52],q[37],q[39],q[41],q[43],q[45],q[47],q[28],q[26],q[25],q[24],q[44],q[42],q[40],q[46],q[34],q[53],q[35],q[54],q[29],q[48],q[49],q[30],q[17],q[31],q[12],q[32],q[27],q[11],q[55],q[33],q[22],q[4],q[3],q[2],q[1],q[0],q[7],q[23],q[15],q[10],q[36],q[50],q[51],q[13],q[9],q[38],q[8],q[20],q[21],q[5],q[18],q[14],q[19],q[16],q[6],q[71];
measure q[69] -> meas[0];
measure q[70] -> meas[1];
measure q[74] -> meas[2];
measure q[68] -> meas[3];
