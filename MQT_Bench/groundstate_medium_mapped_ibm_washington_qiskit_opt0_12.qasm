...
rz(pi/2) q[30];
sx q[30];
rz(5.262068219594607) q[30];
sx q[30];
rz(5*pi/2) q[30];
barrier q[0],q[1],q[3],q[4],q[5],q[6],q[8],q[26],q[28],q[12],q[17],q[30];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[3] -> meas[2];
measure q[4] -> meas[3];
