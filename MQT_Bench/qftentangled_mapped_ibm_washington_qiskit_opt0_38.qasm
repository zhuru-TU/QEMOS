...
cx q[47],q[35];
cx q[35],q[47];
barrier q[35],q[27],q[25],q[30],q[8],q[16],q[17],q[11],q[28],q[45],q[15],q[43],q[9],q[33],q[31],q[20],q[6],q[2],q[3],q[4],q[1],q[5],q[18],q[13],q[19],q[21],q[10],q[34],q[44],q[12],q[46],q[22],q[23],q[7],q[29],q[24],q[26],q[47];
measure q[35] -> meas[0];
measure q[27] -> meas[1];
measure q[25] -> meas[2];
measure q[30] -> meas[3];
