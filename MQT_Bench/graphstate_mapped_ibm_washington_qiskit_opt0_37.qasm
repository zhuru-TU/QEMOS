...
sx q[23];
rz(pi/2) q[23];
barrier q[1],q[14],q[0],q[26],q[6],q[13],q[21],q[3],q[12],q[11],q[10],q[9],q[29],q[31],q[4],q[22],q[5],q[7],q[32],q[34],q[18],q[24],q[15],q[2],q[19],q[20],q[23],q[28],q[36],q[35],q[16],q[8],q[25],q[33],q[27],q[17],q[30];
measure q[1] -> meas[0];
measure q[14] -> meas[1];
measure q[0] -> meas[2];
measure q[26] -> meas[3];
