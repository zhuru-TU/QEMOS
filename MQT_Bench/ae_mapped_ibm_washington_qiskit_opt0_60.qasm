...
sx q[15];
rz(pi/2) q[15];
barrier q[15],q[4],q[5],q[22],q[21],q[20],q[39],q[40],q[41],q[42],q[43],q[45],q[54],q[44],q[63],q[61],q[53],q[60],q[59],q[38],q[37],q[23],q[33],q[24],q[34],q[25],q[26],q[52],q[28],q[29],q[30],q[31],q[32],q[35],q[36],q[27],q[3],q[16],q[64],q[47],q[51],q[6],q[46],q[8],q[48],q[17],q[12],q[49],q[11],q[13],q[10],q[9],q[50],q[2],q[19],q[1],q[14],q[0],q[56],q[57];
measure q[15] -> meas[0];
measure q[4] -> meas[1];
measure q[5] -> meas[2];
measure q[22] -> meas[3];
