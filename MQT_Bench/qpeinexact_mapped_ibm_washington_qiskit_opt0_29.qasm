...
cx q[24],q[23];
cx q[23],q[24];
rz(1.5160122039934265) q[23];
cx q[23],q[22];
rz(-1.5160122039934265) q[22];
cx q[23],q[22];
rz(1.5160122039934265) q[22];
cx q[22],q[23];
cx q[23],q[22];
...
cx q[21],q[20];
cx q[20],q[21];
rz(-0.10956824560294026) q[20];
cx q[20],q[19];
rz(0.10956824560294026) q[19];
cx q[20],q[19];
rz(-0.10956824560294026) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(-0.21913649120588052) q[18];
cx q[18],q[14];
rz(0.21913649120588052) q[14];
cx q[18],q[14];
rz(-0.21913649120588052) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(-0.43827298241176105) q[0];
cx q[0],q[1];
rz(0.43827298241176105) q[1];
cx q[0],q[1];
rz(-0.43827298241176105) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(-0.8765459648235221) q[1];
cx q[1],q[2];
rz(0.8765459648235221) q[2];
cx q[1],q[2];
rz(-0.8765459648235221) q[2];
cx q[1],q[2];
cx q[2],q[1];
...
cx q[3],q[2];
cx q[2],q[3];
rz(1.388500723942749) q[3];
cx q[3],q[4];
rz(-1.388500723942749) q[4];
cx q[3],q[4];
rz(1.388500723942749) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
cx q[2],q[3];
rz(-0.36459120570429515) q[4];
cx q[4],q[5];
rz(0.36459120570429515) q[5];
cx q[4],q[5];
rz(-0.36459120570429515) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[3],q[4];
cx q[4],q[15];
rz(-0.7291824114085903) q[5];
cx q[5],q[6];
rz(0.7291824114085903) q[6];
cx q[5],q[6];
rz(-0.7291824114085903) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(-1.4583648228171806) q[6];
cx q[6],q[7];
rz(1.4583648228171806) q[7];
cx q[6],q[7];
rz(-1.4583648228171806) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.44972601591086336) q[17];
cx q[17],q[12];
rz(-0.44972601591086336) q[12];
cx q[17],q[12];
rz(0.44972601591086336) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.8994520318217267) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-1.3426885899463397) q[11];
cx q[11],q[10];
rz(1.3426885899463397) q[10];
cx q[11],q[10];
rz(-1.3426885899463397) q[10];
rz(0.45621547369711396) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(-0.45621547369711396) q[12];
cx q[11],q[12];
rz(0.45621547369711396) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[27],q[26];
cx q[26],q[27];
rz(0.9124309473942279) q[26];
cx q[26],q[25];
rz(-0.9124309473942279) q[25];
cx q[26],q[25];
rz(0.9124309473942279) q[25];
cx q[25],q[26];
cx q[26],q[25];
cx q[25],q[26];
rz(-1.3167307588013373) q[25];
cx q[26],q[27];
cx q[27],q[26];
cx q[26],q[27];
cx q[16],q[26];
...
cx q[25],q[24];
cx q[24],q[25];
rz(-1.1090681096413186) q[24];
cx q[24],q[23];
rz(1.1090681096413186) q[23];
cx q[24],q[23];
rz(-1.1090681096413186) q[23];
cx q[23],q[24];
cx q[24],q[23];
