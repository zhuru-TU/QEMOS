...
sx q[17];
rz(pi/2) q[17];
barrier q[1],q[14],q[21],q[5],q[22],q[3],q[10],q[2],q[32],q[16],q[9],q[7],q[28],q[13],q[8],q[0],q[29],q[23],q[24],q[20],q[6],q[11],q[27],q[18],q[19],q[25],q[4],q[15],q[26],q[12],q[31],q[30],q[17];
measure q[1] -> meas[0];
measure q[14] -> meas[1];
measure q[21] -> meas[2];
measure q[5] -> meas[3];
