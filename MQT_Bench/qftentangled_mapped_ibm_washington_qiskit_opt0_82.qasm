...
cx q[50],q[49];
cx q[49],q[50];
barrier q[40],q[41],q[61],q[59],q[78],q[21],q[83],q[54],q[47],q[49],q[85],q[84],q[44],q[43],q[80],q[48],q[55],q[68],q[8],q[70],q[64],q[66],q[74],q[36],q[17],q[12],q[25],q[26],q[31],q[6],q[16],q[15],q[2],q[0],q[42],q[20],q[72],q[58],q[81],q[52],q[56],q[38],q[37],q[24],q[71],q[14],q[18],q[62],q[1],q[22],q[5],q[23],q[3],q[10],q[27],q[4],q[13],q[11],q[51],q[67],q[79],q[65],q[69],q[7],q[30],q[29],q[28],q[63],q[34],q[46],q[86],q[73],q[50],q[35],q[45],q[82],q[19],q[77],q[53],q[60],q[33],q[39];
measure q[40] -> meas[0];
measure q[41] -> meas[1];
measure q[61] -> meas[2];
measure q[59] -> meas[3];
