...
cx q[86],q[85];
cx q[85],q[86];
barrier q[40],q[60],q[72],q[59],q[41],q[47],q[28],q[46],q[54],q[17],q[48],q[13],q[64],q[85],q[66],q[49],q[68],q[73],q[27],q[88],q[50],q[69],q[83],q[70],q[74],q[80],q[8],q[43],q[34],q[25],q[18],q[58],q[19],q[21],q[2],q[81],q[56],q[37],q[52],q[0],q[1],q[15],q[38],q[57],q[6],q[5],q[3],q[4],q[42],q[22],q[16],q[23],q[24],q[31],q[7],q[36],q[51],q[67],q[87],q[26],q[82],q[9],q[84],q[55],q[44],q[65],q[86],q[10],q[11],q[63],q[12],q[45],q[30],q[29],q[35],q[33],q[61],q[62],q[53],q[39];
measure q[40] -> meas[0];
measure q[60] -> meas[1];
measure q[72] -> meas[2];
measure q[59] -> meas[3];
