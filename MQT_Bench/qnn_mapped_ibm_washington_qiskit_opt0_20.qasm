...
rz(0) q[11];
sx q[11];
rz(3.5333474197845973) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(3.86625158524609) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[26];
sx q[26];
rz(3.9504818624562814) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.582510473288456) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[25],q[26];
...
rz(0) q[27];
sx q[27];
rz(3.515865852525774) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.602793778875065) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
rz(0) q[10];
sx q[10];
rz(3.2991936365950183) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.8325239111717764) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[0];
sx q[0];
rz(3.973476740527678) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.919914421356303) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.7663970498403407) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.9312526751500547) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[21];
sx q[21];
rz(3.392130272627049) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(4.093863805868537) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[23];
sx q[23];
rz(3.9969871869255815) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[25];
sx q[25];
rz(4.082018358986049) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(3.2797070816527025) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.1994692629616215) q[27];
sx q[27];
rz(3*pi) q[27];
barrier q[0],q[1],q[2],q[4],q[22],q[21],q[23],q[25],q[26],q[24],q[27],q[17],q[11],q[10],q[12],q[30],q[29],q[16],q[15],q[28];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
