...
sx q[92];
rz(pi/2) q[92];
barrier q[14],q[1],q[0],q[12],q[7],q[18],q[26],q[3],q[6],q[23],q[10],q[47],q[13],q[32],q[20],q[22],q[36],q[31],q[19],q[37],q[102],q[56],q[33],q[57],q[4],q[35],q[25],q[5],q[15],q[39],q[17],q[9],q[16],q[49],q[28],q[11],q[48],q[8],q[84],q[52],q[2],q[82],q[53],q[42],q[30],q[21],q[65],q[87],q[64],q[89],q[51],q[27],q[77],q[50],q[54],q[74],q[71],q[40],q[98],q[58],q[38],q[86],q[90],q[45],q[72],q[69],q[85],q[63],q[55],q[88],q[43],q[62],q[34],q[24],q[46],q[96],q[81],q[78],q[97],q[61],q[99],q[66],q[29],q[41],q[94],q[104],q[70],q[73],q[68],q[60],q[75],q[59],q[79],q[91],q[44],q[76],q[95],q[83],q[80],q[67],q[92];
measure q[14] -> meas[0];
measure q[1] -> meas[1];
measure q[0] -> meas[2];
measure q[12] -> meas[3];
