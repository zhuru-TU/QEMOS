...
cx q[41],q[40];
cx q[40],q[41];
rz(1.3380311259601883) q[40];
cx q[40],q[39];
rz(-1.3380311259601883) q[39];
cx q[40],q[39];
rz(1.3380311259601883) q[39];
cx q[39],q[40];
cx q[40],q[39];
...
cx q[33],q[20];
cx q[20],q[33];
rz(-0.4655304016694167) q[20];
cx q[20],q[19];
rz(0.4655304016694167) q[19];
cx q[20],q[19];
rz(-0.4655304016694167) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[22],q[15];
cx q[15],q[22];
rz(-0.9310608033388335) q[15];
cx q[15],q[4];
rz(0.9310608033388335) q[4];
cx q[15],q[4];
rz(-0.9310608033388335) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(1.2794710469121264) q[4];
cx q[4],q[3];
...
cx q[4],q[3];
rz(0.5826505597655403) q[3];
cx q[4],q[3];
rz(-0.5826505597655403) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-1.1653011195310805) q[4];
cx q[4],q[5];
rz(1.1653011195310805) q[5];
cx q[4],q[5];
rz(0.8109904145276321) q[4];
rz(-1.1653011195310805) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.8109904145276321) q[5];
cx q[4],q[5];
rz(0.8109904145276321) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
sx q[36];
rz(pi/2) q[36];
barrier q[71],q[39],q[64],q[55],q[58],q[65],q[70],q[66],q[69],q[67],q[68],q[49],q[45],q[7],q[54],q[46],q[6],q[14],q[5],q[56],q[52],q[62],q[61],q[18],q[37],q[60],q[59],q[57],q[53],q[63],q[44],q[8],q[43],q[34],q[1],q[20],q[22],q[15],q[3],q[4],q[2],q[0],q[19],q[38],q[42],q[41],q[40],q[33],q[21],q[23],q[16],q[24],q[31],q[9],q[13],q[10],q[12],q[11],q[30],q[25],q[26],q[17],q[27],q[28],q[29],q[35],q[47],q[48],q[50],q[51],q[32],q[36],q[72];
measure q[71] -> c[0];
measure q[39] -> c[1];
measure q[64] -> c[2];
measure q[55] -> c[3];
