...
cx q[46],q[47];
cx q[47],q[46];
barrier q[39],q[22],q[43],q[34],q[41],q[4],q[47],q[35],q[30],q[28],q[8],q[7],q[6],q[11],q[2],q[24],q[18],q[1],q[21],q[20],q[0],q[14],q[26],q[23],q[19],q[25],q[5],q[10],q[12],q[16],q[17],q[27],q[31],q[29],q[46],q[3],q[40],q[44],q[42],q[15],q[33];
measure q[39] -> meas[0];
measure q[22] -> meas[1];
measure q[43] -> meas[2];
measure q[34] -> meas[3];
