...
cx q[3],q[2];
cx q[2],q[3];
rz(0.44749339226169826) q[2];
cx q[2],q[1];
rz(-0.44749339226169826) q[1];
cx q[2],q[1];
rz(0.44749339226169826) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
rz(pi/2) q[6];
rz(-pi/4) q[7];
barrier q[13],q[25],q[18],q[0],q[2],q[5],q[16],q[23],q[26],q[28],q[30],q[11],q[10],q[12],q[17],q[29],q[27],q[24],q[22],q[3],q[1],q[14],q[19],q[20],q[21],q[15],q[4],q[8],q[7],q[6],q[9];
measure q[13] -> c[0];
measure q[25] -> c[1];
measure q[18] -> c[2];
measure q[0] -> c[3];
