...
cx q[45],q[44];
cx q[44],q[45];
rz(1.3468851166290816) q[44];
cx q[44],q[43];
rz(-1.3468851166290816) q[43];
cx q[44],q[43];
rz(1.3468851166290816) q[43];
cx q[43],q[44];
cx q[44],q[43];
...
cx q[40],q[39];
cx q[39],q[40];
rz(-0.44782242033162994) q[39];
cx q[39],q[33];
rz(0.44782242033162994) q[33];
cx q[39],q[33];
rz(-0.44782242033162994) q[33];
cx q[33],q[39];
cx q[39],q[33];
...
cx q[20],q[19];
cx q[19],q[20];
rz(-0.8956448406632599) q[19];
cx q[19],q[18];
rz(0.8956448406632599) q[18];
cx q[19],q[18];
rz(-0.8956448406632599) q[18];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[18],q[14];
cx q[14],q[18];
rz(1.3503029722632733) q[14];
cx q[14],q[0];
rz(-1.3503029722632733) q[0];
cx q[14],q[0];
rz(1.3503029722632733) q[0];
cx q[0],q[14];
cx q[14],q[0];
cx q[0],q[14];
rz(-0.44098670906324644) q[0];
cx q[0],q[1];
rz(0.44098670906324644) q[1];
cx q[0],q[1];
rz(-0.44098670906324644) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-0.8819734181264929) q[2];
cx q[2],q[3];
rz(0.8819734181264929) q[3];
cx q[2],q[3];
rz(-0.8819734181264929) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(1.3776458173368076) q[3];
cx q[3],q[4];
rz(-1.3776458173368076) q[4];
cx q[3],q[4];
rz(1.3776458173368076) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
cx q[2],q[3];
rz(-0.3863010189161782) q[4];
cx q[4],q[5];
rz(0.3863010189161782) q[5];
cx q[4],q[5];
rz(-0.3863010189161782) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[6],q[5];
cx q[5],q[6];
rz(-0.7726020378323564) q[6];
cx q[6],q[7];
rz(0.7726020378323564) q[7];
cx q[6],q[7];
rz(-0.7726020378323564) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-1.5452040756647127) q[28];
cx q[28],q[29];
rz(1.5452040756647127) q[29];
cx q[28],q[29];
rz(-1.5452040756647127) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
rz(pi/2) q[47];
rz(-pi/512) q[70];
barrier q[56],q[37],q[52],q[72],q[57],q[58],q[59],q[73],q[66],q[62],q[65],q[45],q[64],q[63],q[38],q[44],q[6],q[43],q[15],q[26],q[25],q[16],q[8],q[7],q[5],q[14],q[0],q[42],q[1],q[2],q[3],q[4],q[23],q[34],q[24],q[22],q[19],q[18],q[21],q[20],q[53],q[33],q[40],q[39],q[41],q[60],q[61],q[54],q[46],q[27],q[13],q[9],q[10],q[11],q[30],q[51],q[12],q[36],q[17],q[32],q[31],q[29],q[74],q[67],q[50],q[70],q[69],q[68],q[55],q[49],q[48],q[28],q[35],q[47],q[71];
measure q[56] -> c[0];
measure q[37] -> c[1];
measure q[52] -> c[2];
measure q[72] -> c[3];
