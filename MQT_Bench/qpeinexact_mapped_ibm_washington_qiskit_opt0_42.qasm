...
cx q[33],q[20];
cx q[20],q[33];
rz(0.10299577321808415) q[20];
cx q[20],q[19];
rz(-0.10299577321808415) q[19];
cx q[20],q[19];
rz(0.10299577321808415) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(0.2059915464361683) q[18];
cx q[18],q[14];
rz(-0.2059915464361683) q[14];
cx q[18],q[14];
rz(0.2059915464361683) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(0.4119830928723366) q[0];
cx q[0],q[1];
rz(-0.4119830928723366) q[1];
cx q[0],q[1];
rz(0.4119830928723366) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(0.8239661857446732) q[1];
cx q[1],q[2];
rz(-0.8239661857446732) q[2];
cx q[1],q[2];
rz(0.8239661857446732) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-1.4936602821004468) q[2];
cx q[2],q[3];
rz(1.4936602821004468) q[3];
cx q[2],q[3];
rz(-1.4936602821004468) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.15427208938889952) q[3];
cx q[3],q[4];
rz(-0.15427208938889952) q[4];
cx q[3],q[4];
rz(0.15427208938889952) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.30854417877779905) q[4];
cx q[4],q[5];
rz(-0.30854417877779905) q[5];
cx q[4],q[5];
rz(0.30854417877779905) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.6170883575555981) q[5];
cx q[5],q[6];
rz(-0.6170883575555981) q[6];
cx q[5],q[6];
rz(0.6170883575555981) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.2341767151111962) q[6];
cx q[6],q[7];
rz(-1.2341767151111962) q[7];
cx q[6],q[7];
rz(1.2341767151111962) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[27],q[26];
cx q[26],q[27];
rz(-0.6732392233674006) q[28];
cx q[28],q[29];
rz(0.6732392233674006) q[29];
cx q[28],q[29];
rz(-0.6732392233674006) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[22],q[15];
cx q[15],q[22];
rz(1.3845614717656554) q[15];
cx q[15],q[4];
rz(-1.3845614717656554) q[4];
cx q[15],q[4];
rz(1.3845614717656554) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
cx q[5],q[4];
cx q[4],q[5];
rz(-0.37246971005848223) q[5];
cx q[5],q[6];
rz(0.37246971005848223) q[6];
cx q[5],q[6];
rz(-0.37246971005848223) q[6];
cx q[6],q[7];
cx q[7],q[6];
...
sx q[43];
rz(pi/2) q[43];
barrier q[0],q[14],q[16],q[2],q[6],q[18],q[3],q[8],q[5],q[33],q[7],q[4],q[15],q[19],q[21],q[28],q[20],q[45],q[44],q[39],q[22],q[40],q[23],q[24],q[47],q[35],q[13],q[30],q[12],q[9],q[10],q[11],q[17],q[29],q[27],q[26],q[25],q[34],q[41],q[42],q[43],q[37];
measure q[0] -> c[0];
measure q[14] -> c[1];
measure q[16] -> c[2];
measure q[2] -> c[3];
