...
rz(pi/2) q[56];
rz(-pi/4) q[57];
barrier q[56],q[57],q[58],q[52],q[38],q[40],q[41],q[43],q[44],q[45],q[54],q[46],q[47],q[35],q[28],q[48],q[49],q[68],q[67],q[66],q[65],q[63],q[62],q[61],q[60],q[53],q[39],q[37],q[42],q[26],q[29],q[34],q[27],q[32],q[36],q[12],q[31],q[17],q[11],q[30],q[10],q[51],q[25],q[24],q[21],q[15],q[4],q[23],q[3],q[2],q[33],q[19],q[5],q[20],q[16],q[13],q[22],q[8],q[18],q[6],q[7],q[0],q[1],q[14],q[9];
measure q[56] -> meas[0];
measure q[57] -> meas[1];
measure q[58] -> meas[2];
measure q[52] -> meas[3];
