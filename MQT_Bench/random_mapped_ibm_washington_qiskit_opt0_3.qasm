...
cx q[1],q[2];
cx q[0],q[1];
rz(5.695888160944528) q[1];
cx q[0],q[1];
rz(1.9003747674411526) q[0];
rz(-0.12579264213698427) q[1];
cx q[0],q[1];
rz(-1.9003747674411526) q[1];
sx q[1];
rz(1.5147684923135878) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
rz(0) q[1];
sx q[1];
rz(4.768416814865999) q[1];
sx q[1];
rz(11.450945370347515) q[1];
rz(2.5432022362570406) q[2];
sx q[2];
rz(5.6180159209007705) q[2];
sx q[2];
rz(8.380289237697308) q[2];
barrier q[0],q[2],q[1];
measure q[0] -> meas[0];
measure q[2] -> meas[1];
measure q[1] -> meas[2];