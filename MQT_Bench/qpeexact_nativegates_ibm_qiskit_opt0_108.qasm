...
rz(pi/2) q[106];
x psi[0];
rz(1.5162309260012306) psi[0];
cx psi[0],q[0];
rz(-1.5162309260012306) q[0];
cx psi[0],q[0];
rz(1.5162309260012306) q[0];
rz(-0.10913080158733215) psi[0];
cx psi[0],q[1];
rz(0.10913080158733215) q[1];
cx psi[0],q[1];
rz(-0.10913080158733215) q[1];
rz(-0.2182616031746643) psi[0];
cx psi[0],q[2];
rz(0.2182616031746643) q[2];
cx psi[0],q[2];
rz(-0.2182616031746643) q[2];
rz(-0.4365232063493286) psi[0];
cx psi[0],q[3];
rz(0.4365232063493286) q[3];
cx psi[0],q[3];
rz(-0.4365232063493286) q[3];
rz(-0.8730464126986572) psi[0];
cx psi[0],q[4];
rz(0.8730464126986572) q[4];
cx psi[0],q[4];
rz(-0.8730464126986572) q[4];
rz(1.3954998281924784) psi[0];
cx psi[0],q[5];
rz(-1.3954998281924784) q[5];
cx psi[0],q[5];
rz(1.3954998281924784) q[5];
