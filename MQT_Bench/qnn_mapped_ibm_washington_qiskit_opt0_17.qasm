...
rz(0) q[8];
sx q[8];
rz(3.652155293154507) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[16];
sx q[16];
rz(3.190556925161184) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[8],q[16];
cx q[7],q[8];
...
rz(0) q[16];
sx q[16];
rz(3.7954034720773286) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.321144204042811) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[12];
sx q[12];
rz(4.118794580170496) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[30];
sx q[30];
rz(3.4021143193281373) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[0];
sx q[0];
rz(3.5436152047310108) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.551435257416738) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.367240269368457) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.779714891299734) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.9595264180566163) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.5984248738922373) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.898555195964663) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.518035410950434) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[29];
sx q[29];
rz(3.22165391442616) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[29],q[17],q[12],q[30],q[28],q[27],q[8],q[6],q[26];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
