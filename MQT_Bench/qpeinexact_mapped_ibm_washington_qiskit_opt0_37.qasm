...
cx q[26],q[25];
cx q[25],q[26];
rz(0.15427208938889952) q[25];
cx q[25],q[24];
rz(-0.15427208938889952) q[24];
cx q[25],q[24];
rz(0.15427208938889952) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[3],q[2];
cx q[2],q[3];
rz(1.2341767151111962) q[2];
cx q[2],q[1];
rz(-1.2341767151111962) q[1];
cx q[2],q[1];
rz(1.2341767151111962) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-0.6732392233674006) q[1];
cx q[1],q[0];
rz(0.6732392233674006) q[0];
cx q[1],q[0];
rz(-0.6732392233674006) q[0];
cx q[1],q[2];
cx q[2],q[1];
...
cx q[18],q[14];
rz(0.37246971005848223) q[14];
cx q[18],q[14];
rz(-0.37246971005848223) q[14];
cx q[14],q[18];
cx q[18],q[14];
cx q[14],q[18];
rz(-0.7449394201169645) q[14];
cx q[21],q[22];
cx q[22],q[21];
cx q[21],q[22];
cx q[15],q[22];
...
cx q[22],q[15];
cx q[15],q[22];
rz(0.16183497312193515) q[15];
cx q[15],q[4];
rz(-0.16183497312193515) q[4];
cx q[15],q[4];
rz(0.16183497312193515) q[4];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[17],q[12];
cx q[12],q[17];
rz(-0.5522330836388308) q[12];
cx q[12],q[11];
rz(0.5522330836388308) q[11];
cx q[12],q[11];
rz(-0.5522330836388308) q[11];
cx q[11],q[12];
cx q[12],q[11];
...
sx q[27];
rz(pi/2) q[27];
barrier q[14],q[15],q[34],q[5],q[21],q[35],q[7],q[8],q[6],q[23],q[33],q[18],q[20],q[19],q[0],q[1],q[2],q[3],q[4],q[22],q[16],q[24],q[36],q[13],q[10],q[25],q[11],q[32],q[31],q[12],q[17],q[30],q[29],q[28],q[26],q[27],q[9];
measure q[14] -> c[0];
measure q[15] -> c[1];
measure q[34] -> c[2];
measure q[5] -> c[3];
