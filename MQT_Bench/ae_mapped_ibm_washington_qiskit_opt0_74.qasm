...
rz(0) q[44];
sx q[44];
rz(-5317260203651847*pi) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[45],q[44];
rz(0) q[44];
sx q[44];
rz(5317260203651850*pi) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[44],q[45];
cx q[45],q[44];
...
rz(0) q[47];
sx q[47];
rz(-10634520407303696*pi) q[47];
sx q[47];
rz(3*pi) q[47];
cx q[48],q[47];
rz(0) q[47];
sx q[47];
rz(10634520407303698*pi) q[47];
sx q[47];
rz(3*pi) q[47];
cx q[46],q[47];
cx q[47],q[46];
...
rz(0) q[63];
sx q[63];
rz(-5444874448539492352*pi) q[63];
sx q[63];
rz(3*pi) q[63];
cx q[64],q[63];
rz(0) q[63];
...
rz(0) q[64];
sx q[64];
rz(-10889748897078984704*pi) q[64];
sx q[64];
rz(3*pi) q[64];
cx q[65],q[64];
rz(0) q[64];
...
rz(0) q[65];
sx q[65];
rz(-21779497794157969408*pi) q[65];
sx q[65];
rz(3*pi) q[65];
cx q[66],q[65];
rz(0) q[65];
...
rz(pi/2) q[55];
rz(-pi/4) q[68];
barrier q[55],q[68],q[49],q[48],q[47],q[28],q[26],q[25],q[24],q[27],q[35],q[46],q[45],q[44],q[43],q[54],q[63],q[61],q[60],q[41],q[39],q[38],q[37],q[56],q[52],q[57],q[59],q[40],q[53],q[62],q[42],q[65],q[66],q[64],q[73],q[69],q[50],q[70],q[67],q[51],q[31],q[30],q[16],q[29],q[32],q[8],q[7],q[6],q[5],q[3],q[4],q[15],q[2],q[0],q[14],q[19],q[21],q[22],q[23],q[17],q[12],q[36],q[11],q[10],q[9],q[13],q[34],q[20],q[1],q[33],q[18],q[58],q[71],q[72];
measure q[55] -> meas[0];
measure q[68] -> meas[1];
measure q[49] -> meas[2];
measure q[48] -> meas[3];
