...
cx q[23],q[24];
cx q[24],q[23];
barrier q[24],q[26],q[22],q[12],q[7],q[5],q[8],q[30],q[16],q[10],q[28],q[21],q[3],q[0],q[14],q[4],q[18],q[19],q[20],q[13],q[27],q[9],q[29],q[17],q[1],q[2],q[6],q[11],q[15],q[25],q[23];
measure q[24] -> meas[0];
measure q[26] -> meas[1];
measure q[22] -> meas[2];
measure q[12] -> meas[3];
