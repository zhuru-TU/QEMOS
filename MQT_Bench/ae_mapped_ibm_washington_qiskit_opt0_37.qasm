...
rz(0) q[30];
sx q[30];
rz(-497837826.2401717) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[17],q[30];
rz(0) q[30];
sx q[30];
rz(497837832.52335703) q[30];
sx q[30];
rz(3*pi) q[30];
rz(0) q[30];
rz(0) q[31];
...
rz(0) q[31];
sx q[31];
rz(-1991351314.3854647) q[31];
sx q[31];
rz(3*pi) q[31];
cx q[32],q[31];
rz(0) q[31];
sx q[31];
rz(1991351320.6686502) q[31];
sx q[31];
rz(3*pi) q[31];
rz(0) q[31];
cx q[32],q[36];
...
rz(pi/2) q[12];
rz(-pi/128) q[32];
barrier q[12],q[11],q[10],q[17],q[30],q[31],q[32],q[29],q[28],q[26],q[8],q[7],q[6],q[4],q[3],q[2],q[15],q[23],q[34],q[43],q[45],q[47],q[35],q[9],q[27],q[13],q[25],q[22],q[21],q[1],q[20],q[14],q[18],q[19],q[16],q[0],q[42];
measure q[12] -> meas[0];
measure q[11] -> meas[1];
measure q[10] -> meas[2];
measure q[17] -> meas[3];
