...
rz(0) q[27];
sx q[27];
rz(5.147412157444096) q[27];
sx q[27];
rz(3*pi) q[27];
rz(5.553936700858894) q[27];
cx q[27],q[28];
cx q[28],q[27];
cx q[27],q[28];
rz(0) q[29];
...
barrier q[10],q[11],q[12],q[17],q[29],q[27],q[16],q[7],q[5],q[4],q[3],q[2],q[0],q[1];
measure q[10] -> meas[0];
measure q[11] -> meas[1];
measure q[12] -> meas[2];
measure q[17] -> meas[3];
