...
rz(pi/2) q[0];
sx q[0];
rz(-0.6447210345024015) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(pi/2) q[1];
sx q[1];
rz(-0.6447210345024015) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[3],q[4];
cx q[4],q[3];
...
rz(pi/2) q[5];
cx q[4],q[5];
rz(1.8517050703329434) q[5];
cx q[4],q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(1.8517050703329434) q[4];
cx q[3],q[4];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
...
cx q[1],q[2];
cx q[0],q[1];
rz(0.6450643607117813) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(10.71393537735216) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(pi/2) q[5];
sx q[5];
rz(-0.6447210345024015) q[5];
sx q[5];
rz(5*pi/2) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
rz(5*pi/2) q[5];
cx q[4],q[5];
rz(0.6450643607117813) q[5];
cx q[4],q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(0.6450643607117813) q[4];
cx q[3],q[4];
rz(pi/2) q[3];
sx q[3];
rz(10.71393537735216) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[4];
sx q[4];
rz(10.71393537735216) q[4];
sx q[4];
rz(5*pi/2) q[4];
rz(pi/2) q[5];
sx q[5];
rz(10.71393537735216) q[5];
sx q[5];
rz(5*pi/2) q[5];
barrier q[0],q[5],q[1],q[3],q[2],q[4];
measure q[0] -> meas[0];
measure q[5] -> meas[1];
measure q[1] -> meas[2];
measure q[3] -> meas[3];
