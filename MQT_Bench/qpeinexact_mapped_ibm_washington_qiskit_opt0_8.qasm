...
cx q[5],q[4];
cx q[4],q[5];
rz(1.337631247036279) q[4];
cx q[4],q[3];
rz(-1.337631247036279) q[3];
cx q[4],q[3];
rz(1.337631247036279) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-0.9326603190344698) q[1];
cx q[1],q[0];
rz(0.9326603190344698) q[0];
cx q[1],q[0];
rz(-0.9326603190344698) q[0];
rz(1.2762720155208536) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
...
rz(pi/2) q[3];
rz(-pi/4) q[4];
barrier q[6],q[5],q[0],q[1],q[2],q[4],q[3],q[7];
measure q[6] -> c[0];
measure q[5] -> c[1];
measure q[0] -> c[2];
measure q[1] -> c[3];
