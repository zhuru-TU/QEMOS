...
rz(pi/2) q[16];
rz(-pi/8589934592) q[62];
barrier q[0],q[2],q[1],q[14],q[65],q[3],q[51],q[54],q[50],q[55],q[49],q[48],q[68],q[67],q[31],q[6],q[42],q[59],q[19],q[18],q[46],q[63],q[40],q[33],q[37],q[38],q[4],q[52],q[56],q[58],q[62],q[60],q[61],q[53],q[15],q[35],q[28],q[9],q[26],q[27],q[13],q[10],q[30],q[11],q[12],q[17],q[29],q[47],q[34],q[45],q[44],q[43],q[41],q[39],q[20],q[21],q[22],q[23],q[24],q[25],q[7],q[8],q[16],q[57];
measure q[0] -> c[0];
measure q[2] -> c[1];
measure q[1] -> c[2];
measure q[14] -> c[3];
