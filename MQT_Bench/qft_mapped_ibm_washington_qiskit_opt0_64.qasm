...
cx q[51],q[50];
cx q[50],q[51];
barrier q[39],q[40],q[57],q[38],q[42],q[46],q[35],q[45],q[54],q[64],q[50],q[49],q[55],q[48],q[67],q[68],q[27],q[24],q[44],q[59],q[58],q[65],q[22],q[14],q[15],q[4],q[2],q[5],q[7],q[16],q[34],q[6],q[11],q[61],q[10],q[8],q[18],q[3],q[23],q[1],q[0],q[21],q[41],q[66],q[53],q[60],q[25],q[26],q[12],q[62],q[63],q[32],q[36],q[51],q[17],q[30],q[29],q[28],q[47],q[43],q[19],q[56],q[20],q[33];
measure q[39] -> meas[0];
measure q[40] -> meas[1];
measure q[57] -> meas[2];
measure q[38] -> meas[3];
