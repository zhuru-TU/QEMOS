...
cx q[19],q[18];
cx q[18],q[19];
rz(-1.3464815971288848) q[18];
cx q[18],q[14];
rz(1.3464815971288848) q[14];
cx q[18],q[14];
rz(-1.3464815971288848) q[14];
cx q[14],q[18];
cx q[18],q[14];
cx q[14],q[18];
rz(0.44862945933202325) q[14];
cx q[14],q[0];
rz(-0.44862945933202325) q[0];
cx q[14],q[0];
rz(0.44862945933202325) q[0];
cx q[0],q[14];
cx q[14],q[0];
cx q[0],q[14];
rz(0.8972589186640465) q[0];
cx q[0],q[1];
rz(-0.8972589186640465) q[1];
cx q[0],q[1];
rz(0.8972589186640465) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(-1.3470748162617001) q[1];
cx q[1],q[2];
rz(1.3470748162617001) q[2];
cx q[1],q[2];
rz(-1.3470748162617001) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(0.44744302106639294) q[2];
cx q[2],q[3];
rz(-0.44744302106639294) q[3];
cx q[2],q[3];
rz(0.44744302106639294) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.8948860421327859) q[3];
cx q[3],q[4];
rz(-0.8948860421327859) q[4];
cx q[3],q[4];
rz(0.8948860421327859) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3518205693242213) q[4];
cx q[4],q[5];
rz(1.3518205693242213) q[5];
cx q[4],q[5];
rz(-1.3518205693242213) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[4],q[15];
rz(0.43795151494135054) q[5];
cx q[5],q[6];
rz(-0.43795151494135054) q[6];
cx q[5],q[6];
rz(0.43795151494135054) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(0.8759030298827011) q[6];
cx q[6],q[7];
rz(-0.8759030298827011) q[7];
cx q[6],q[7];
rz(0.8759030298827011) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.3620194659410113) q[17];
cx q[17],q[12];
rz(-0.3620194659410113) q[12];
cx q[17],q[12];
rz(0.3620194659410113) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.7240389318820226) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4480778637640452) q[11];
cx q[11],q[10];
rz(-1.4480778637640452) q[10];
cx q[11],q[10];
rz(1.4480778637640452) q[10];
cx q[10],q[11];
cx q[11],q[10];
cx q[10],q[11];
rz(-0.2454369260617026) q[10];
cx q[17],q[30];
cx q[30],q[17];
cx q[17],q[30];
cx q[12],q[17];
...
cx q[29],q[30];
cx q[17],q[30];
rz(-0.4908738521234052) q[29];
cx q[29],q[28];
rz(0.4908738521234052) q[28];
cx q[29],q[28];
rz(-0.4908738521234052) q[28];
cx q[27],q[28];
cx q[28],q[27];
