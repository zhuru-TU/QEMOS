...
cx q[46],q[45];
cx q[45],q[46];
barrier q[20],q[33],q[39],q[21],q[38],q[45],q[27],q[29],q[26],q[25],q[44],q[49],q[41],q[51],q[35],q[8],q[23],q[42],q[10],q[31],q[6],q[37],q[9],q[3],q[0],q[36],q[1],q[2],q[34],q[32],q[48],q[16],q[11],q[5],q[4],q[7],q[24],q[50],q[40],q[47],q[43],q[12],q[17],q[30],q[28],q[46],q[15],q[22],q[14],q[18],q[19];
measure q[20] -> meas[0];
measure q[33] -> meas[1];
measure q[39] -> meas[2];
measure q[21] -> meas[3];
