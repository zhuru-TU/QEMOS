...
cx q[66],q[65];
cx q[65],q[66];
barrier q[25],q[43],q[26],q[28],q[45],q[31],q[32],q[49],q[50],q[48],q[13],q[65],q[47],q[67],q[41],q[46],q[15],q[40],q[2],q[7],q[1],q[21],q[54],q[64],q[70],q[61],q[51],q[63],q[69],q[58],q[18],q[33],q[37],q[38],q[0],q[56],q[19],q[14],q[52],q[53],q[20],q[57],q[59],q[62],q[9],q[60],q[55],q[39],q[8],q[3],q[6],q[4],q[5],q[16],q[22],q[29],q[34],q[68],q[11],q[66],q[10],q[12],q[17],q[35],q[36],q[30],q[44],q[27],q[23],q[42],q[24];
measure q[25] -> meas[0];
measure q[43] -> meas[1];
measure q[26] -> meas[2];
measure q[28] -> meas[3];
