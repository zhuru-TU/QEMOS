...
rz(0) q[19];
sx q[19];
rz(3.4012274219713885) q[19];
sx q[19];
rz(3*pi) q[19];
rz(0) q[20];
sx q[20];
rz(3.4810254122273836) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[19],q[20];
cx q[18],q[19];
...
rz(0) q[20];
sx q[20];
rz(3.9152709130300614) q[20];
sx q[20];
rz(3*pi) q[20];
rz(0) q[21];
sx q[21];
rz(3.390898295589571) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[20],q[21];
cx q[21],q[20];
...
rz(0) q[22];
sx q[22];
rz(3.764090590020313) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[22],q[21];
rz(0) q[21];
sx q[21];
rz(3.6400395361060363) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[24];
sx q[24];
rz(3.7190915311380923) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[24],q[23];
rz(0) q[23];
sx q[23];
rz(3.9506588402051586) q[23];
sx q[23];
rz(3*pi) q[23];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[25];
sx q[25];
rz(4.093153037918625) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[25],q[24];
rz(0) q[24];
sx q[24];
rz(3.206619901560176) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(0) q[27];
sx q[27];
rz(3.7531792967914535) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(3.877056400523142) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[29];
sx q[29];
rz(3.77972792438291) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[29],q[28];
rz(0) q[28];
sx q[28];
rz(3.279230512074489) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[27];
sx q[27];
rz(3.8114152805638777) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(4.119959224276625) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[30],q[17];
cx q[17],q[30];
...
rz(0) q[1];
sx q[1];
rz(3.6900700899548324) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.1580895581700448) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.9120401228950556) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[7];
sx q[7];
rz(3.2178532864142726) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[27];
sx q[27];
rz(3.893174824897789) q[27];
sx q[27];
rz(3*pi) q[27];
barrier q[1],q[2],q[4],q[7],q[27],q[3],q[21],q[20],q[24],q[28],q[30],q[12],q[10],q[11],q[17],q[29],q[25],q[23],q[22],q[15],q[18],q[14],q[19];
measure q[1] -> meas[0];
measure q[2] -> meas[1];
measure q[4] -> meas[2];
measure q[7] -> meas[3];
