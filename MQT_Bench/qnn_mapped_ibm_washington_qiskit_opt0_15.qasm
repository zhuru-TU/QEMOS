...
rz(0) q[28];
sx q[28];
rz(4.091345435562172) q[28];
sx q[28];
rz(3*pi) q[28];
rz(0) q[29];
sx q[29];
rz(3.4448470226780175) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[28],q[29];
cx q[27],q[28];
...
rz(0) q[11];
sx q[11];
rz(3.581107469797686) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[17];
sx q[17];
rz(3.853469527650844) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[0];
sx q[0];
rz(4.100582676605806) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.2549995724028697) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.4096682356745664) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.346045920324792) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.3381950937955276) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6968790339748088) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.802258293514221) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.7429079463828367) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.8558618371667643) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[29],q[11],q[12],q[17],q[28],q[26],q[30];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
