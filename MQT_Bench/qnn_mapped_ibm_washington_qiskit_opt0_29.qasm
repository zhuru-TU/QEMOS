...
rz(0) q[0];
sx q[0];
rz(3.578102849140152) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[14];
sx q[14];
rz(3.2060223243607333) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[18];
sx q[18];
rz(3.9244300488979587) q[18];
sx q[18];
rz(3*pi) q[18];
rz(0) q[20];
sx q[20];
rz(3.930978243278823) q[20];
sx q[20];
rz(3*pi) q[20];
rz(0) q[21];
sx q[21];
rz(3.393583897176795) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[4];
sx q[4];
rz(3.399406214615298) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[15];
sx q[15];
rz(3.5007811407235105) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[15],q[4];
rz(0) q[4];
sx q[4];
rz(3.608238650755279) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(0) q[1];
sx q[1];
rz(4.136957679386354) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.767343369621372) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.977618536679737) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(3.6965263868751825) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[15];
sx q[15];
rz(3.31881664223941) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[18],q[14];
rz(0) q[14];
sx q[14];
rz(3.207200280566214) q[14];
sx q[14];
rz(3*pi) q[14];
cx q[18],q[19];
cx q[19],q[18];
...
rz(0) q[10];
sx q[10];
rz(3.9554159736837526) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.697092014982268) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
rz(0) q[6];
sx q[6];
rz(4.01912905252014) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.8282802547805366) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[15],q[4];
cx q[4],q[15];
...
rz(0) q[21];
sx q[21];
rz(4.126446403718068) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(4.010957338864948) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[27];
sx q[27];
rz(3.4804266223740066) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.244909896524071) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[21],q[22],q[6],q[7],q[16],q[25],q[24],q[27],q[29],q[17],q[10],q[11],q[12],q[30],q[28],q[8],q[26],q[23],q[20],q[19],q[18],q[14],q[0],q[1],q[2],q[5],q[4],q[15],q[3];
measure q[21] -> meas[0];
measure q[22] -> meas[1];
measure q[6] -> meas[2];
measure q[7] -> meas[3];
