...
sx q[80];
rz(pi/2) q[80];
barrier q[39],q[15],q[18],q[4],q[14],q[22],q[33],q[29],q[61],q[30],q[24],q[7],q[32],q[44],q[19],q[20],q[9],q[5],q[0],q[38],q[1],q[40],q[3],q[21],q[13],q[31],q[6],q[8],q[23],q[25],q[36],q[26],q[46],q[34],q[47],q[51],q[12],q[52],q[76],q[90],q[91],q[56],q[74],q[37],q[28],q[43],q[10],q[48],q[68],q[73],q[89],q[87],q[50],q[49],q[16],q[92],q[77],q[2],q[58],q[94],q[53],q[54],q[66],q[41],q[63],q[103],q[67],q[57],q[69],q[64],q[45],q[86],q[42],q[27],q[97],q[102],q[88],q[85],q[75],q[83],q[81],q[80],q[82],q[35],q[55],q[84],q[79],q[11],q[70],q[62],q[72],q[71],q[17],q[65],q[60],q[59],q[78];
measure q[39] -> meas[0];
measure q[15] -> meas[1];
measure q[18] -> meas[2];
measure q[4] -> meas[3];
