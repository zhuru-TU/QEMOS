...
rz(0) q[0];
sx q[0];
rz(3.0486252999403423) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.1199325335534036) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(5.381888823316668) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.1541376673033414) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.1766747222605574) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.2688689306057115) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(3.025717620679287) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(5.066323970142588) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(1.617840186349667) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[9];
sx q[9];
rz(1.6061459854083804) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[10];
sx q[10];
rz(4.72885223452227) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[11];
sx q[11];
rz(4.735110661637681) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[9],q[10];
...
rz(0) q[9];
sx q[9];
rz(1.5437041399657332) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(1.287085291551496) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[0];
sx q[0];
rz(3.3610214528937212) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(0.0673314067355455) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.8256543978912552) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(2.3455041550264752) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(0.6553682232833267) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.8159113869854284) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[11];
sx q[11];
rz(4.567088427820489) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[11],q[10];
rz(0) q[10];
sx q[10];
rz(1.4823850912922876) q[10];
sx q[10];
rz(3*pi) q[10];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[0];
sx q[0];
rz(3.1746193795454767) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.015917107622953) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.486322588705541) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(4.718831673184454) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(4.656373889756024) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.62765996302455) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[0];
sx q[0];
rz(3.3486345626095426) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.0368262651260722) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.5713996224667603) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.334679003098299) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(2.374389319348045) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.0196354898958568) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.8560829453511416) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(5.139209410517837) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.7579193829523536) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(1.461071084964888) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[29],q[12],q[10];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
