...
cx q[46],q[45];
cx q[45],q[46];
barrier q[21],q[20],q[19],q[5],q[14],q[2],q[4],q[45],q[42],q[41],q[39],q[62],q[24],q[40],q[54],q[52],q[61],q[38],q[53],q[57],q[26],q[66],q[28],q[30],q[55],q[47],q[64],q[32],q[51],q[29],q[10],q[11],q[9],q[16],q[8],q[12],q[36],q[31],q[35],q[48],q[50],q[17],q[27],q[58],q[59],q[1],q[65],q[33],q[60],q[56],q[44],q[23],q[25],q[63],q[37],q[43],q[34],q[46],q[7],q[3],q[0],q[6],q[18],q[15],q[22];
measure q[21] -> meas[0];
measure q[20] -> meas[1];
measure q[19] -> meas[2];
measure q[5] -> meas[3];
