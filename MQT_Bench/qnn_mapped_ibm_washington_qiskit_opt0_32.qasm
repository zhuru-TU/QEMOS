...
rz(0) q[1];
sx q[1];
rz(4.103175685361207) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[3];
sx q[3];
rz(3.835943194772341) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
rz(0) q[24];
sx q[24];
rz(3.8472198659362533) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.1710591060257567) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[25],q[24];
rz(0) q[24];
sx q[24];
rz(3.970287936317816) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(0) q[0];
sx q[0];
rz(3.5924643476255236) q[0];
sx q[0];
rz(3*pi) q[0];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(4.013070611378162) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[2],q[3];
cx q[3],q[2];
...
rz(0) q[5];
sx q[5];
rz(3.223352824197902) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[7],q[6];
rz(0) q[6];
sx q[6];
rz(3.2983807961563527) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[7],q[8];
cx q[8],q[7];
...
rz(0) q[18];
sx q[18];
rz(3.789201570377159) q[18];
sx q[18];
rz(3*pi) q[18];
rz(0) q[20];
sx q[20];
rz(3.586721932085337) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
rz(0) q[25];
sx q[25];
rz(3.168236476669192) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(3.769908834481506) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(4.049252972268707) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[29];
sx q[29];
rz(3.3193527811366557) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[29],q[28];
rz(0) q[28];
sx q[28];
rz(3.4635915833085336) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[30];
sx q[30];
rz(4.064558745764538) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[30],q[29];
rz(0) q[29];
sx q[29];
rz(3.678258608022511) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0) q[31];
sx q[31];
rz(3.705398241701611) q[31];
sx q[31];
rz(3*pi) q[31];
cx q[31],q[30];
cx q[30],q[31];
...
rz(0) q[10];
sx q[10];
rz(3.867352957506749) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.583143288411788) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
rz(0) q[13];
sx q[13];
rz(3.4514978093737745) q[13];
sx q[13];
rz(3*pi) q[13];
rz(0) q[17];
sx q[17];
rz(3.605299064255371) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[3];
sx q[3];
rz(4.027275537499801) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.189039645669572) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[22];
sx q[22];
rz(3.4730474097308504) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[29];
sx q[29];
rz(4.112854750071792) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0) q[31];
sx q[31];
rz(3.158083844494298) q[31];
sx q[31];
rz(3*pi) q[31];
barrier q[3],q[4],q[22],q[7],q[25],q[24],q[29],q[10],q[11],q[9],q[13],q[12],q[17],q[31],q[30],q[28],q[16],q[8],q[6],q[5],q[2],q[1],q[0],q[14],q[18],q[19],q[20],q[15],q[21],q[26],q[27],q[23];
measure q[3] -> meas[0];
measure q[4] -> meas[1];
measure q[22] -> meas[2];
measure q[7] -> meas[3];
