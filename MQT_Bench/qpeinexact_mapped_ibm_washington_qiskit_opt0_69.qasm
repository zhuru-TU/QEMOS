...
cx q[26],q[16];
cx q[16],q[26];
rz(1.2794710469121264) q[16];
cx q[16],q[8];
rz(-1.2794710469121264) q[8];
cx q[16],q[8];
rz(1.2794710469121264) q[8];
cx q[8],q[16];
cx q[16],q[8];
...
cx q[3],q[2];
cx q[2],q[3];
rz(0.8109904145276321) q[2];
cx q[2],q[1];
rz(-0.8109904145276321) q[1];
cx q[2],q[1];
rz(0.8109904145276321) q[1];
cx q[1],q[2];
cx q[2],q[1];
...
sx q[47];
rz(pi/2) q[47];
barrier q[55],q[16],q[7],q[8],q[0],q[59],q[57],q[58],q[1],q[68],q[56],q[52],q[37],q[23],q[21],q[53],q[62],q[14],q[61],q[18],q[38],q[19],q[20],q[33],q[60],q[24],q[66],q[65],q[63],q[41],q[64],q[43],q[54],q[44],q[34],q[42],q[40],q[39],q[22],q[2],q[3],q[6],q[15],q[4],q[5],q[25],q[45],q[13],q[9],q[10],q[11],q[12],q[29],q[17],q[26],q[27],q[30],q[31],q[32],q[36],q[51],q[50],q[49],q[46],q[28],q[48],q[35],q[47],q[67];
measure q[55] -> c[0];
measure q[16] -> c[1];
measure q[7] -> c[2];
measure q[8] -> c[3];
