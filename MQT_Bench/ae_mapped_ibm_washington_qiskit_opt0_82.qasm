...
rz(0) q[40];
sx q[40];
rz(-1019571874570.7118) q[40];
sx q[40];
rz(3*pi) q[40];
cx q[39],q[40];
rz(0) q[40];
sx q[40];
rz(1019571874576.995) q[40];
sx q[40];
rz(3*pi) q[40];
cx q[40],q[41];
cx q[41],q[40];
...
rz(pi/2) q[63];
rz(-pi/4) q[64];
barrier q[63],q[64],q[65],q[72],q[81],q[83],q[85],q[86],q[88],q[74],q[69],q[68],q[55],q[49],q[70],q[89],q[48],q[47],q[46],q[45],q[44],q[43],q[54],q[62],q[61],q[59],q[58],q[71],q[77],q[60],q[57],q[53],q[41],q[78],q[79],q[56],q[40],q[20],q[21],q[22],q[24],q[33],q[25],q[27],q[26],q[28],q[29],q[35],q[17],q[11],q[12],q[10],q[13],q[9],q[30],q[42],q[31],q[16],q[15],q[50],q[4],q[39],q[19],q[23],q[18],q[66],q[14],q[5],q[34],q[52],q[51],q[84],q[87],q[32],q[8],q[6],q[3],q[2],q[0],q[1],q[7],q[75];
measure q[63] -> meas[0];
measure q[64] -> meas[1];
measure q[65] -> meas[2];
measure q[72] -> meas[3];
