...
sx q[29];
rz(3*pi) q[29];
barrier q[20],q[1],q[18],q[0],q[14],q[19],q[21],q[3],q[24],q[26],q[28],q[30],q[11],q[12],q[17],q[29],q[27],q[16],q[8],q[7],q[6],q[5],q[4],q[15],q[23],q[22];
measure q[20] -> meas[0];
measure q[1] -> meas[1];
measure q[18] -> meas[2];
measure q[0] -> meas[3];
