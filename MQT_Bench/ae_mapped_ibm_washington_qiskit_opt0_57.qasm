...
sx q[43];
rz(pi/2) q[43];
barrier q[43],q[42],q[41],q[44],q[45],q[54],q[64],q[63],q[61],q[60],q[53],q[39],q[33],q[21],q[22],q[23],q[24],q[25],q[26],q[8],q[16],q[15],q[34],q[27],q[28],q[31],q[30],q[32],q[29],q[35],q[48],q[47],q[49],q[50],q[46],q[65],q[4],q[3],q[20],q[2],q[1],q[40],q[6],q[5],q[17],q[11],q[12],q[10],q[9],q[7],q[13],q[38],q[19],q[0],q[14],q[37],q[68];
measure q[43] -> meas[0];
measure q[42] -> meas[1];
measure q[41] -> meas[2];
measure q[44] -> meas[3];
