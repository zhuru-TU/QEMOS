...
cx q[26],q[25];
cx q[25],q[26];
rz(1.3472186269605644) q[25];
cx q[25],q[24];
rz(-1.3472186269605644) q[24];
cx q[25],q[24];
rz(1.3472186269605644) q[24];
cx q[24],q[25];
cx q[25],q[24];
...
cx q[3],q[2];
rz(-1.3529710549151355) q[2];
cx q[3],q[2];
rz(1.3529710549151355) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-0.4356505437595221) q[2];
cx q[2],q[1];
rz(0.4356505437595221) q[1];
cx q[2],q[1];
rz(-0.4356505437595221) q[1];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-0.8713010875190442) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(0.8713010875190442) q[4];
cx q[3],q[4];
rz(-0.8713010875190442) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(pi/2) q[24];
rz(-pi/4) q[25];
barrier q[28],q[27],q[16],q[7],q[5],q[2],q[3],q[4],q[22],q[26],q[25],q[24],q[11];
measure q[28] -> c[0];
measure q[27] -> c[1];
measure q[16] -> c[2];
measure q[7] -> c[3];
