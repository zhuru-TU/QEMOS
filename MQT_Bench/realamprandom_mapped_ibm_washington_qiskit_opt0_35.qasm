...
sx q[21];
rz(3*pi) q[21];
barrier q[9],q[10],q[13],q[11],q[12],q[31],q[32],q[17],q[30],q[1],q[29],q[34],q[23],q[28],q[8],q[24],q[27],q[25],q[26],q[16],q[7],q[6],q[3],q[5],q[4],q[15],q[2],q[33],q[22],q[21],q[20],q[19],q[18],q[0],q[14];
measure q[9] -> meas[0];
measure q[10] -> meas[1];
measure q[13] -> meas[2];
measure q[11] -> meas[3];
