...
rz(pi/2) q[87];
rz(-pi/4) q[88];
barrier q[87],q[88],q[86],q[85],q[84],q[83],q[82],q[81],q[72],q[62],q[63],q[64],q[65],q[66],q[67],q[68],q[55],q[49],q[48],q[47],q[35],q[29],q[30],q[28],q[46],q[45],q[44],q[34],q[24],q[42],q[53],q[60],q[58],q[56],q[52],q[38],q[39],q[37],q[43],q[59],q[41],q[57],q[40],q[33],q[21],q[26],q[20],q[19],q[15],q[22],q[4],q[7],q[8],q[25],q[27],q[16],q[31],q[6],q[23],q[32],q[36],q[12],q[11],q[54],q[10],q[13],q[9],q[17],q[5],q[3],q[69],q[18],q[14],q[0],q[1],q[73],q[71];
measure q[87] -> meas[0];
measure q[88] -> meas[1];
measure q[86] -> meas[2];
measure q[85] -> meas[3];
