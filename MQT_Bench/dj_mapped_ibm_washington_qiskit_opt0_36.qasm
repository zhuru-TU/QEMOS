...
sx q[34];
rz(pi/2) q[34];
barrier q[33],q[15],q[2],q[1],q[7],q[3],q[4],q[5],q[6],q[30],q[11],q[13],q[9],q[10],q[16],q[21],q[8],q[12],q[23],q[20],q[18],q[14],q[0],q[19],q[22],q[26],q[35],q[27],q[28],q[29],q[17],q[31],q[32],q[34],q[24],q[25];
measure q[33] -> c[0];
measure q[15] -> c[1];
measure q[2] -> c[2];
measure q[1] -> c[3];
