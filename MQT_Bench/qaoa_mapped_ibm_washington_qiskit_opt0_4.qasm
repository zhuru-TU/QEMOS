...
rz(pi/2) q[3];
cx q[2],q[3];
rz(0.9045524589178571) q[3];
cx q[2],q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
cx q[1],q[2];
rz(0.9045524589178571) q[2];
cx q[1],q[2];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
...
cx q[2],q[3];
cx q[1],q[2];
rz(-5.1646812557223685) q[2];
cx q[1],q[2];
cx q[1],q[0];
rz(-5.1646812557223685) q[0];
cx q[1],q[0];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
...
rz(pi/2) q[1];
sx q[1];
rz(8.520218483642147) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(8.520218483642147) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(pi/2) q[3];
sx q[3];
rz(8.520218483642147) q[3];
sx q[3];
rz(5*pi/2) q[3];
