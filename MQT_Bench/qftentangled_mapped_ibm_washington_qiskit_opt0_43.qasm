...
cx q[26],q[25];
cx q[25],q[26];
barrier q[20],q[33],q[21],q[41],q[39],q[40],q[25],q[23],q[3],q[34],q[5],q[7],q[35],q[47],q[30],q[17],q[12],q[11],q[10],q[44],q[9],q[13],q[8],q[16],q[28],q[42],q[1],q[0],q[29],q[14],q[27],q[6],q[2],q[43],q[4],q[24],q[26],q[38],q[15],q[37],q[22],q[18],q[19];
measure q[20] -> meas[0];
measure q[33] -> meas[1];
measure q[21] -> meas[2];
measure q[41] -> meas[3];
