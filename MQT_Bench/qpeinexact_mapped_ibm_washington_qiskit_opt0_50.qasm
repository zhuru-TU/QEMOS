...
cx q[43],q[34];
cx q[34],q[43];
rz(0.10236411273390686) q[34];
cx q[34],q[24];
rz(-0.10236411273390686) q[24];
cx q[34],q[24];
rz(0.10236411273390686) q[24];
cx q[24],q[34];
cx q[34],q[24];
...
cx q[22],q[15];
cx q[15],q[22];
rz(0.20472822546781372) q[15];
cx q[15],q[4];
rz(-0.20472822546781372) q[4];
cx q[15],q[4];
rz(0.20472822546781372) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.40945645093562744) q[4];
cx q[4],q[3];
rz(-0.40945645093562744) q[3];
cx q[4],q[3];
rz(0.40945645093562744) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(-0.8189129018712549) q[2];
cx q[3],q[2];
rz(0.8189129018712549) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-1.5037668498472834) q[2];
cx q[2],q[1];
rz(1.5037668498472834) q[1];
cx q[2],q[1];
rz(-1.5037668498472834) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.13405895389522618) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.13405895389522618) q[4];
cx q[3],q[4];
rz(0.13405895389522618) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.26811790779045236) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.26811790779045236) q[5];
cx q[4],q[5];
rz(0.26811790779045236) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.5362358155809047) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.5362358155809047) q[6];
cx q[5],q[6];
rz(0.5362358155809047) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.0724716311618094) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-1.0724716311618094) q[7];
cx q[6],q[7];
rz(1.0724716311618094) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-0.9966493912661744) q[28];
cx q[28],q[29];
rz(0.9966493912661744) q[29];
cx q[28],q[29];
rz(-0.9966493912661744) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.1482938710574444) q[17];
cx q[17],q[12];
rz(-1.1482938710574444) q[12];
cx q[17],q[12];
rz(1.1482938710574444) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8450049114749044) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4515828306399843) q[11];
cx q[11],q[10];
rz(-1.4515828306399843) q[10];
cx q[11],q[10];
rz(1.4515828306399843) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.23842699230982461) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.23842699230982461) q[12];
cx q[11],q[12];
rz(-0.23842699230982461) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[25],q[26];
cx q[16],q[26];
rz(-0.47685398461964923) q[25];
cx q[25],q[24];
rz(0.47685398461964923) q[24];
cx q[25],q[24];
rz(-0.47685398461964923) q[24];
cx q[24],q[25];
cx q[25],q[24];
