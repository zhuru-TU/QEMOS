...
cx q[24],q[34];
cx q[34],q[24];
barrier q[34],q[23],q[30],q[27],q[45],q[43],q[50],q[29],q[31],q[11],q[47],q[28],q[7],q[6],q[21],q[15],q[20],q[3],q[1],q[2],q[4],q[5],q[26],q[46],q[8],q[48],q[35],q[10],q[32],q[12],q[49],q[25],q[44],q[16],q[17],q[22],q[24];
measure q[34] -> meas[0];
measure q[23] -> meas[1];
measure q[30] -> meas[2];
measure q[27] -> meas[3];
