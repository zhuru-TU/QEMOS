...
cx q[33],q[20];
cx q[20],q[33];
rz(0.10518693529520835) q[20];
cx q[20],q[19];
rz(-0.10518693529520835) q[19];
cx q[20],q[19];
rz(0.10518693529520835) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(0.2103738705904167) q[18];
cx q[18],q[14];
rz(-0.2103738705904167) q[14];
cx q[18],q[14];
rz(0.2103738705904167) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(0.4207477411808334) q[0];
cx q[0],q[1];
rz(-0.4207477411808334) q[1];
cx q[0],q[1];
rz(0.4207477411808334) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(0.8414954823616668) q[1];
cx q[1],q[2];
rz(-0.8414954823616668) q[2];
cx q[1],q[2];
rz(0.8414954823616668) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-1.4586016888664595) q[2];
cx q[2],q[3];
rz(1.4586016888664595) q[3];
cx q[2],q[3];
rz(-1.4586016888664595) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[17],q[12];
rz(-0.6473398924877406) q[12];
cx q[17],q[12];
rz(0.6473398924877406) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(1.2946797849754812) q[12];
cx q[30],q[29];
cx q[29],q[30];
cx q[30],q[29];
cx q[30],q[31];
...
rz(pi/2) q[34];
rz(-pi/4) q[43];
barrier q[14],q[5],q[6],q[33],q[2],q[21],q[19],q[15],q[32],q[46],q[31],q[47],q[26],q[44],q[41],q[22],q[4],q[3],q[1],q[0],q[18],q[20],q[23],q[24],q[13],q[35],q[9],q[10],q[12],q[11],q[17],q[30],q[29],q[28],q[27],q[25],q[42],q[43],q[34],q[38];
measure q[14] -> c[0];
measure q[5] -> c[1];
measure q[6] -> c[2];
measure q[33] -> c[3];
