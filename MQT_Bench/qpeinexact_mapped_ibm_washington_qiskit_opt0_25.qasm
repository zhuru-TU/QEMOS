...
sx q[1];
rz(pi/2) q[1];
barrier q[14],q[15],q[19],q[20],q[22],q[21],q[23],q[24],q[25],q[26],q[28],q[12],q[17],q[30],q[29],q[27],q[16],q[7],q[5],q[4],q[3],q[2],q[0],q[1],q[18];
measure q[14] -> c[0];
measure q[15] -> c[1];
measure q[19] -> c[2];
measure q[20] -> c[3];
