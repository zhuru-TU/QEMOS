...
rz(0) q[21];
sx q[21];
rz(3.6765528396588647) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[24];
sx q[24];
rz(3.855921009750011) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(0) q[8];
sx q[8];
rz(3.7653089855882422) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[16];
sx q[16];
rz(3.822065349958926) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[8],q[16];
cx q[7],q[8];
...
rz(0) q[16];
sx q[16];
rz(3.443895062461677) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[26];
sx q[26];
rz(3.7025340003371214) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[16],q[26];
cx q[26],q[16];
...
rz(0) q[26];
sx q[26];
rz(3.5224604781776248) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.8710160144549843) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[25];
sx q[25];
rz(3.8779659445821633) q[25];
sx q[25];
rz(3*pi) q[25];
rz(0) q[26];
sx q[26];
rz(3.4995328338769007) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[28];
sx q[28];
rz(3.334797289219272) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[10];
sx q[10];
rz(3.428193394657953) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.882478640464802) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
rz(0) q[1];
sx q[1];
rz(3.8105177947585513) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.811712923419586) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.9957143588268407) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.119324439995983) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.8341341186428486) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(4.055419677592905) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[14];
sx q[14];
rz(3.312548829370702) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[16];
sx q[16];
rz(4.095413149489107) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[28];
sx q[28];
rz(3.311002191878791) q[28];
sx q[28];
rz(3*pi) q[28];
barrier q[14],q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[28],q[25],q[11],q[10],q[12],q[17],q[29],q[23],q[3],q[19],q[20],q[21],q[24],q[27],q[22],q[30],q[8],q[6],q[26];
measure q[14] -> meas[0];
measure q[0] -> meas[1];
measure q[1] -> meas[2];
measure q[2] -> meas[3];
