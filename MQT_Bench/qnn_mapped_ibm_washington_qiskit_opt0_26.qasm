...
rz(0) q[11];
sx q[11];
rz(3.7814911614239364) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[30];
sx q[30];
rz(3.7882254019168804) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[0];
sx q[0];
rz(3.9852788049851298) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.68278958205435) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[1],q[0];
rz(0) q[0];
sx q[0];
rz(3.8817428950241104) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[2];
sx q[2];
rz(3.9710185152366844) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[2],q[1];
cx q[1],q[2];
...
rz(0) q[2];
sx q[2];
rz(3.895025850842197) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[14];
sx q[14];
rz(4.13170473643409) q[14];
sx q[14];
rz(3*pi) q[14];
cx q[0],q[14];
cx q[14],q[0];
...
rz(0) q[1];
sx q[1];
rz(3.9554815541178034) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[18];
sx q[18];
rz(3.501311650449121) q[18];
sx q[18];
rz(3*pi) q[18];
cx q[14],q[18];
cx q[18],q[14];
...
rz(0) q[21];
sx q[21];
rz(3.146325555160336) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[21],q[20];
rz(0) q[20];
sx q[20];
rz(4.031308136976277) q[20];
sx q[20];
rz(3*pi) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
rz(0) q[22];
sx q[22];
rz(3.743565159996389) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[22],q[21];
rz(0) q[21];
sx q[21];
rz(3.5366383114736064) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[20],q[21];
cx q[21],q[20];
...
rz(0) q[23];
sx q[23];
rz(4.11960585550221) q[23];
sx q[23];
rz(3*pi) q[23];
cx q[23],q[22];
rz(0) q[22];
sx q[22];
rz(3.6208862610688146) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[24];
sx q[24];
rz(3.9758749592265463) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[24],q[23];
rz(0) q[23];
sx q[23];
rz(3.4364169245346585) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[25];
sx q[25];
rz(3.211347058625826) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[25],q[24];
rz(0) q[24];
sx q[24];
rz(3.8384150336655334) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[27];
sx q[27];
rz(3.59403923069965) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(3.278751307055482) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[29];
sx q[29];
rz(3.9026471804946072) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[29],q[28];
rz(0) q[28];
sx q[28];
rz(3.9349179279420303) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[10];
sx q[10];
rz(3.300541601407674) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.961177738197912) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
rz(0) q[17];
sx q[17];
rz(3.426021370709418) q[17];
sx q[17];
rz(3*pi) q[17];
rz(0) q[30];
sx q[30];
rz(3.233511067221716) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[3];
sx q[3];
rz(3.6807710801456888) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[4],q[15];
rz(0) q[5];
sx q[5];
rz(3.7748977576237746) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6031759121878943) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[15],q[4];
cx q[4],q[15];
...
rz(0) q[21];
sx q[21];
rz(3.43436842690776) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(3.7785916587401074) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[26];
sx q[26];
rz(3.205217425455631) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(3.1567759736838905) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.369126631202138) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[21],q[22],q[3],q[5],q[7],q[16],q[26],q[27],q[29],q[12],q[10],q[11],q[17],q[30],q[28],q[25],q[24],q[23],q[15],q[20],q[19],q[18],q[0],q[1],q[2],q[14];
measure q[21] -> meas[0];
measure q[22] -> meas[1];
measure q[3] -> meas[2];
measure q[5] -> meas[3];
