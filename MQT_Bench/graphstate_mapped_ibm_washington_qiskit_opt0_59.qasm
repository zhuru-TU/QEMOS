...
sx q[44];
rz(pi/2) q[44];
barrier q[18],q[1],q[15],q[0],q[7],q[27],q[17],q[5],q[13],q[54],q[10],q[9],q[12],q[23],q[4],q[25],q[48],q[16],q[2],q[14],q[19],q[56],q[6],q[8],q[37],q[3],q[26],q[49],q[30],q[31],q[55],q[51],q[36],q[20],q[38],q[33],q[29],q[28],q[42],q[52],q[59],q[32],q[21],q[11],q[41],q[46],q[35],q[47],q[40],q[53],q[45],q[34],q[60],q[44],q[50],q[24],q[22],q[39],q[43];
measure q[18] -> meas[0];
measure q[1] -> meas[1];
measure q[15] -> meas[2];
measure q[0] -> meas[3];
