...
cx q[50],q[49];
cx q[49],q[50];
barrier q[20],q[33],q[21],q[38],q[53],q[26],q[47],q[46],q[45],q[54],q[49],q[41],q[81],q[0],q[37],q[80],q[57],q[63],q[58],q[64],q[23],q[11],q[61],q[72],q[73],q[62],q[48],q[68],q[67],q[51],q[12],q[8],q[13],q[36],q[16],q[10],q[9],q[77],q[83],q[66],q[15],q[84],q[31],q[32],q[34],q[25],q[7],q[6],q[85],q[2],q[55],q[5],q[3],q[24],q[65],q[43],q[28],q[4],q[17],q[52],q[42],q[71],q[82],q[1],q[56],q[59],q[40],q[50],q[44],q[30],q[29],q[35],q[27],q[60],q[14],q[22],q[18],q[19];
measure q[20] -> meas[0];
measure q[33] -> meas[1];
measure q[21] -> meas[2];
measure q[38] -> meas[3];
