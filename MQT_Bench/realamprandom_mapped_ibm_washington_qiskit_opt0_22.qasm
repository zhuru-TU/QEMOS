...
sx q[29];
rz(3*pi) q[29];
barrier q[18],q[19],q[20],q[21],q[22],q[26],q[28],q[30],q[11],q[12],q[17],q[29],q[27],q[25],q[24],q[23],q[15],q[4],q[3],q[2],q[0],q[1];
measure q[18] -> meas[0];
measure q[19] -> meas[1];
measure q[20] -> meas[2];
measure q[21] -> meas[3];
