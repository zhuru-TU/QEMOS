...
cx q[25],q[24];
cx q[24],q[25];
rz(0.10237267196077061) q[24];
cx q[24],q[23];
rz(-0.10237267196077061) q[23];
cx q[24],q[23];
rz(0.10237267196077061) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[22],q[15];
cx q[15],q[22];
rz(0.20474534392154123) q[15];
cx q[15],q[4];
rz(-0.20474534392154123) q[4];
cx q[15],q[4];
rz(0.20474534392154123) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(0.40949068784308246) q[4];
cx q[4],q[3];
rz(-0.40949068784308246) q[3];
cx q[4],q[3];
rz(0.40949068784308246) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(-0.8189813756861649) q[2];
cx q[3],q[2];
rz(0.8189813756861649) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-1.5036299022174633) q[2];
cx q[2],q[1];
rz(1.5036299022174633) q[1];
cx q[2],q[1];
rz(-1.5036299022174633) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.1343328491548667) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.1343328491548667) q[4];
cx q[3],q[4];
rz(0.1343328491548667) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(0.2686656983097334) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.2686656983097334) q[5];
cx q[4],q[5];
rz(0.2686656983097334) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.5373313966194668) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.5373313966194668) q[6];
cx q[5],q[6];
rz(0.5373313966194668) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(1.0746627932389337) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-1.0746627932389337) q[7];
cx q[6],q[7];
rz(1.0746627932389337) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-0.992267067111926) q[28];
cx q[28],q[29];
rz(0.992267067111926) q[29];
cx q[28],q[29];
rz(-0.992267067111926) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(1.157058519365941) q[17];
cx q[17],q[12];
rz(-1.157058519365941) q[12];
cx q[17],q[12];
rz(1.157058519365941) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(-0.8274756148579108) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4866414238739716) q[11];
cx q[11],q[10];
rz(-1.4866414238739716) q[10];
cx q[11],q[10];
rz(1.4866414238739716) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.16830980584185015) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.16830980584185015) q[12];
cx q[11],q[12];
rz(-0.16830980584185015) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[25],q[26];
cx q[16],q[26];
rz(-0.3366196116837003) q[25];
cx q[25],q[24];
rz(0.3366196116837003) q[24];
cx q[25],q[24];
rz(-0.3366196116837003) q[24];
cx q[24],q[25];
cx q[25],q[24];
