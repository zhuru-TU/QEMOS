...
rz(0) q[27];
sx q[27];
rz(-248918911.54928952) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[28],q[27];
rz(0) q[27];
sx q[27];
rz(248918917.83247483) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[44];
sx q[44];
rz(-65252599972723.48) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[45],q[44];
rz(0) q[44];
sx q[44];
rz(65252599972729.76) q[44];
sx q[44];
rz(3*pi) q[44];
cx q[44],q[45];
cx q[45],q[44];
...
sx q[64];
rz(pi/2) q[64];
barrier q[64],q[63],q[62],q[54],q[61],q[45],q[65],q[42],q[40],q[39],q[33],q[21],q[20],q[22],q[15],q[4],q[5],q[7],q[16],q[24],q[6],q[23],q[27],q[8],q[28],q[26],q[34],q[25],q[46],q[3],q[41],q[43],q[56],q[52],q[57],q[59],q[60],q[53],q[66],q[35],q[29],q[30],q[31],q[17],q[32],q[50],q[49],q[55],q[68],q[47],q[48],q[11],q[38],q[44],q[51],q[58],q[12],q[36],q[10],q[13],q[9],q[67],q[37],q[19],q[1],q[2],q[0],q[14],q[18],q[69];
measure q[64] -> meas[0];
measure q[63] -> meas[1];
measure q[62] -> meas[2];
measure q[54] -> meas[3];
