...
cx q[3],q[2];
cx q[2],q[3];
rz(0.8189520361658813) q[2];
cx q[2],q[1];
rz(-0.8189520361658813) q[1];
cx q[2],q[1];
rz(0.8189520361658813) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
rz(-pi/4) q[1];
rz(-pi/16) q[14];
barrier q[6],q[62],q[61],q[18],q[64],q[63],q[54],q[66],q[51],q[50],q[19],q[9],q[49],q[13],q[10],q[7],q[16],q[8],q[37],q[30],q[11],q[48],q[12],q[36],q[17],q[32],q[31],q[44],q[45],q[29],q[28],q[46],q[47],q[35],q[23],q[34],q[26],q[27],q[5],q[24],q[25],q[43],q[42],q[33],q[58],q[60],q[41],q[40],q[53],q[59],q[57],q[56],q[52],q[38],q[39],q[20],q[21],q[22],q[15],q[4],q[3],q[14],q[2],q[1],q[0],q[65];
measure q[6] -> c[0];
measure q[62] -> c[1];
measure q[61] -> c[2];
measure q[18] -> c[3];
