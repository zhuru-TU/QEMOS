...
sx q[47];
rz(pi/2) q[47];
barrier q[8],q[1],q[0],q[3],q[30],q[14],q[2],q[6],q[5],q[9],q[11],q[13],q[15],q[10],q[17],q[7],q[34],q[22],q[33],q[18],q[19],q[20],q[32],q[16],q[21],q[26],q[28],q[12],q[4],q[48],q[40],q[27],q[25],q[31],q[39],q[35],q[24],q[46],q[38],q[42],q[41],q[44],q[45],q[23],q[47];
measure q[8] -> meas[0];
measure q[1] -> meas[1];
measure q[0] -> meas[2];
measure q[3] -> meas[3];
