...
sx q[104];
rz(pi/2) q[104];
barrier q[33],q[5],q[38],q[3],q[18],q[11],q[4],q[25],q[35],q[8],q[31],q[9],q[10],q[60],q[26],q[14],q[23],q[70],q[52],q[39],q[50],q[2],q[1],q[19],q[37],q[43],q[6],q[32],q[13],q[27],q[15],q[12],q[17],q[59],q[30],q[36],q[7],q[42],q[21],q[58],q[20],q[56],q[16],q[90],q[97],q[28],q[48],q[53],q[63],q[89],q[74],q[67],q[49],q[22],q[95],q[68],q[57],q[61],q[83],q[82],q[65],q[71],q[55],q[69],q[64],q[88],q[99],q[84],q[85],q[86],q[66],q[81],q[76],q[46],q[47],q[51],q[41],q[62],q[72],q[79],q[91],q[0],q[75],q[101],q[24],q[105],q[102],q[29],q[34],q[45],q[44],q[40],q[73],q[54],q[80],q[104],q[92],q[94],q[96],q[78],q[100],q[77];
measure q[33] -> meas[0];
measure q[5] -> meas[1];
measure q[38] -> meas[2];
measure q[3] -> meas[3];
...
measure q[44] -> meas[90];
measure q[40] -> meas[91];
