...
rz(pi/2) q[27];
rz(-pi/33554432) q[48];
barrier q[27],q[26],q[25],q[28],q[29],q[17],q[11],q[10],q[9],q[12],q[30],q[35],q[13],q[46],q[44],q[41],q[39],q[20],q[22],q[23],q[24],q[21],q[31],q[16],q[48],q[47],q[49],q[50],q[34],q[33],q[4],q[5],q[6],q[7],q[8],q[3],q[2],q[0],q[1],q[14];
measure q[27] -> meas[0];
measure q[26] -> meas[1];
measure q[25] -> meas[2];
measure q[28] -> meas[3];
