...
cx q[21],q[20];
cx q[20],q[21];
rz(0.44863575573143644) q[20];
cx q[20],q[19];
rz(-0.44863575573143644) q[19];
cx q[20],q[19];
rz(0.44863575573143644) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(0.8972715114628729) q[18];
cx q[18],q[14];
rz(-0.8972715114628729) q[14];
cx q[18],q[14];
rz(0.8972715114628729) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
sx q[1];
rz(pi/2) q[1];
barrier q[19],q[18],q[21],q[20],q[6],q[15],q[22],q[23],q[28],q[30],q[11],q[12],q[17],q[29],q[27],q[24],q[25],q[26],q[16],q[8],q[7],q[5],q[4],q[3],q[2],q[14],q[0],q[1],q[10];
measure q[19] -> c[0];
measure q[18] -> c[1];
measure q[21] -> c[2];
measure q[20] -> c[3];
