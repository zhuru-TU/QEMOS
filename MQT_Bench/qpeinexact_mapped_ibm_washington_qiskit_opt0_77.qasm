...
cx q[53],q[41];
cx q[41],q[53];
rz(1.3472311231769365) q[41];
cx q[41],q[40];
rz(-1.3472311231769365) q[40];
cx q[41],q[40];
rz(1.3472311231769365) q[40];
cx q[40],q[41];
cx q[41],q[40];
...
cx q[33],q[20];
cx q[20],q[33];
rz(-0.4471304072359201) q[20];
cx q[20],q[19];
rz(0.4471304072359201) q[19];
cx q[20],q[19];
rz(-0.4471304072359201) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[22],q[15];
cx q[15],q[22];
rz(-0.8942608144718402) q[15];
cx q[15],q[4];
rz(0.8942608144718402) q[4];
cx q[15],q[4];
rz(-0.8942608144718402) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(1.3530710246461126) q[4];
cx q[4],q[3];
...
cx q[4],q[3];
rz(0.43545060429756755) q[3];
cx q[4],q[3];
rz(-0.43545060429756755) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(-0.8709012085951351) q[4];
cx q[4],q[5];
rz(0.8709012085951351) q[5];
cx q[4],q[5];
rz(1.399790236399523) q[4];
rz(-0.8709012085951351) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-1.399790236399523) q[5];
cx q[4],q[5];
rz(1.399790236399523) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(-0.34201218079074713) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(0.34201218079074713) q[6];
cx q[5],q[6];
rz(-0.34201218079074713) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[5],q[4];
cx q[4],q[5];
rz(-0.6840243615814943) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(0.6840243615814943) q[7];
cx q[6],q[7];
rz(-0.6840243615814943) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-1.3680487231629885) q[28];
cx q[28],q[29];
rz(1.3680487231629885) q[29];
cx q[28],q[29];
rz(-1.3680487231629885) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.40549520726381605) q[17];
cx q[17],q[12];
rz(-0.40549520726381605) q[12];
cx q[17],q[12];
rz(0.40549520726381605) q[12];
cx q[12],q[17];
cx q[17],q[12];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-1.519611824534529) q[11];
cx q[11],q[10];
rz(1.519611824534529) q[10];
cx q[11],q[10];
rz(-1.519611824534529) q[10];
cx q[9],q[10];
cx q[10],q[9];
...
rz(pi/2) q[63];
rz(-pi/4) q[64];
barrier q[71],q[52],q[9],q[36],q[32],q[17],q[10],q[11],q[13],q[12],q[31],q[30],q[70],q[81],q[72],q[69],q[51],q[85],q[73],q[65],q[34],q[29],q[45],q[44],q[43],q[28],q[50],q[67],q[66],q[49],q[68],q[55],q[46],q[47],q[48],q[42],q[35],q[7],q[26],q[8],q[16],q[27],q[24],q[25],q[14],q[0],q[6],q[23],q[5],q[2],q[1],q[3],q[15],q[4],q[22],q[21],q[18],q[19],q[20],q[33],q[37],q[38],q[39],q[40],q[41],q[53],q[59],q[56],q[57],q[58],q[60],q[61],q[62],q[54],q[64],q[63],q[80];
measure q[71] -> c[0];
measure q[52] -> c[1];
measure q[9] -> c[2];
measure q[36] -> c[3];
