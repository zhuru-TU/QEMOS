...
cx q[24],q[23];
cx q[23],q[24];
rz(1.5160122069192625) q[23];
cx q[23],q[22];
rz(-1.5160122069192625) q[22];
cx q[23],q[22];
rz(1.5160122069192625) q[22];
cx q[22],q[23];
cx q[23],q[22];
...
cx q[15],q[4];
cx q[4],q[15];
rz(-0.10956823975126795) q[4];
cx q[4],q[3];
rz(0.10956823975126795) q[3];
cx q[4],q[3];
rz(-0.10956823975126795) q[3];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-0.2191364795025359) q[3];
cx q[3],q[2];
...
cx q[3],q[2];
cx q[2],q[3];
rz(-0.4382729590050718) q[2];
cx q[2],q[1];
rz(0.4382729590050718) q[1];
cx q[2],q[1];
rz(-0.4382729590050718) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
cx q[3],q[4];
rz(1.388500817569506) q[3];
rz(-0.8765459180101436) q[4];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-1.388500817569506) q[4];
cx q[3],q[4];
rz(1.388500817569506) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[6],q[5];
cx q[5],q[6];
rz(-1.458364073803124) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(1.458364073803124) q[7];
cx q[6],q[7];
rz(-1.458364073803124) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.4497290119670897) q[17];
cx q[17],q[12];
rz(-0.4497290119670897) q[12];
cx q[17],q[12];
rz(0.4497290119670897) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.8994580239341794) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-1.3426766057214343) q[11];
cx q[11],q[10];
rz(1.3426766057214343) q[10];
cx q[11],q[10];
rz(-1.3426766057214343) q[10];
rz(0.4562394421469247) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(-0.4562394421469247) q[12];
cx q[11],q[12];
rz(0.4562394421469247) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[25],q[26];
cx q[16],q[26];
rz(0.9124788842938494) q[25];
cx q[25],q[24];
rz(-0.9124788842938494) q[24];
cx q[25],q[24];
rz(0.9124788842938494) q[24];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
rz(-1.3166348850020944) q[24];
cx q[24],q[23];
rz(1.3166348850020944) q[23];
cx q[24],q[23];
rz(-1.3166348850020944) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[24],q[23];
cx q[23],q[24];
rz(-1.1083011192473757) q[23];
cx q[23],q[22];
rz(1.1083011192473757) q[22];
cx q[23],q[22];
rz(-1.1083011192473757) q[22];
cx q[22],q[23];
cx q[23],q[22];
...
cx q[22],q[21];
cx q[21],q[22];
rz(0.9249904150950417) q[21];
cx q[21],q[20];
rz(-0.9249904150950417) q[20];
cx q[21],q[20];
rz(0.9249904150950417) q[20];
cx q[20],q[21];
cx q[21],q[20];
...
cx q[20],q[19];
rz(1.2916118233997098) q[19];
cx q[20],q[19];
rz(-1.2916118233997098) q[19];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
rz(0.5583690067903734) q[19];
cx q[19],q[18];
rz(-0.5583690067903734) q[18];
cx q[19],q[18];
rz(0.5583690067903734) q[18];
cx q[18],q[19];
cx q[19],q[18];
cx q[18],q[19];
rz(1.1167380135807468) q[18];
cx q[18],q[14];
rz(-1.1167380135807468) q[14];
cx q[18],q[14];
rz(1.1167380135807468) q[14];
cx q[0],q[14];
cx q[14],q[0];
...
sx q[22];
rz(pi/2) q[22];
barrier q[18],q[0],q[14],q[6],q[23],q[5],q[7],q[26],q[8],q[16],q[13],q[30],q[11],q[12],q[17],q[29],q[28],q[27],q[25],q[24],q[19],q[15],q[1],q[2],q[3],q[4],q[20],q[21],q[22],q[10];
measure q[18] -> c[0];
measure q[0] -> c[1];
measure q[14] -> c[2];
measure q[6] -> c[3];
