...
cx q[25],q[24];
cx q[24],q[25];
rz(-1.3464784474662603) q[24];
cx q[24],q[23];
rz(1.3464784474662603) q[23];
cx q[24],q[23];
rz(-1.3464784474662603) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[22],q[21];
cx q[21],q[22];
rz(0.44863575865727257) q[21];
cx q[21],q[20];
rz(-0.44863575865727257) q[20];
cx q[21],q[20];
rz(0.44863575865727257) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[15],q[4];
cx q[4],q[15];
rz(0.8972715173145451) q[4];
cx q[4],q[3];
rz(-0.8972715173145451) q[3];
cx q[4],q[3];
rz(0.8972715173145451) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(1.3470496189607029) q[2];
cx q[3],q[2];
rz(-1.3470496189607029) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.4474934156683876) q[2];
cx q[2],q[1];
rz(-0.4474934156683876) q[1];
cx q[2],q[1];
rz(0.4474934156683876) q[1];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.8949868313367751) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.8949868313367751) q[4];
cx q[3],q[4];
rz(0.8949868313367751) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3516189909162428) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(1.3516189909162428) q[5];
cx q[4],q[5];
rz(-1.3516189909162428) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.4383546717573073) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.4383546717573073) q[6];
cx q[5],q[6];
rz(0.4383546717573073) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(0.8767093435146146) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-0.8767093435146146) q[7];
cx q[6],q[7];
rz(0.8767093435146146) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.3652447204686654) q[17];
cx q[17],q[12];
rz(-0.3652447204686654) q[12];
cx q[17],q[12];
rz(0.3652447204686654) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.7304894409373308) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(1.4609788818746616) q[11];
cx q[11],q[10];
rz(-1.4609788818746616) q[10];
cx q[11],q[10];
rz(1.4609788818746616) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.2196348898404699) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.2196348898404699) q[12];
cx q[11],q[12];
rz(-0.2196348898404699) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[25],q[26];
cx q[16],q[26];
rz(-0.4392697796809398) q[25];
cx q[25],q[24];
rz(0.4392697796809398) q[24];
cx q[25],q[24];
rz(-0.4392697796809398) q[24];
cx q[24],q[25];
cx q[25],q[24];
cx q[24],q[25];
rz(-0.8785395593618796) q[24];
cx q[24],q[23];
rz(0.8785395593618796) q[23];
cx q[24],q[23];
rz(-0.8785395593618796) q[23];
cx q[22],q[23];
cx q[23],q[22];
...
cx q[25],q[24];
cx q[24],q[25];
rz(1.384513534866034) q[25];
cx q[26],q[16];
cx q[16],q[26];
cx q[25],q[26];
rz(-1.384513534866034) q[26];
cx q[25],q[26];
rz(1.384513534866034) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
cx q[25],q[24];
cx q[24],q[25];
rz(-0.7451311677154502) q[24];
cx q[24],q[23];
rz(0.7451311677154502) q[23];
cx q[24],q[23];
rz(-0.7451311677154502) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[22],q[21];
cx q[21],q[22];
rz(-1.4902623354309004) q[21];
cx q[21],q[20];
rz(1.4902623354309004) q[20];
cx q[21],q[20];
rz(-1.4902623354309004) q[20];
cx q[20],q[21];
cx q[21],q[20];
...
cx q[20],q[19];
cx q[19],q[20];
rz(0.16106798272799233) q[19];
cx q[19],q[18];
rz(-0.16106798272799233) q[18];
cx q[19],q[18];
rz(0.16106798272799233) q[18];
cx q[18],q[19];
cx q[19],q[18];
cx q[18],q[19];
rz(0.32213596545598466) q[18];
cx q[18],q[14];
rz(-0.32213596545598466) q[14];
cx q[18],q[14];
rz(0.32213596545598466) q[14];
cx q[14],q[18];
cx q[18],q[14];
cx q[14],q[18];
rz(0.6442719309119693) q[14];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
cx q[18],q[19];
...
cx q[16],q[26];
cx q[25],q[26];
rz(1.1290098598838318) q[26];
cx q[25],q[26];
rz(0.8835729338221293) q[25];
cx q[25],q[24];
rz(-0.8835729338221293) q[24];
cx q[25],q[24];
rz(0.8835729338221293) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
sx q[1];
rz(pi/2) q[1];
barrier q[13],q[10],q[27],q[8],q[7],q[31],q[11],q[16],q[28],q[12],q[17],q[30],q[29],q[26],q[25],q[5],q[6],q[14],q[3],q[24],q[18],q[19],q[20],q[23],q[21],q[22],q[15],q[4],q[2],q[0],q[1],q[9];
measure q[13] -> c[0];
measure q[10] -> c[1];
measure q[27] -> c[2];
measure q[8] -> c[3];
