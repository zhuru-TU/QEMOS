...
rz(0) q[6];
sx q[6];
rz(3.7749685390985865) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.7870887769473582) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[7],q[6];
rz(0) q[6];
sx q[6];
rz(3.235834877413719) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[0];
sx q[0];
rz(4.069978393023298) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.921531314042166) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.3289511381808246) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(4.079402679726033) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.7526640261309923) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.983286510327173) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.693386063768336) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(3.8887533391938547) q[8];
sx q[8];
rz(3*pi) q[8];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[8],q[6];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
