...
sx q[72];
rz(pi/2) q[72];
barrier q[0],q[5],q[15],q[1],q[26],q[6],q[7],q[8],q[68],q[32],q[12],q[28],q[34],q[13],q[18],q[2],q[30],q[36],q[57],q[14],q[20],q[41],q[33],q[11],q[27],q[23],q[3],q[21],q[29],q[51],q[9],q[10],q[69],q[82],q[16],q[47],q[55],q[60],q[53],q[22],q[38],q[24],q[39],q[62],q[64],q[61],q[45],q[70],q[74],q[17],q[31],q[50],q[42],q[52],q[19],q[25],q[79],q[4],q[56],q[58],q[35],q[44],q[59],q[63],q[43],q[75],q[54],q[67],q[66],q[49],q[83],q[65],q[81],q[48],q[46],q[37],q[71],q[76],q[40],q[77],q[78],q[72];
measure q[0] -> meas[0];
measure q[5] -> meas[1];
measure q[15] -> meas[2];
measure q[1] -> meas[3];
