...
rz(-pi/4) q[48];
rz(-pi/32768) q[52];
barrier q[47],q[48],q[49],q[35],q[27],q[26],q[25],q[24],q[23],q[21],q[20],q[39],q[38],q[37],q[52],q[40],q[42],q[41],q[33],q[19],q[22],q[44],q[43],q[15],q[34],q[6],q[8],q[7],q[16],q[28],q[4],q[46],q[29],q[5],q[3],q[45],q[30],q[31],q[32],q[36],q[17],q[51],q[13],q[11],q[10],q[9],q[12],q[18],q[2],q[1],q[0],q[14],q[50];
measure q[47] -> meas[0];
measure q[48] -> meas[1];
measure q[49] -> meas[2];
measure q[35] -> meas[3];
