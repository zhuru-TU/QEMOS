...
rz(0) q[3];
sx q[3];
rz(3.850433297083356) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(4.095610303174419) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[4],q[3];
rz(0) q[3];
sx q[3];
rz(3.6420735047076818) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
rz(0) q[0];
sx q[0];
rz(3.298294859970453) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.5079264013425493) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.559708595455404) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.166643600297512) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.262961787277579) q[5];
sx q[5];
rz(3*pi) q[5];
barrier q[0],q[1],q[2],q[4],q[5],q[3];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
