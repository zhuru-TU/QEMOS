...
rz(pi/2) q[22];
rz(-pi/4) q[23];
barrier q[22],q[23],q[15],q[4],q[5],q[7],q[16],q[26],q[25],q[24],q[27],q[28],q[47],q[46],q[45],q[44],q[43],q[42],q[41],q[35],q[29],q[30],q[8],q[34],q[21],q[6],q[17],q[12],q[11],q[10],q[31],q[13],q[33],q[3],q[2],q[0],q[1],q[14],q[20],q[18],q[38];
measure q[22] -> meas[0];
measure q[23] -> meas[1];
measure q[15] -> meas[2];
measure q[4] -> meas[3];
