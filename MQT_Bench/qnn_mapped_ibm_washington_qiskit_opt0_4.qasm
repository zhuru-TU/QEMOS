...
rz(0) q[1];
sx q[1];
rz(3.3154034403087795) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.69845876192682) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[2],q[1];
rz(0) q[1];
sx q[1];
rz(3.9242405261172957) q[1];
sx q[1];
rz(3*pi) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
rz(0) q[1];
sx q[1];
rz(3.6002688237554463) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.9756075838718967) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.756632766883863) q[3];
sx q[3];
rz(3*pi) q[3];
