...
sx q[0];
rz(pi/2) q[0];
rz(-4.6442939433271775) q[0];
rz(pi/2) q[1];
sx q[1];
rz(pi/2) q[1];
rz(-4.697610934420388) q[1];
cx q[0],q[1];
rz(4.670329757615175) q[1];
cx q[0],q[1];
rz(pi/2) q[2];
sx q[2];
rz(pi/2) q[2];
rz(-4.650014252171866) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(4.669625768043109) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(9.393478922180883) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(-2.6806235709823234) q[0];
cx q[2],q[1];
rz(4.671050135266782) q[1];
cx q[2],q[1];
rz(pi/2) q[1];
sx q[1];
rz(9.393478922180883) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(-2.68392525578296) q[1];
rz(pi/2) q[2];
sx q[2];
rz(9.393478922180883) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(-2.7113974162217414) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(2.6956510904119235) q[1];
cx q[0],q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(2.6952447571643656) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(9.715001278017414) q[0];
sx q[0];
rz(5*pi/2) q[0];
rz(4.709561696044971) q[0];
cx q[2],q[1];
rz(2.6960668826370653) q[1];
cx q[2],q[1];
rz(pi/2) q[1];
sx q[1];
rz(9.715001278017414) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(4.715362394224982) q[1];
rz(pi/2) q[2];
sx q[2];
rz(9.715001278017414) q[2];
sx q[2];
rz(5*pi/2) q[2];
rz(4.763627967918596) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(-4.735963399983686) q[1];
cx q[0],q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
cx q[0],q[1];
rz(-4.735249517020318) q[1];
cx q[0],q[1];
rz(pi/2) q[0];
sx q[0];
rz(-3.893902816780691) q[0];
sx q[0];
rz(5*pi/2) q[0];
cx q[2],q[1];
rz(-4.736693901333536) q[1];
cx q[2],q[1];
rz(pi/2) q[1];
sx q[1];
rz(-3.893902816780691) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[2];
sx q[2];
rz(-3.893902816780691) q[2];
sx q[2];
rz(5*pi/2) q[2];
barrier q[0],q[2],q[1];
measure q[0] -> meas[0];
...
measure q[1] -> meas[2];
barrier q[0],q[2],q[1];
measure q[0] -> meas297[0];
measure q[2] -> meas297[1];
measure q[1] -> meas297[2];