...
cx q[25],q[24];
cx q[24],q[25];
rz(-1.3464875892413377) q[24];
cx q[24],q[23];
rz(1.3464875892413377) q[23];
cx q[24],q[23];
rz(-1.3464875892413377) q[23];
cx q[23],q[24];
cx q[24],q[23];
...
cx q[22],q[21];
cx q[21],q[22];
rz(0.4486174751071179) q[21];
cx q[21],q[20];
rz(-0.4486174751071179) q[20];
cx q[21],q[20];
rz(0.4486174751071179) q[20];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[15],q[4];
cx q[4],q[15];
rz(0.8972349502142358) q[4];
cx q[4],q[3];
rz(-0.8972349502142358) q[3];
cx q[4],q[3];
rz(0.8972349502142358) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[3],q[2];
rz(1.3471227531613215) q[2];
cx q[3],q[2];
rz(-1.3471227531613215) q[2];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(0.4473471472671501) q[2];
cx q[2],q[1];
rz(-0.4473471472671501) q[1];
cx q[2],q[1];
rz(0.4473471472671501) q[1];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[2],q[1];
cx q[1],q[2];
rz(0.8946942945343002) q[3];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[3],q[4];
rz(-0.8946942945343002) q[4];
cx q[3],q[4];
rz(0.8946942945343002) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3522040645211928) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(1.3522040645211928) q[5];
cx q[4],q[5];
rz(-1.3522040645211928) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
cx q[4],q[15];
rz(0.43718452454740775) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.43718452454740775) q[6];
cx q[5],q[6];
rz(0.43718452454740775) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(0.8743690490948155) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-0.8743690490948155) q[7];
cx q[6],q[7];
rz(0.8743690490948155) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.35588354278946877) q[17];
cx q[17],q[12];
rz(-0.35588354278946877) q[12];
cx q[17],q[12];
rz(0.35588354278946877) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.7117670855789375) q[12];
cx q[12],q[11];
...
rz(-pi/4) q[16];
rz(-pi/16384) q[30];
barrier q[3],q[27],q[17],q[30],q[29],q[28],q[24],q[25],q[23],q[15],q[4],q[5],q[6],q[7],q[26],q[16],q[8],q[22];
measure q[3] -> c[0];
measure q[27] -> c[1];
measure q[17] -> c[2];
measure q[30] -> c[3];
