...
sx q[26];
rz(pi/2) q[26];
barrier q[8],q[14],q[0],q[16],q[18],q[1],q[37],q[13],q[46],q[28],q[9],q[25],q[45],q[17],q[30],q[6],q[7],q[32],q[21],q[15],q[35],q[4],q[2],q[22],q[41],q[44],q[47],q[5],q[20],q[29],q[27],q[10],q[11],q[31],q[3],q[23],q[12],q[33],q[39],q[26],q[24],q[19],q[40],q[42],q[34],q[38],q[43];
measure q[8] -> meas[0];
measure q[14] -> meas[1];
measure q[0] -> meas[2];
measure q[16] -> meas[3];
