...
rz(0) q[0];
sx q[0];
rz(6.279408296363799) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.1410266694333693) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.4978629118692177) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(1.4687076824099135) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(3.16123674101277) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(0.028614393403033844) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(1.5835762898109351) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.1418090636124036) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(1.5690909345194586) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[9];
sx q[9];
rz(0.005124684685862135) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[10];
sx q[10];
rz(4.723610695271218) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[11];
sx q[11];
rz(1.5200198318933953) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
...
rz(0) q[9];
sx q[9];
rz(4.712119103448701) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(4.711473240955736) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[9];
sx q[9];
rz(6.272509493355026) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(0.05186856874886825) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[1];
sx q[1];
rz(0.12674494690952187) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.712046461992239) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(1.5702694732601499) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(1.570625646069014) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.5715014043593207) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[0];
sx q[0];
rz(0.0035794941205593567) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(0.1267495300977206) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(2.5769106856099175) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(6.210583364571026) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(6.181604005447456) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.693879076113614) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(1.5994135758588257) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(0.01469797502030179) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(4.713072357975688) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[30];
sx q[30];
...
sx q[30];
rz(3*pi) q[30];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[30],q[11],q[9],q[10];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
