...
rz(0) q[1];
sx q[1];
rz(3.664565397545342) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[3];
sx q[3];
rz(4.09975850227498) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
rz(0) q[4];
sx q[4];
rz(3.724809518949099) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[15];
sx q[15];
rz(3.670199851273685) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[15],q[4];
rz(0) q[4];
sx q[4];
rz(3.92075841427674) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
rz(0) q[3];
sx q[3];
rz(3.285394006222443) q[3];
sx q[3];
rz(3*pi) q[3];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(3.6908174261702795) q[0];
sx q[0];
rz(3*pi) q[0];
cx q[14],q[18];
rz(0) q[15];
sx q[15];
rz(4.068431979528107) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[18],q[14];
cx q[14],q[18];
...
rz(0) q[19];
sx q[19];
rz(3.3521943988370886) q[19];
sx q[19];
rz(3*pi) q[19];
rz(0) q[21];
sx q[21];
rz(3.955108918189926) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(3.9545540487069326) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[27];
sx q[27];
rz(3.91090474020205) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[27],q[26];
rz(0) q[26];
sx q[26];
rz(3.3692025124195695) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[16],q[26];
cx q[26],q[16];
...
rz(0) q[29];
sx q[29];
rz(3.8643764689100295) q[29];
sx q[29];
rz(3*pi) q[29];
cx q[29],q[28];
rz(0) q[28];
sx q[28];
rz(3.8284797149075986) q[28];
sx q[28];
rz(3*pi) q[28];
cx q[27],q[28];
cx q[28],q[27];
...
rz(0) q[9];
sx q[9];
rz(3.5444346417364883) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(4.012090534267696) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[12];
sx q[12];
rz(4.070692481126468) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[17];
sx q[17];
rz(3.6107585011119108) q[17];
sx q[17];
rz(3*pi) q[17];
rz(0) q[30];
sx q[30];
rz(3.17794893255604) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[29],q[30];
cx q[30],q[29];
...
rz(0) q[5];
sx q[5];
rz(4.124185653118917) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6266606466775215) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[7],q[8];
cx q[8],q[7];
...
rz(0) q[8];
sx q[8];
rz(3.217734825872642) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[16];
sx q[16];
rz(3.411233056467707) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.6254425308779954) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[30];
sx q[30];
rz(3.3360245168953258) q[30];
sx q[30];
rz(3*pi) q[30];
barrier q[16],q[8],q[6],q[5],q[7],q[26],q[27],q[30],q[11],q[9],q[10],q[12],q[17],q[29],q[28],q[25],q[24],q[22],q[3],q[0],q[19],q[21],q[20],q[18],q[14],q[1],q[2],q[15],q[23],q[4];
measure q[16] -> meas[0];
measure q[8] -> meas[1];
measure q[6] -> meas[2];
measure q[5] -> meas[3];
