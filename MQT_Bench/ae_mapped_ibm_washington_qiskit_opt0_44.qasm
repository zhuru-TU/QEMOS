...
rz(pi/2) q[46];
rz(-pi/4) q[47];
barrier q[46],q[47],q[35],q[45],q[44],q[34],q[24],q[25],q[26],q[27],q[28],q[23],q[22],q[21],q[39],q[40],q[33],q[41],q[42],q[19],q[16],q[38],q[20],q[15],q[4],q[8],q[30],q[29],q[7],q[48],q[17],q[11],q[12],q[13],q[10],q[9],q[31],q[5],q[2],q[0],q[1],q[14],q[18],q[37];
measure q[46] -> meas[0];
measure q[47] -> meas[1];
measure q[35] -> meas[2];
measure q[45] -> meas[3];
