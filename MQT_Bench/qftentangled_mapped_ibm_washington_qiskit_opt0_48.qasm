...
cx q[32],q[36];
cx q[36],q[32];
barrier q[15],q[19],q[14],q[21],q[39],q[40],q[5],q[43],q[28],q[35],q[27],q[11],q[12],q[46],q[36],q[49],q[26],q[16],q[38],q[42],q[3],q[23],q[45],q[1],q[24],q[44],q[7],q[2],q[20],q[37],q[8],q[25],q[48],q[32],q[47],q[9],q[10],q[17],q[30],q[29],q[34],q[6],q[41],q[33],q[22],q[0],q[18],q[4];
measure q[15] -> meas[0];
measure q[19] -> meas[1];
measure q[14] -> meas[2];
measure q[21] -> meas[3];
