...
cx q[33],q[20];
cx q[20],q[33];
rz(0.15427208938889952) q[20];
cx q[20],q[19];
rz(-0.15427208938889952) q[19];
cx q[20],q[19];
rz(0.15427208938889952) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(0.30854417877779905) q[18];
cx q[18],q[14];
rz(-0.30854417877779905) q[14];
cx q[18],q[14];
rz(0.30854417877779905) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(0.6170883575555981) q[0];
cx q[0],q[1];
rz(-0.6170883575555981) q[1];
cx q[0],q[1];
rz(0.6170883575555981) q[1];
cx q[0],q[1];
cx q[1],q[0];
...
cx q[2],q[1];
cx q[1],q[2];
rz(-0.6732392233674006) q[2];
cx q[2],q[3];
rz(0.6732392233674006) q[3];
cx q[2],q[3];
rz(-0.6732392233674006) q[3];
cx q[2],q[3];
cx q[3],q[2];
...
cx q[15],q[4];
cx q[4],q[15];
rz(0.3236699462438703) q[4];
cx q[4],q[5];
rz(-0.3236699462438703) q[5];
cx q[4],q[5];
rz(0.3236699462438703) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[6],q[5];
cx q[5],q[6];
rz(0.6473398924877406) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(-0.6473398924877406) q[7];
cx q[6],q[7];
rz(0.6473398924877406) q[7];
cx q[8],q[16];
cx q[16],q[8];
...
rz(pi/2) q[4];
rz(-pi/4096) q[32];
barrier q[19],q[18],q[39],q[34],q[33],q[35],q[9],q[13],q[10],q[7],q[16],q[8],q[0],q[6],q[5],q[1],q[14],q[20],q[21],q[26],q[28],q[31],q[11],q[12],q[17],q[32],q[30],q[29],q[27],q[25],q[24],q[23],q[22],q[15],q[2],q[3],q[4],q[36];
measure q[19] -> c[0];
measure q[18] -> c[1];
measure q[39] -> c[2];
measure q[34] -> c[3];
