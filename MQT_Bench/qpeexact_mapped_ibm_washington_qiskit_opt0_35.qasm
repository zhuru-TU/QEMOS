...
rz(pi/2) q[20];
rz(-pi/16) q[21];
barrier q[3],q[32],q[9],q[10],q[11],q[31],q[12],q[6],q[34],q[25],q[33],q[15],q[22],q[23],q[24],q[26],q[28],q[17],q[30],q[29],q[27],q[16],q[8],q[7],q[5],q[4],q[2],q[1],q[0],q[14],q[21],q[18],q[19],q[20],q[13];
measure q[3] -> c[0];
measure q[32] -> c[1];
measure q[9] -> c[2];
measure q[10] -> c[3];
