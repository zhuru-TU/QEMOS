...
cx q[21],q[20];
cx q[20],q[21];
rz(1.5160121279216863) q[20];
cx q[20],q[19];
rz(-1.5160121279216863) q[19];
cx q[20],q[19];
rz(1.5160121279216863) q[19];
cx q[19],q[20];
cx q[20],q[19];
...
cx q[19],q[18];
cx q[18],q[19];
rz(-0.1095683977464205) q[18];
cx q[18],q[14];
rz(0.1095683977464205) q[14];
cx q[18],q[14];
rz(-0.1095683977464205) q[14];
cx q[14],q[18];
cx q[18],q[14];
...
cx q[14],q[0];
cx q[0],q[14];
rz(-0.219136795492841) q[0];
cx q[0],q[1];
rz(0.219136795492841) q[1];
cx q[0],q[1];
rz(-0.219136795492841) q[1];
cx q[0],q[1];
cx q[1],q[0];
cx q[0],q[1];
rz(-0.438273590985682) q[1];
cx q[1],q[2];
rz(0.438273590985682) q[2];
cx q[1],q[2];
rz(-0.438273590985682) q[2];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(-0.876547181971364) q[2];
cx q[2],q[3];
rz(0.876547181971364) q[3];
cx q[2],q[3];
rz(-0.876547181971364) q[3];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(1.388498289647065) q[3];
cx q[3],q[4];
rz(-1.388498289647065) q[4];
cx q[3],q[4];
rz(1.388498289647065) q[4];
cx q[3],q[4];
cx q[4],q[3];
cx q[3],q[4];
rz(-0.364596074295663) q[4];
cx q[4],q[5];
rz(0.364596074295663) q[5];
cx q[4],q[5];
rz(-0.364596074295663) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(-0.729192148591326) q[5];
cx q[5],q[6];
rz(0.729192148591326) q[6];
cx q[5],q[6];
rz(-0.729192148591326) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.44964811844897856) q[17];
cx q[17],q[12];
rz(-0.44964811844897856) q[12];
cx q[17],q[12];
rz(0.44964811844897856) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.8992962368979571) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-1.3430001797938789) q[11];
cx q[11],q[10];
rz(1.3430001797938789) q[10];
cx q[11],q[10];
rz(-1.3430001797938789) q[10];
cx q[12],q[17];
cx q[17],q[12];
...
cx q[29],q[28];
cx q[28],q[29];
rz(0.9111845880040709) q[28];
cx q[28],q[27];
rz(-0.9111845880040709) q[27];
cx q[28],q[27];
rz(0.9111845880040709) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
cx q[26],q[25];
cx q[25],q[26];
rz(-1.3192234775816514) q[25];
cx q[25],q[24];
rz(1.3192234775816514) q[24];
cx q[25],q[24];
rz(-1.3192234775816514) q[24];
cx q[23],q[24];
cx q[24],q[23];
...
rz(-pi/4) q[1];
rz(-pi/16) q[14];
barrier q[18],q[20],q[21],q[22],q[15],q[6],q[8],q[26],q[28],q[12],q[17],q[30],q[29],q[27],q[16],q[7],q[5],q[4],q[3],q[14],q[2],q[1],q[0],q[23];
measure q[18] -> c[0];
measure q[20] -> c[1];
measure q[21] -> c[2];
measure q[22] -> c[3];
