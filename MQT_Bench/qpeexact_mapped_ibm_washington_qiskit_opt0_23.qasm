...
cx q[15],q[4];
cx q[4],q[15];
rz(-1.3464786010726586) q[4];
cx q[4],q[3];
rz(1.3464786010726586) q[3];
cx q[4],q[3];
rz(-1.3464786010726586) q[3];
cx q[3],q[4];
cx q[4],q[3];
...
sx q[4];
rz(pi/2) q[4];
barrier q[18],q[20],q[21],q[22],q[24],q[25],q[26],q[11],q[12],q[17],q[30],q[29],q[28],q[27],q[16],q[8],q[7],q[6],q[5],q[2],q[3],q[4],q[1];
measure q[18] -> c[0];
measure q[20] -> c[1];
measure q[21] -> c[2];
measure q[22] -> c[3];
