...
sx q[72];
rz(pi/2) q[72];
barrier q[1],q[25],q[2],q[11],q[23],q[3],q[15],q[0],q[70],q[9],q[13],q[12],q[30],q[8],q[37],q[6],q[44],q[5],q[58],q[56],q[19],q[20],q[39],q[4],q[28],q[36],q[24],q[26],q[27],q[7],q[32],q[17],q[41],q[22],q[67],q[35],q[47],q[71],q[57],q[53],q[52],q[54],q[34],q[59],q[21],q[66],q[46],q[10],q[31],q[55],q[42],q[65],q[43],q[16],q[63],q[64],q[14],q[18],q[33],q[38],q[69],q[73],q[45],q[60],q[40],q[62],q[51],q[50],q[68],q[48],q[29],q[61],q[72],q[49];
measure q[1] -> meas[0];
measure q[25] -> meas[1];
measure q[2] -> meas[2];
measure q[11] -> meas[3];
