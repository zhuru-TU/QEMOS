...
cx q[3],q[2];
cx q[2],q[3];
rz(-1.3470496131090304) q[2];
cx q[2],q[1];
rz(1.3470496131090304) q[1];
cx q[2],q[1];
rz(-1.3470496131090304) q[1];
cx q[1],q[2];
cx q[2],q[1];
cx q[1],q[2];
rz(0.4474934273717322) q[1];
cx q[1],q[0];
...
cx q[4],q[3];
cx q[3],q[4];
rz(-1.3516189441028643) q[4];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(1.3516189441028643) q[5];
cx q[4],q[5];
rz(-1.3516189441028643) q[5];
cx q[4],q[5];
cx q[5],q[4];
cx q[4],q[5];
rz(0.43835476538406437) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(-0.43835476538406437) q[6];
cx q[5],q[6];
rz(0.43835476538406437) q[6];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
rz(0.8767095307681287) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
...
cx q[11],q[10];
rz(-1.4609818779308879) q[10];
cx q[11],q[10];
rz(1.4609818779308879) q[10];
cx q[9],q[10];
cx q[10],q[9];
cx q[9],q[10];
rz(-0.21962889772801722) q[11];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
cx q[11],q[12];
rz(0.21962889772801722) q[12];
cx q[11],q[12];
rz(-0.21962889772801722) q[12];
cx q[11],q[12];
cx q[12],q[11];
...
cx q[20],q[19];
rz(-0.16183497312193515) q[19];
cx q[20],q[19];
rz(0.16183497312193515) q[19];
cx q[19],q[20];
cx q[20],q[19];
cx q[19],q[20];
rz(0.3236699462438703) q[19];
cx q[19],q[18];
rz(-0.3236699462438703) q[18];
cx q[19],q[18];
rz(0.3236699462438703) q[18];
cx q[18],q[19];
cx q[19],q[18];
cx q[18],q[19];
rz(0.6473398924877406) q[18];
cx q[18],q[14];
rz(-0.6473398924877406) q[14];
cx q[18],q[14];
rz(0.6473398924877406) q[14];
cx q[14],q[18];
cx q[18],q[14];
cx q[14],q[18];
rz(1.2946797849754812) q[14];
cx q[21],q[22];
cx q[22],q[21];
cx q[21],q[22];
cx q[20],q[21];
...
cx q[18],q[19];
cx q[14],q[18];
rz(-1.2946797849754812) q[18];
cx q[14],q[18];
rz(-0.5522330836388308) q[14];
rz(1.2946797849754812) q[18];
cx q[22],q[23];
cx q[23],q[22];
cx q[22],q[23];
...
cx q[21],q[22];
rz(0.9326603190344698) q[21];
cx q[21],q[20];
rz(-0.9326603190344698) q[20];
cx q[21],q[20];
rz(0.9326603190344698) q[20];
rz(-1.1044661672776617) q[22];
cx q[15],q[22];
...
sx q[1];
rz(pi/2) q[1];
barrier q[32],q[31],q[8],q[26],q[21],q[24],q[15],q[23],q[25],q[28],q[30],q[13],q[10],q[11],q[12],q[17],q[29],q[27],q[16],q[7],q[6],q[22],q[20],q[19],q[18],q[3],q[5],q[4],q[2],q[14],q[0],q[1],q[9];
measure q[32] -> c[0];
measure q[31] -> c[1];
measure q[8] -> c[2];
measure q[26] -> c[3];
