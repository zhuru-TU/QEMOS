...
cx q[41],q[40];
cx q[40],q[41];
rz(0.1023521263301747) q[40];
cx q[40],q[39];
rz(-0.1023521263301747) q[39];
cx q[40],q[39];
rz(0.1023521263301747) q[39];
cx q[39],q[40];
cx q[40],q[39];
...
cx q[33],q[20];
cx q[20],q[33];
rz(0.2047042526603494) q[20];
cx q[20],q[19];
rz(-0.2047042526603494) q[19];
cx q[20],q[19];
rz(0.2047042526603494) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
sx q[43];
rz(pi/2) q[43];
barrier q[46],q[37],q[40],q[38],q[1],q[33],q[39],q[45],q[31],q[13],q[9],q[10],q[17],q[11],q[12],q[48],q[16],q[44],q[20],q[5],q[14],q[18],q[23],q[22],q[3],q[4],q[2],q[0],q[19],q[21],q[15],q[6],q[8],q[47],q[26],q[35],q[30],q[29],q[28],q[27],q[25],q[24],q[34],q[41],q[42],q[43],q[7];
measure q[46] -> c[0];
measure q[37] -> c[1];
measure q[40] -> c[2];
measure q[38] -> c[3];
