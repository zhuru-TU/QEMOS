...
cx q[45],q[44];
cx q[44],q[45];
barrier q[4],q[20],q[21],q[22],q[2],q[14],q[5],q[44],q[43],q[24],q[42],q[40],q[61],q[38],q[59],q[34],q[58],q[64],q[48],q[53],q[7],q[29],q[28],q[17],q[65],q[8],q[32],q[50],q[10],q[13],q[11],q[36],q[9],q[51],q[31],q[47],q[55],q[12],q[27],q[30],q[16],q[33],q[35],q[46],q[23],q[60],q[37],q[39],q[62],q[41],q[26],q[25],q[54],q[45],q[6],q[0],q[1],q[15],q[18],q[19],q[3];
measure q[4] -> meas[0];
measure q[20] -> meas[1];
measure q[21] -> meas[2];
measure q[22] -> meas[3];
