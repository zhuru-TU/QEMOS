...
sx q[45];
rz(pi/2) q[45];
barrier q[15],q[2],q[34],q[8],q[1],q[19],q[7],q[6],q[10],q[51],q[12],q[67],q[13],q[9],q[3],q[5],q[24],q[27],q[22],q[0],q[43],q[14],q[41],q[28],q[18],q[35],q[4],q[36],q[11],q[30],q[31],q[32],q[37],q[38],q[16],q[69],q[29],q[23],q[75],q[42],q[58],q[33],q[48],q[50],q[70],q[66],q[47],q[46],q[76],q[63],q[49],q[57],q[26],q[21],q[72],q[55],q[71],q[56],q[80],q[82],q[81],q[52],q[79],q[60],q[64],q[65],q[44],q[68],q[17],q[86],q[25],q[20],q[85],q[73],q[54],q[83],q[78],q[77],q[59],q[53],q[40],q[39],q[62],q[61],q[45];
measure q[15] -> meas[0];
measure q[2] -> meas[1];
measure q[34] -> meas[2];
measure q[8] -> meas[3];
