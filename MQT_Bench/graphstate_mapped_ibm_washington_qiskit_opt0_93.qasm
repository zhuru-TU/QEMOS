...
sx q[96];
rz(pi/2) q[96];
barrier q[1],q[34],q[14],q[47],q[31],q[43],q[8],q[19],q[77],q[11],q[51],q[9],q[13],q[10],q[2],q[82],q[5],q[6],q[3],q[35],q[52],q[76],q[0],q[12],q[27],q[7],q[20],q[29],q[42],q[46],q[32],q[68],q[62],q[4],q[15],q[22],q[30],q[18],q[56],q[57],q[71],q[58],q[24],q[21],q[79],q[87],q[28],q[41],q[50],q[36],q[26],q[17],q[80],q[53],q[66],q[67],q[33],q[39],q[78],q[37],q[23],q[65],q[61],q[25],q[92],q[83],q[40],q[86],q[69],q[48],q[89],q[44],q[63],q[85],q[70],q[75],q[95],q[72],q[81],q[59],q[45],q[16],q[73],q[60],q[96],q[74],q[88],q[55],q[84],q[49],q[54],q[38],q[64];
measure q[1] -> meas[0];
measure q[34] -> meas[1];
measure q[14] -> meas[2];
measure q[47] -> meas[3];
