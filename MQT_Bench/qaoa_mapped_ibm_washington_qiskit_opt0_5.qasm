...
rz(pi/2) q[1];
sx q[1];
rz(4.24454027083546) q[1];
sx q[1];
rz(5*pi/2) q[1];
cx q[0],q[1];
rz(5.180304788760421) q[1];
cx q[0],q[1];
rz(pi/2) q[4];
sx q[4];
rz(pi/2) q[4];
...
cx q[2],q[3];
cx q[1],q[2];
rz(5.180304788760421) q[2];
cx q[1],q[2];
rz(pi/2) q[1];
sx q[1];
rz(9.94945603963712) q[1];
sx q[1];
rz(5*pi/2) q[1];
rz(pi/2) q[4];
sx q[4];
rz(4.24454027083546) q[4];
sx q[4];
rz(5*pi/2) q[4];
cx q[3],q[4];
rz(5.180304788760421) q[4];
cx q[3],q[4];
cx q[2],q[3];
cx q[3],q[2];
cx q[2],q[3];
rz(pi/2) q[2];
sx q[2];
rz(9.94945603963712) q[2];
sx q[2];
rz(5*pi/2) q[2];
cx q[4],q[3];
rz(5.180304788760421) q[3];
cx q[4],q[3];
rz(pi/2) q[3];
sx q[3];
rz(9.94945603963712) q[3];
sx q[3];
rz(5*pi/2) q[3];
rz(pi/2) q[4];
sx q[4];
rz(9.94945603963712) q[4];
sx q[4];
rz(5*pi/2) q[4];
