...
rz(0) q[10];
sx q[10];
rz(3.4209852021251725) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[17];
sx q[17];
rz(3.643095649440467) q[17];
sx q[17];
rz(3*pi) q[17];
cx q[31],q[30];
rz(9.172838187819544) q[30];
...
rz(0) q[23];
sx q[23];
rz(3.772371205355584) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[24];
sx q[24];
rz(3.7725941709939717) q[24];
sx q[24];
rz(3*pi) q[24];
cx q[23],q[24];
cx q[22],q[23];
...
rz(0) q[24];
sx q[24];
rz(3.8216441312516167) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[25];
sx q[25];
rz(3.246731807558229) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[24],q[25];
cx q[25],q[24];
...
rz(0) q[23];
sx q[23];
rz(3.7478541607400326) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[26];
sx q[26];
rz(3.588110863022861) q[26];
sx q[26];
rz(3*pi) q[26];
cx q[25],q[26];
cx q[26],q[25];
...
rz(0) q[5];
sx q[5];
rz(3.388833581760972) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.6410471031686775) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
rz(0) q[4];
sx q[4];
rz(3.745286970295454) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[15],q[22];
rz(0) q[18];
sx q[18];
rz(3.385522741675684) q[18];
sx q[18];
rz(3*pi) q[18];
cx q[22],q[15];
cx q[15],q[22];
...
rz(0) q[15];
sx q[15];
rz(3.234104107365701) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[22],q[21];
rz(0) q[21];
sx q[21];
rz(3.8038538186329145) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[23];
cx q[23],q[22];
...
rz(0) q[26];
sx q[26];
rz(3.6914134975338033) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[27];
sx q[27];
rz(4.044738204280348) q[27];
sx q[27];
rz(3*pi) q[27];
cx q[26],q[27];
cx q[27],q[26];
...
rz(0) q[10];
sx q[10];
rz(3.431802976294115) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.2406391546300064) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[12],q[13];
cx q[13],q[12];
...
rz(0) q[29];
sx q[29];
rz(3.3175650745339382) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0) q[30];
sx q[30];
rz(3.8194592740209794) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[30],q[31];
cx q[31],q[30];
...
rz(0) q[4];
sx q[4];
rz(3.265524058240482) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[15],q[22];
rz(0) q[16];
sx q[16];
rz(3.70437588353422) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[22],q[15];
cx q[15],q[22];
...
rz(0) q[23];
sx q[23];
rz(3.6833403033522836) q[23];
sx q[23];
rz(3*pi) q[23];
rz(0) q[24];
sx q[24];
rz(3.1756688004364935) q[24];
sx q[24];
rz(3*pi) q[24];
rz(0) q[28];
sx q[28];
rz(3.35266516489538) q[28];
sx q[28];
rz(3*pi) q[28];
barrier q[24],q[23],q[21],q[4],q[16],q[28],q[32],q[17],q[11],q[10],q[13],q[9],q[12],q[31],q[30],q[29],q[26],q[34],q[19],q[15],q[5],q[2],q[0],q[18],q[14],q[1],q[3],q[6],q[7],q[8],q[27],q[22],q[20],q[33],q[25];
measure q[24] -> meas[0];
measure q[23] -> meas[1];
measure q[21] -> meas[2];
measure q[4] -> meas[3];
