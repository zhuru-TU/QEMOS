...
rz(0) q[0];
sx q[0];
rz(1.570995034347683) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(4.712268919936992) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.5705789940911572) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(1.3516170004160102) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(4.71050494736421) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.385542110677815) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(1.1906768927543538) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(4.6694181151952465) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(0.1149686602001645) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[9];
sx q[9];
rz(1.424246012224077) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[10];
sx q[10];
rz(3.779302807988012) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[11];
sx q[11];
rz(3.142741272179999) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[9],q[10];
...
rz(0) q[9];
sx q[9];
rz(4.712528644617124) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(4.711589373503549) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[0];
sx q[0];
rz(1.5708561223664457) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(1.5709118955994832) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.712373477588436) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(1.57079142108222) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(1.5708160452282307) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.712836800613726) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[0];
sx q[0];
rz(1.4418458336039255) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(8.274947675346311e-05) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.141478091012035) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.141329202968964) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(2.922415641382178) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.142862849068741) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(2.956321062094362) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.522475540606535) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.1846224479899448) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[30];
sx q[30];
rz(4.597423859358982) q[30];
sx q[30];
rz(3*pi) q[30];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[30],q[11],q[9];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
