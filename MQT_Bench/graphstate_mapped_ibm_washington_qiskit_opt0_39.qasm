...
sx q[34];
rz(pi/2) q[34];
barrier q[1],q[2],q[22],q[4],q[0],q[36],q[3],q[10],q[6],q[25],q[9],q[13],q[11],q[15],q[18],q[5],q[23],q[12],q[19],q[14],q[16],q[39],q[26],q[35],q[8],q[28],q[7],q[29],q[33],q[32],q[31],q[17],q[27],q[43],q[24],q[34],q[30],q[20],q[21];
measure q[1] -> meas[0];
measure q[2] -> meas[1];
measure q[22] -> meas[2];
measure q[4] -> meas[3];
