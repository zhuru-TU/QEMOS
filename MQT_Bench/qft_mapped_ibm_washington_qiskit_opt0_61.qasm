...
cx q[54],q[45];
cx q[45],q[54];
barrier q[39],q[19],q[42],q[20],q[15],q[38],q[16],q[26],q[30],q[37],q[45],q[44],q[24],q[53],q[56],q[62],q[18],q[60],q[34],q[65],q[41],q[66],q[47],q[31],q[35],q[63],q[67],q[11],q[10],q[49],q[55],q[50],q[9],q[8],q[25],q[13],q[29],q[12],q[48],q[46],q[23],q[2],q[7],q[6],q[0],q[61],q[14],q[40],q[52],q[64],q[54],q[3],q[17],q[28],q[27],q[5],q[4],q[22],q[43],q[21],q[33];
measure q[39] -> meas[0];
measure q[19] -> meas[1];
measure q[42] -> meas[2];
measure q[20] -> meas[3];
