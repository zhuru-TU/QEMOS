...
rz(0) q[62];
sx q[62];
rz(-696943929413055021056*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[61],q[62];
rz(-pi/128) q[61];
...
sx q[80];
rz(pi/2) q[80];
barrier q[80],q[79],q[81],q[82],q[72],q[83],q[85],q[73],q[66],q[65],q[64],q[54],q[45],q[47],q[49],q[48],q[46],q[35],q[27],q[25],q[24],q[43],q[44],q[41],q[63],q[60],q[40],q[59],q[58],q[39],q[53],q[38],q[34],q[26],q[55],q[50],q[17],q[31],q[12],q[30],q[11],q[29],q[67],q[62],q[28],q[42],q[84],q[33],q[37],q[57],q[20],q[61],q[23],q[19],q[21],q[4],q[15],q[5],q[7],q[6],q[8],q[2],q[16],q[1],q[22],q[13],q[69],q[10],q[32],q[36],q[9],q[68],q[3],q[14],q[0],q[52],q[18],q[51],q[56];
measure q[80] -> meas[0];
measure q[79] -> meas[1];
measure q[81] -> meas[2];
measure q[82] -> meas[3];
