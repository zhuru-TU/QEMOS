...
cx q[23],q[22];
cx q[22],q[23];
rz(-1.346478460632523) q[22];
cx q[22],q[21];
rz(1.346478460632523) q[21];
cx q[22],q[21];
cx q[15],q[22];
rz(-1.346478460632523) q[21];
cx q[22],q[15];
...
cx q[15],q[4];
cx q[4],q[15];
rz(1.3836506706728484) q[4];
cx q[4],q[5];
rz(-1.3836506706728484) q[5];
cx q[4],q[5];
cx q[4],q[15];
rz(1.3836506706728484) q[5];
cx q[5],q[6];
...
cx q[23],q[22];
cx q[22],q[23];
rz(-0.7485826244881929) q[22];
cx q[22],q[21];
rz(0.7485826244881929) q[21];
cx q[22],q[21];
rz(-0.7485826244881929) q[21];
cx q[21],q[22];
cx q[22],q[21];
...
rz(pi/2) q[0];
rz(-pi/4) q[1];
barrier q[3],q[30],q[16],q[20],q[2],q[5],q[6],q[8],q[26],q[28],q[11],q[10],q[12],q[17],q[29],q[27],q[25],q[24],q[23],q[4],q[15],q[22],q[21],q[19],q[14],q[1],q[0],q[18];
measure q[3] -> c[0];
measure q[30] -> c[1];
measure q[16] -> c[2];
measure q[20] -> c[3];
