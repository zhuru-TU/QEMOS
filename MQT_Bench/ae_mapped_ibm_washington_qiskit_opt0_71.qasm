...
rz(0) q[6];
sx q[6];
rz(-60768.077814300064) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[7],q[6];
rz(0) q[6];
sx q[6];
rz(60774.36099960725) q[6];
sx q[6];
rz(3*pi) q[6];
cx q[6],q[7];
cx q[7],q[6];
...
rz(0) q[21];
sx q[21];
rz(-3889354.9004523805) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[22],q[21];
rz(0) q[21];
sx q[21];
rz(3889361.1836376875) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[21],q[22];
cx q[22],q[21];
...
rz(0) q[62];
sx q[62];
rz(-2722437224269746176*pi) q[62];
sx q[62];
rz(3*pi) q[62];
cx q[63],q[62];
rz(0) q[62];
...
rz(0) q[68];
sx q[68];
rz(-174235982353263755264*pi) q[68];
sx q[68];
rz(3*pi) q[68];
cx q[69],q[68];
rz(0) q[68];
...
rz(pi/2) q[55];
rz(-pi/4) q[68];
barrier q[55],q[68],q[67],q[49],q[50],q[66],q[65],q[64],q[63],q[62],q[61],q[60],q[58],q[56],q[37],q[39],q[40],q[41],q[33],q[21],q[23],q[34],q[43],q[25],q[27],q[29],q[17],q[12],q[13],q[11],q[10],q[31],q[9],q[35],q[8],q[30],q[6],q[15],q[24],q[4],q[5],q[20],q[53],q[59],q[69],q[26],q[28],q[52],q[38],q[42],q[45],q[44],q[22],q[46],q[54],q[47],q[48],q[32],q[16],q[36],q[51],q[7],q[2],q[19],q[18],q[57],q[14],q[3],q[0],q[1],q[70];
measure q[55] -> meas[0];
measure q[68] -> meas[1];
measure q[67] -> meas[2];
measure q[49] -> meas[3];
