...
cx q[67],q[66];
cx q[66],q[67];
barrier q[39],q[20],q[38],q[18],q[52],q[22],q[46],q[27],q[35],q[44],q[66],q[60],q[53],q[26],q[16],q[17],q[23],q[64],q[62],q[68],q[54],q[49],q[51],q[65],q[57],q[7],q[58],q[4],q[11],q[3],q[0],q[2],q[56],q[34],q[1],q[32],q[9],q[31],q[10],q[6],q[40],q[5],q[41],q[13],q[30],q[50],q[48],q[55],q[63],q[43],q[24],q[12],q[8],q[25],q[42],q[59],q[67],q[45],q[28],q[29],q[47],q[15],q[37],q[14],q[21],q[19],q[33];
measure q[39] -> meas[0];
measure q[20] -> meas[1];
measure q[38] -> meas[2];
measure q[18] -> meas[3];
