...
rz(0) q[11];
sx q[11];
rz(3.739110495646241) q[11];
sx q[11];
rz(3*pi) q[11];
rz(0) q[12];
sx q[12];
rz(3.371193463823349) q[12];
sx q[12];
rz(3*pi) q[12];
cx q[11],q[12];
cx q[10],q[11];
...
rz(0) q[10];
sx q[10];
rz(3.3550584863513953) q[10];
sx q[10];
rz(3*pi) q[10];
rz(0) q[12];
sx q[12];
rz(3.482919792750467) q[12];
sx q[12];
rz(3*pi) q[12];
rz(0) q[30];
sx q[30];
rz(3.5910658819997687) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[17],q[30];
cx q[30],q[17];
...
rz(0) q[0];
sx q[0];
rz(3.2496940684829485) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.545018724366886) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.536898412529571) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[4];
sx q[4];
rz(3.964649450700642) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(3.3377016264979535) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(3.3005074330134136) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(3.9583049303256477) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(3.5152442715097774) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.6726115770270598) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[4],q[5],q[7],q[16],q[27],q[29],q[17],q[11],q[10],q[12];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[4] -> meas[3];
