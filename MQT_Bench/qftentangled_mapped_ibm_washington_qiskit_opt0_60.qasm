...
cx q[45],q[54];
cx q[54],q[45];
barrier q[33],q[38],q[21],q[37],q[52],q[54],q[34],q[35],q[47],q[29],q[32],q[36],q[50],q[13],q[68],q[12],q[16],q[27],q[42],q[53],q[26],q[6],q[63],q[46],q[14],q[49],q[59],q[64],q[44],q[60],q[18],q[65],q[5],q[15],q[0],q[2],q[4],q[25],q[3],q[23],q[41],q[43],q[7],q[8],q[17],q[55],q[10],q[51],q[11],q[31],q[30],q[48],q[28],q[24],q[45],q[22],q[40],q[19],q[39],q[20];
measure q[33] -> meas[0];
measure q[38] -> meas[1];
measure q[21] -> meas[2];
measure q[37] -> meas[3];
