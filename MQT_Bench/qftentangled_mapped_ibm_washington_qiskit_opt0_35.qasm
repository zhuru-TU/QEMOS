...
cx q[47],q[35];
cx q[35],q[47];
barrier q[26],q[27],q[23],q[28],q[17],q[12],q[31],q[35],q[11],q[9],q[8],q[15],q[1],q[7],q[6],q[3],q[5],q[33],q[14],q[18],q[4],q[13],q[2],q[34],q[19],q[16],q[20],q[47],q[32],q[29],q[30],q[21],q[22],q[24],q[25];
measure q[26] -> meas[0];
measure q[27] -> meas[1];
measure q[23] -> meas[2];
measure q[28] -> meas[3];
