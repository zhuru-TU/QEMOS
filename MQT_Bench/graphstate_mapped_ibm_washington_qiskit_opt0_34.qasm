...
sx q[27];
rz(pi/2) q[27];
barrier q[1],q[6],q[3],q[14],q[16],q[5],q[2],q[12],q[31],q[9],q[32],q[10],q[13],q[28],q[11],q[21],q[15],q[24],q[23],q[4],q[33],q[20],q[0],q[18],q[25],q[22],q[26],q[8],q[7],q[27],q[19],q[30],q[17],q[29];
measure q[1] -> meas[0];
measure q[6] -> meas[1];
measure q[3] -> meas[2];
measure q[14] -> meas[3];
