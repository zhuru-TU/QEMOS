...
cx q[25],q[24];
cx q[24],q[25];
barrier q[20],q[24],q[23],q[44],q[34],q[15],q[42],q[3],q[16],q[21],q[45],q[29],q[7],q[30],q[5],q[12],q[41],q[10],q[13],q[35],q[47],q[31],q[9],q[11],q[1],q[17],q[0],q[27],q[14],q[28],q[18],q[33],q[8],q[6],q[46],q[4],q[26],q[43],q[22],q[25],q[19];
measure q[20] -> meas[0];
measure q[24] -> meas[1];
measure q[23] -> meas[2];
measure q[44] -> meas[3];
