...
rz(0) q[0];
sx q[0];
rz(3.141765072704429) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.6684428371278965) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(5.399576084424265) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.651490287905621) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(2.599218693052555) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
...
rz(0) q[6];
sx q[6];
rz(1.47032038003993) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.3691507046200053) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
cx q[5],q[6];
...
rz(0) q[0];
sx q[0];
rz(5.836797156515576) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(1.5713392462748261) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.5704521505795888) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(1.5707246500630718) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(1.5706452127997867) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.712346077948719) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(2.721446258889999) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(5.874622094822743) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[6],q[7];
cx q[5],q[6];
...
rz(0) q[0];
sx q[0];
rz(5.836806852314028) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.8502957440333727) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(5.239118408192914) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(2.454510097342391) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(5.222236916106155) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(4.1696398062470585) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(3.1103336652961007) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(0.248369096434228) q[7];
sx q[7];
rz(3*pi) q[7];
