...
rz(pi/2) q[29];
rz(-pi/1024) q[32];
barrier q[29],q[28],q[30],q[17],q[12],q[11],q[10],q[13],q[31],q[32],q[27],q[26],q[24],q[23],q[22],q[21],q[15],q[25],q[20],q[4],q[19],q[33],q[18],q[5],q[7],q[8],q[3],q[6],q[1],q[0],q[2],q[14],q[16],q[9];
measure q[29] -> meas[0];
measure q[28] -> meas[1];
measure q[30] -> meas[2];
measure q[17] -> meas[3];
