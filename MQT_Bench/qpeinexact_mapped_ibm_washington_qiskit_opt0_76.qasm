...
cx q[56],q[52];
cx q[52],q[56];
rz(1.3468601241963372) q[52];
cx q[52],q[37];
rz(-1.3468601241963372) q[37];
cx q[52],q[37];
rz(1.3468601241963372) q[37];
cx q[37],q[52];
cx q[52],q[37];
...
rz(pi/2) q[28];
rz(-pi/4) q[29];
barrier q[26],q[8],q[6],q[1],q[43],q[70],q[72],q[68],q[73],q[85],q[64],q[65],q[69],q[35],q[66],q[45],q[61],q[54],q[23],q[34],q[63],q[71],q[53],q[0],q[62],q[59],q[58],q[14],q[19],q[18],q[25],q[27],q[20],q[16],q[7],q[2],q[3],q[5],q[4],q[22],q[15],q[21],q[24],q[42],q[60],q[33],q[57],q[40],q[56],q[37],q[52],q[38],q[39],q[41],q[44],q[67],q[46],q[55],q[9],q[10],q[11],q[17],q[13],q[12],q[31],q[32],q[36],q[51],q[50],q[49],q[48],q[47],q[30],q[29],q[28],q[86];
measure q[26] -> c[0];
measure q[8] -> c[1];
measure q[6] -> c[2];
measure q[1] -> c[3];
