...
rz(pi/2) q[42];
rz(-pi/4) q[43];
barrier q[42],q[43],q[41],q[40],q[39],q[33],q[20],q[19],q[18],q[21],q[23],q[34],q[44],q[45],q[47],q[35],q[29],q[30],q[17],q[12],q[32],q[11],q[10],q[13],q[31],q[9],q[48],q[36],q[27],q[26],q[15],q[5],q[7],q[16],q[24],q[46],q[8],q[25],q[22],q[4],q[6],q[2],q[1],q[14],q[0],q[3],q[38],q[37];
measure q[42] -> meas[0];
measure q[43] -> meas[1];
measure q[41] -> meas[2];
measure q[40] -> meas[3];
