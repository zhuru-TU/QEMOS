...
rz(pi/2) q[1];
rz(-pi/8192) q[35];
barrier q[83],q[14],q[37],q[70],q[21],q[36],q[69],q[50],q[51],q[73],q[49],q[52],q[85],q[55],q[68],q[84],q[80],q[39],q[56],q[67],q[46],q[18],q[5],q[7],q[8],q[6],q[3],q[42],q[48],q[43],q[19],q[20],q[33],q[44],q[38],q[57],q[41],q[40],q[71],q[53],q[77],q[79],q[58],q[59],q[81],q[60],q[72],q[45],q[66],q[61],q[65],q[62],q[64],q[63],q[54],q[34],q[13],q[32],q[47],q[31],q[9],q[10],q[17],q[11],q[12],q[30],q[29],q[16],q[35],q[28],q[27],q[26],q[25],q[24],q[23],q[22],q[15],q[4],q[2],q[0],q[1],q[75];
measure q[83] -> c[0];
measure q[14] -> c[1];
measure q[37] -> c[2];
measure q[70] -> c[3];
