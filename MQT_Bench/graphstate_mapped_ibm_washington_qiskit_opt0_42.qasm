...
sx q[43];
rz(pi/2) q[43];
barrier q[0],q[1],q[7],q[3],q[4],q[6],q[33],q[8],q[36],q[11],q[32],q[35],q[9],q[10],q[20],q[2],q[5],q[16],q[34],q[19],q[14],q[22],q[37],q[21],q[24],q[26],q[15],q[28],q[23],q[12],q[17],q[13],q[25],q[18],q[31],q[30],q[47],q[27],q[42],q[39],q[29],q[43];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[7] -> meas[2];
measure q[3] -> meas[3];
