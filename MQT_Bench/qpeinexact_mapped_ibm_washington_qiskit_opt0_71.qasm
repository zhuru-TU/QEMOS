...
cx q[62],q[61];
cx q[61],q[62];
rz(1.3261591585810122) q[61];
cx q[61],q[60];
rz(-1.3261591585810122) q[60];
cx q[61],q[60];
rz(1.3261591585810122) q[60];
cx q[60],q[61];
cx q[61],q[60];
...
cx q[40],q[39];
cx q[39],q[40];
rz(-0.4892743364277687) q[39];
cx q[39],q[33];
rz(0.4892743364277687) q[33];
cx q[39],q[33];
rz(-0.4892743364277687) q[33];
cx q[33],q[39];
cx q[39],q[33];
...
cx q[19],q[18];
cx q[18],q[19];
rz(-0.9785486728555374) q[21];
cx q[21],q[22];
rz(0.9785486728555374) q[22];
cx q[21],q[22];
rz(-0.9785486728555374) q[22];
cx q[21],q[22];
cx q[22],q[21];
...
cx q[22],q[15];
cx q[15],q[22];
rz(1.1844953078787184) q[15];
cx q[15],q[4];
rz(-1.1844953078787184) q[4];
cx q[15],q[4];
rz(1.1844953078787184) q[4];
cx q[4],q[15];
cx q[15],q[4];
...
cx q[1],q[0];
cx q[0],q[1];
rz(-1.5452040756647127) q[4];
cx q[4],q[5];
rz(1.5452040756647127) q[5];
cx q[4],q[5];
rz(0.05118450226036758) q[4];
rz(-1.5452040756647127) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-0.05118450226036758) q[5];
cx q[4],q[5];
rz(0.05118450226036758) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[6],q[5];
cx q[5],q[6];
rz(1.0737239285898545) q[5];
cx q[5],q[4];
rz(-1.0737239285898545) q[4];
cx q[5],q[4];
rz(1.0737239285898545) q[4];
cx q[3],q[4];
cx q[4],q[3];
...
cx q[6],q[5];
cx q[5],q[6];
rz(-0.9941447964100841) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(0.9941447964100841) q[7];
cx q[6],q[7];
rz(-0.9941447964100841) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
rz(-pi/4) q[32];
rz(0) q[54];
barrier q[50],q[53],q[52],q[57],q[37],q[56],q[38],q[58],q[59],q[69],q[62],q[61],q[60],q[65],q[63],q[66],q[67],q[41],q[68],q[55],q[64],q[54],q[39],q[40],q[33],q[51],q[10],q[9],q[11],q[13],q[12],q[36],q[49],q[48],q[46],q[47],q[35],q[16],q[15],q[45],q[42],q[44],q[43],q[34],q[21],q[6],q[18],q[20],q[19],q[14],q[0],q[1],q[2],q[3],q[8],q[7],q[5],q[4],q[22],q[23],q[24],q[25],q[26],q[27],q[28],q[17],q[29],q[30],q[32],q[31],q[70];
measure q[50] -> c[0];
measure q[53] -> c[1];
measure q[52] -> c[2];
measure q[57] -> c[3];
