...
rz(0) q[14];
sx q[14];
rz(3.819506428096507) q[14];
sx q[14];
rz(3*pi) q[14];
rz(0) q[22];
sx q[22];
rz(3.3476723664345767) q[22];
sx q[22];
rz(3*pi) q[22];
cx q[21],q[22];
cx q[22],q[21];
...
rz(0) q[6];
sx q[6];
rz(3.4667672964934932) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[15];
sx q[15];
rz(3.9616111829438867) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[16],q[8];
rz(9.172838187819544) q[8];
...
rz(0) q[8];
sx q[8];
rz(4.04146310287512) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[16];
sx q[16];
rz(3.3421309566319417) q[16];
sx q[16];
rz(3*pi) q[16];
cx q[16],q[8];
cx q[7],q[8];
...
rz(0) q[4];
sx q[4];
rz(3.402554165796035) q[4];
sx q[4];
rz(3*pi) q[4];
cx q[4],q[15];
rz(0) q[5];
sx q[5];
rz(4.080536836959963) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[6];
sx q[6];
rz(4.039596779398747) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.722663649143977) q[7];
sx q[7];
rz(3*pi) q[7];
cx q[15],q[4];
cx q[4],q[15];
...
rz(0) q[19];
sx q[19];
rz(3.488042647251917) q[19];
sx q[19];
rz(3*pi) q[19];
rz(0) q[21];
sx q[21];
rz(3.680860468523358) q[21];
sx q[21];
rz(3*pi) q[21];
cx q[20],q[21];
cx q[21],q[20];
...
rz(0) q[22];
sx q[22];
rz(4.104000738568559) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[25];
sx q[25];
rz(3.954708722217293) q[25];
sx q[25];
rz(3*pi) q[25];
cx q[24],q[25];
cx q[25],q[24];
...
rz(0) q[31];
sx q[31];
rz(3.315847770567931) q[31];
sx q[31];
rz(3*pi) q[31];
cx q[31],q[30];
rz(0) q[30];
sx q[30];
rz(4.103097408205582) q[30];
sx q[30];
rz(3*pi) q[30];
cx q[17],q[30];
cx q[30],q[17];
...
rz(0) q[9];
sx q[9];
rz(3.8111811241514992) q[9];
sx q[9];
rz(3*pi) q[9];
rz(0) q[11];
sx q[11];
rz(3.4818492268362298) q[11];
sx q[11];
rz(3*pi) q[11];
cx q[10],q[11];
cx q[11],q[10];
...
rz(0) q[2];
sx q[2];
rz(3.4556201108669744) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[14],q[0];
rz(0) q[0];
sx q[0];
rz(3.58640522808298) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[15];
sx q[15];
rz(3.7536792985719227) q[15];
sx q[15];
rz(3*pi) q[15];
cx q[18],q[14];
rz(0) q[14];
sx q[14];
rz(3.752723749292614) q[14];
sx q[14];
rz(3*pi) q[14];
cx q[18],q[19];
cx q[19],q[18];
...
rz(0) q[21];
sx q[21];
rz(3.892733420200557) q[21];
sx q[21];
rz(3*pi) q[21];
rz(0) q[22];
sx q[22];
rz(3.8132826440366276) q[22];
sx q[22];
rz(3*pi) q[22];
rz(0) q[26];
sx q[26];
rz(3.995893118507595) q[26];
sx q[26];
rz(3*pi) q[26];
rz(0) q[29];
sx q[29];
rz(4.129072654419568) q[29];
sx q[29];
rz(3*pi) q[29];
rz(0) q[31];
sx q[31];
rz(3.5785096704020822) q[31];
sx q[31];
rz(3*pi) q[31];
rz(0) q[32];
sx q[32];
rz(3.381750676795674) q[32];
sx q[32];
rz(3*pi) q[32];
barrier q[22],q[21],q[14],q[0],q[2],q[15],q[26],q[29],q[17],q[11],q[9],q[10],q[13],q[30],q[31],q[32],q[12],q[28],q[27],q[25],q[20],q[18],q[19],q[24],q[23],q[3],q[1],q[4],q[5],q[6],q[7],q[16],q[8];
measure q[22] -> meas[0];
measure q[21] -> meas[1];
measure q[14] -> meas[2];
measure q[0] -> meas[3];
