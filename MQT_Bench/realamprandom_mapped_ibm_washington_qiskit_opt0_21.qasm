...
sx q[29];
rz(3*pi) q[29];
barrier q[20],q[21],q[23],q[24],q[25],q[26],q[28],q[30],q[10],q[11],q[12],q[17],q[29],q[27],q[16],q[7],q[5],q[4],q[3],q[1],q[2];
measure q[20] -> meas[0];
measure q[21] -> meas[1];
measure q[23] -> meas[2];
measure q[24] -> meas[3];
