...
rz(0) q[0];
sx q[0];
rz(1.793376784728006) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(0.8303555177053554) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(3.348255395454759) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[1],q[2];
cx q[0],q[1];
rz(0) q[0];
sx q[0];
rz(3.431233715941998) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.476410808243811) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(2.1427649451977553) q[2];
sx q[2];
rz(3*pi) q[2];
cx q[1],q[2];
cx q[0],q[1];
rz(0) q[0];
sx q[0];
rz(4.473504995508536) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.1846540529766725) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(5.498529917094801) q[2];
sx q[2];
rz(3*pi) q[2];
barrier q[0],q[1],q[2];
measure q[0] -> meas[0];
