...
cx q[53],q[41];
cx q[41],q[53];
rz(1.3472248750687503) q[41];
cx q[41],q[40];
rz(-1.3472248750687503) q[40];
cx q[41],q[40];
rz(1.3472248750687503) q[40];
cx q[40],q[41];
cx q[41],q[40];
...
cx q[33],q[20];
cx q[20],q[33];
rz(-0.44714290345229224) q[20];
cx q[20],q[19];
rz(0.44714290345229224) q[19];
cx q[20],q[19];
rz(-0.44714290345229224) q[19];
cx q[18],q[19];
cx q[19],q[18];
...
cx q[22],q[15];
cx q[15],q[22];
rz(-0.8942858069045845) q[15];
cx q[15],q[4];
rz(0.8942858069045845) q[4];
cx q[15],q[4];
rz(-0.8942858069045845) q[4];
cx q[4],q[15];
cx q[15],q[4];
cx q[4],q[15];
rz(1.3530210397806242) q[4];
cx q[4],q[3];
...
cx q[1],q[0];
cx q[0],q[1];
rz(-0.8711011480570896) q[4];
cx q[4],q[5];
rz(0.8711011480570896) q[5];
cx q[4],q[5];
rz(1.399390357475614) q[4];
rz(-0.8711011480570896) q[5];
cx q[5],q[6];
cx q[6],q[5];
cx q[5],q[6];
cx q[4],q[5];
rz(-1.399390357475614) q[5];
cx q[4],q[5];
rz(1.399390357475614) q[5];
cx q[4],q[5];
cx q[5],q[4];
...
cx q[4],q[3];
cx q[3],q[4];
rz(-0.34281193863856535) q[5];
cx q[6],q[7];
cx q[7],q[6];
cx q[6],q[7];
cx q[5],q[6];
rz(0.34281193863856535) q[6];
cx q[5],q[6];
rz(-0.34281193863856535) q[6];
cx q[5],q[6];
cx q[6],q[5];
...
cx q[5],q[4];
cx q[4],q[5];
rz(-0.6856238772771307) q[6];
cx q[7],q[8];
cx q[8],q[7];
cx q[7],q[8];
cx q[6],q[7];
rz(0.6856238772771307) q[7];
cx q[6],q[7];
rz(-0.6856238772771307) q[7];
cx q[6],q[7];
cx q[7],q[6];
...
cx q[28],q[27];
cx q[27],q[28];
rz(-1.3712477545542614) q[28];
cx q[28],q[29];
rz(1.3712477545542614) q[29];
cx q[28],q[29];
rz(-1.3712477545542614) q[29];
cx q[28],q[29];
cx q[29],q[28];
...
cx q[30],q[17];
cx q[17],q[30];
rz(0.39909714448127015) q[17];
cx q[17],q[12];
rz(-0.39909714448127015) q[12];
cx q[17],q[12];
rz(0.39909714448127015) q[12];
cx q[12],q[17];
cx q[17],q[12];
cx q[12],q[17];
rz(0.7981942889625403) q[12];
cx q[12],q[11];
...
cx q[12],q[11];
cx q[11],q[12];
rz(-1.5452040756647127) q[11];
cx q[11],q[10];
rz(1.5452040756647127) q[10];
cx q[11],q[10];
rz(-1.5452040756647127) q[10];
cx q[9],q[10];
cx q[10],q[9];
...
sx q[56];
rz(pi/2) q[56];
barrier q[70],q[59],q[19],q[7],q[16],q[15],q[28],q[36],q[21],q[51],q[69],q[83],q[53],q[50],q[85],q[63],q[46],q[29],q[32],q[13],q[9],q[31],q[17],q[10],q[11],q[12],q[30],q[35],q[27],q[73],q[67],q[49],q[47],q[48],q[55],q[68],q[22],q[60],q[61],q[81],q[82],q[84],q[66],q[65],q[42],q[41],q[33],q[24],q[23],q[43],q[40],q[39],q[20],q[18],q[0],q[1],q[2],q[3],q[4],q[5],q[6],q[8],q[26],q[25],q[34],q[44],q[45],q[54],q[64],q[62],q[72],q[80],q[79],q[77],q[58],q[57],q[52],q[56],q[14];
measure q[70] -> c[0];
measure q[59] -> c[1];
measure q[19] -> c[2];
measure q[7] -> c[3];
