...
rz(0) q[0];
sx q[0];
rz(3.019513641001229) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(3.1418116475294435) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.729839396942142) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(2.1320954244830554) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(5.25665536985093) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
...
rz(0) q[6];
sx q[6];
rz(4.712324758014003) q[6];
sx q[6];
rz(3*pi) q[6];
rz(0) q[7];
sx q[7];
rz(3.1415451675243427) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[8];
sx q[8];
rz(5.096034634749632) q[8];
sx q[8];
rz(3*pi) q[8];
rz(0) q[9];
sx q[9];
rz(2.6994973453033384) q[9];
sx q[9];
rz(3*pi) q[9];
cx q[9],q[10];
cx q[10],q[9];
...
rz(0) q[0];
sx q[0];
rz(5.458853588727237) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(6.099225155656369) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(4.712212226597702) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(4.712585566337874) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(1.5711500501530904) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(1.5707115250411392) q[5];
sx q[5];
rz(3*pi) q[5];
cx q[5],q[6];
cx q[6],q[5];
...
rz(0) q[0];
sx q[0];
rz(1.7180151062721147) q[0];
sx q[0];
rz(3*pi) q[0];
rz(0) q[1];
sx q[1];
rz(5.546921293554616) q[1];
sx q[1];
rz(3*pi) q[1];
rz(0) q[2];
sx q[2];
rz(1.5707622780189836) q[2];
sx q[2];
rz(3*pi) q[2];
rz(0) q[3];
sx q[3];
rz(3.1241900745458953) q[3];
sx q[3];
rz(3*pi) q[3];
rz(0) q[4];
sx q[4];
rz(0.5614239559301497) q[4];
sx q[4];
rz(3*pi) q[4];
rz(0) q[5];
sx q[5];
rz(0.543998519483861) q[5];
sx q[5];
rz(3*pi) q[5];
rz(0) q[7];
sx q[7];
rz(1.5703554023574942) q[7];
sx q[7];
rz(3*pi) q[7];
rz(0) q[16];
sx q[16];
rz(1.8407976373852446) q[16];
sx q[16];
rz(3*pi) q[16];
rz(0) q[27];
sx q[27];
rz(1.5709285707776426) q[27];
sx q[27];
rz(3*pi) q[27];
rz(0) q[29];
sx q[29];
rz(3.718660189955748) q[29];
sx q[29];
rz(3*pi) q[29];
barrier q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[16],q[27],q[29];
measure q[0] -> meas[0];
measure q[1] -> meas[1];
measure q[2] -> meas[2];
measure q[3] -> meas[3];
