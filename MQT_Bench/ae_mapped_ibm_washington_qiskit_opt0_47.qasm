...
rz(-pi/512) q[49];
rz(-pi/65536) q[51];
barrier q[43],q[42],q[41],q[44],q[45],q[46],q[47],q[48],q[49],q[35],q[28],q[29],q[31],q[32],q[30],q[51],q[36],q[17],q[12],q[11],q[10],q[13],q[9],q[27],q[26],q[5],q[3],q[4],q[2],q[15],q[1],q[0],q[6],q[16],q[24],q[22],q[21],q[8],q[20],q[7],q[14],q[34],q[33],q[25],q[18],q[19],q[37];
measure q[43] -> meas[0];
measure q[42] -> meas[1];
measure q[41] -> meas[2];
measure q[44] -> meas[3];
