...
cx q[8],q[16];
cx q[16],q[8];
barrier q[60],q[16],q[27],q[35],q[47],q[34],q[49],q[46],q[55],q[66],q[22],q[48],q[61],q[21],q[44],q[19],q[45],q[54],q[4],q[5],q[10],q[15],q[2],q[33],q[40],q[20],q[13],q[18],q[14],q[63],q[3],q[32],q[39],q[65],q[41],q[9],q[25],q[31],q[11],q[6],q[12],q[42],q[0],q[43],q[1],q[62],q[17],q[24],q[67],q[30],q[68],q[29],q[23],q[7],q[28],q[26],q[8],q[53];
measure q[60] -> meas[0];
measure q[16] -> meas[1];
measure q[27] -> meas[2];
measure q[35] -> meas[3];
